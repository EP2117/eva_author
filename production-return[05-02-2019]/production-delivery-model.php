		...
		// echo $pdo_entry_product_detail_qty[$i]; exit;
			...
			if($detail_request_fields) {
				...
				$detail_id			= mysql_insert_id();
						...
						$product_colour_id									=	$advance_entry_product_detail_product_colour_id[$i];
						...
						$length_feet										= 	$advance_entry_product_detail_sl_feet[$i];
						$length_meter										= 	$advance_entry_product_detail_sl_feet_met[$i];
						...
						$stock_ledger_entry_type							= 	"purchase-entry-fin";
						$product_con_entry_godown_id						= 	"3";
						stockLedger('in',$advance_entry_id,$detail_id,$produt_id,$length_feet,$length_meter,$ton_qty,$kg_qty,$product_detail_qty, $advance_entry_branch_id,  $product_con_entry_godown_id, $advance_entry_date, $advance_entry_no,$stock_ledger_entry_type, '2',$width_inches,$width_mm,$product_colour_id,$product_thick);
		...
		$prn_entry_id 	= getId('prn_entry', 'prn_entry_id', 'prn_entry_uniq_id',  dataValidation($_GET['id'])); 
		 ...
		 $select_pdo_entry_product_detail 	= "	SELECT 
													...
													LEFT JOIN 
														products 
													ON 
														product_id 		= 	prn_entry_raw_product_detail_product_id
													LEFT JOIN 
														brands 
													ON 
														brand_id 		= product_brand_id
