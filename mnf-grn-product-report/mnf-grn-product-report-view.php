								...
								<table class="table table-striped table-bordered table-hover" id="product_detail_rls" >
                                    ...
                                    <tbody >
										...
										<td><?php echo $sno++;?></td>	
											...
											<td><?php echo $get_val['gin_entry_no'];?></td>
											<td><?php echo dateGeneralFormatN($get_val['gin_entry_date']);?></td>
											...
											<td><?php echo $arr_thick[$get_val['grn_entry_product_detail_product_thick']];?></td>
											<td><?php echo $get_val['grn_entry_product_detail_s_width_inches'];?></td>
											<td><?php echo $get_val['grn_entry_product_detail_s_width_mm'];?></td>
											<td><?php echo $get_val['grn_entry_product_detail_sl_feet'];?></td>
											<td><?php echo $get_val['grn_entry_product_detail_sl_feet_mm'];?></td>
											<td><?php echo $get_val['grn_entry_product_detail_qty'];?></td>
										</tr>
										<?php 
										...
										<td><?php echo $sno++;?></td>	
											...
											<td><?php echo $get_val['grn_entry_product_detail_s_width_inches'];?></td>
											<td><?php echo $get_val['grn_entry_product_detail_s_width_mm'];?></td>
											<td><?php echo number_format($get_val['grn_entry_product_detail_s_weight_inches'],2,'.','');?></td>
											<td><?php echo $get_val['grn_entry_product_detail_s_weight_mm'];?></td>
											<td><?php echo $get_val['grn_entry_product_detail_qty'];?></td>
										</tr>
										<?php 
