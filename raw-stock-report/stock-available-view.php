...
<script type="text/javascript" src="<?php echo PROJECT_PATH.'/raw-stock-report/stock-available-javascript.js'; ?>"></script>
        ...
        <div id="page-wrapper">
            ...
            <div id="page-inner">
                ...
                <div class="row">
					 ...
					 <form action="index.php" id="stock-form" name="stock-form" method="post">
									...
									<div class="panel-body">
										...
										<div class="col-lg-4">										
											...
											<div class="form-group">
												...
												<select name="warehouseid" id="warehouseid" class="form-control select2"  style="width:100%" >
													...
													?>
														<option  value="<?=$get_godown['godown_id']?>" <?php if(searchValue('warehouseid')==$get_godown['godown_id']){ ?> selected <?php }?>><?=$get_godown['godown_name']?></option>
										...
										<div class="col-lg-4">
											...
											<div class="form-group">
												...
												<input type="text" class="form-control"  name="productcode" id="productcode" value="<?=searchValue('productcode') ?>" onFocus="" >
					...
					<div class="panel panel-default">
						...
						<div class="panel-heading">
							...
							Stock availability list  <a href="<?php echo PROJECT_PATH.'/raw-stock-report/stock-print.php?brandid='.searchValue('brandid').'&type='.searchValue('type').'&product_status='.searchValue('product_status').'&category='.searchValue('category').'&productname='.searchValue('productname').'&colorid='.searchValue('colorid').'&width='.searchValue('width').'&branchid='.searchValue('branchid').'&from_date='.searchValue('from_date').'&to_date='.searchValue('to_date').'&thik='.searchValue('thik').'&productcode='.searchValue('productcode').'&warehouseid='.searchValue('warehouseid');  ?>" title="Download PDF" target="_blank" align="right">

							<img src="<?php echo PROJECT_PATH.'/images/pdf-icon.png'; ?>" width="28" border="0"   alt="Download PDF" title="Download PDF">

							</a>

							<a href="<?php echo PROJECT_PATH.'/raw-stock-report/stock-available-excel.php?brandid='.searchValue('brandid').'&type='.searchValue('type').'&product_status='.searchValue('product_status').'&category='.searchValue('category').'&productname='.searchValue('productname').'&colorid='.searchValue('colorid').'&width='.searchValue('width').'&branchid='.searchValue('branchid').'&from_date='.searchValue('from_date').'&to_date='.searchValue('to_date').'&thik='.searchValue('thik').'&productcode='.searchValue('productcode').'&warehouseid='.searchValue('warehouseid');  ?>" title="Download PDF" target="_blank" align="right">
							...
							<form action="index.php" method="post">
								...
								<table id="stock_table"  class="table table-striped table-bordered table-hover"  style="width:195%">
									...
									<?php $amt=0;
									    ...
									    $ton=0;	
										$brand_name='';	//print_r($stockList);exit;
								...
								<tr >
											...
											<td ><b><?php echo number_format($amt,2,'.','');?></b></td>
 <td >&nbsp;</td>

											<td ><b><?php echo number_format($ton,2,'.','');?></b></td>
  <td >&nbsp;</td>
										</tr>
								 <?php }
								 	$amt 		=0;
								 ...
								 <tr>
								 <td colspan="20" style="text-align:center;"><?php echo $result['brand_name']; ?></td>
								 </tr>
