    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Damage Entry Report</h1>
                            ...
                            <div class="table-responsive">
								...
								<table class="table table-striped table-bordered table-hover" id="product_detail_rls" >
                                    ...
                                    <tbody >
										...
										if($product_id!=$get_val['damage_entry_product_detail_product_id']){
										if($sno!=1){ ?>
										...
										?>
										<tr>
											<td colspan="17" style="text-align:center"> <?php if($get_val['damage_entry_type_id']==3 || $get_val['damage_entry_type_id']==2){ echo $get_val['product_con_entry_child_product_detail_code'].' - '.$get_val['product_con_entry_child_product_detail_name'];} else{echo $get_val['product_code'].' - '.$get_val['product_name']; }?></td>
										</tr>
										
										<?php } 
										if($get_val['damage_entry_product_detail_product_thick']==0){
										$arr_thicks='';
										}else{
										$arr_thicks=$arr_thick[number_format($get_val['damage_entry_product_detail_product_thick'])];
										...
										<td><?php echo $sno++;?></td>	
											...
											<td><?php if($get_val['damage_entry_type_id']==3 || $get_val['damage_entry_type_id']==2){ echo $get_val['c_brand_name']; }else { echo $get_val['p_brand_name'];}?></td>
											<td><?php if($get_val['damage_entry_type_id']==3 || $get_val['damage_entry_type_id']==2){ echo $get_val['c_uom_name']; }else { echo $get_val['p_uom_name'];}?></td>
											<td><?php if($get_val['damage_entry_type_id']==3 || $get_val['damage_entry_type_id']==2){ echo $get_val['c_colour_name']; }else { echo $get_val['p_colour_name'];};?></td>
											<td><?php echo $arr_thicks;?></td>
											<td><?php echo $get_val['damage_entry_product_detail_width_inches'];?></td>
											<td><?php echo $get_val['damage_entry_product_detail_width_mm'];?></td>
											<td><?php echo $get_val['damage_entry_product_detail_length_feet'];?></td>
											<td><?php echo $get_val['damage_entry_product_detail_length_mm'];?></td>
											<td><?php echo $get_val['damage_entry_product_detail_weight_tone'];?></td>
											<td><?php echo $get_val['damage_entry_product_detail_weight_kg'];?></td>
											
											<td><?php echo number_format($get_val['damage_entry_product_detail_qty'],3,'.','');?></td>
										</tr>
										<?php 
										
										$product_id=$get_val['damage_entry_product_detail_product_id'];
										$subqty=$subqty+$get_val['damage_entry_product_detail_qty'];
										$grandqty=$grandqty+$get_val['damage_entry_product_detail_qty'];
										}?>
										<tr><td colspan="10" >&nbsp; </td>
											<td colspan="3" > Sub Total</td>
											<td style="text-align:right"><?php echo number_format($subqty,3,'.','');?>
