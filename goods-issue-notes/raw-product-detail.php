...
<?php
	...
	$product_thick = isset($_GET['product_thick'])?$_GET['product_thick']:'';
	//$godown_id = isset($_GET['godown_id'])?number_format($_GET['godown_id'],0):'';
	$godown_id = isset($_GET['godown_id'])?$_GET['godown_id']:'';
   	if($m_id == '') {
	...
	//Edited by AuthorsMM 
	$where .=" AND product_con_entry_child_product_detail_color_id IN (".$product_color_id.")";
	//$where .=" AND product_con_entry_child_product_detail_product_brand_id IN (".$product_brand_id.")";
	$where .=" AND product_con_entry_child_product_detail_thick_ness IN (".$product_thick.")";
	//end Edited
...
<?php
		 ...
		 $query	="SELECT 
				 ...
				 LEFT JOIN
				 		(SELECT
							stock_ledger_product_id, stock_ledger_colour_id, stock_ledger_thick_ness, 
						 ...
						 WHERE
							...
							stock_ledger_godown_id		= '".$godown_id."'                                  AND 
