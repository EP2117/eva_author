...
<table style="width:100%;font-size:12px;padding-top:100px;" cellspacing="0"  ><!--class="report-outer-table"-->
	...
	<tr>
 	 <td width="100%" colspan="4" class="report-border-bottom report-border-top report-border-right report-border-left" style='text-align:center;font-weight:bold;font-size:16px;padding:10px;' > Manufacturing Production Order </td>
	</tr>
   <tr>
	  ...
	  <td width="50%" colspan="2" class="report-border-right report-border-bottom" style='text-align:left;font-weight:bold;font-size:13px;' >PO NO : &nbsp;<?=$invoice_entry_edit['production_order_no']?></td>
	...
	<tr>	 
	 ...
	 <td colspan="2" class="report-border-right report-border-bottom" style='text-align:left;font-weight:bold;font-size:13px;' >GIN NO : <?=$invoice_entry_edit['gin_entry_no']?></td>
	</tr>
	<tr>	 
	 ...
	 <td colspan="2" class="report-border-right report-border-bottom" style='text-align:left;font-weight:bold;font-size:13px;' >DATE : <?=dateGeneralFormatN($invoice_entry_edit['gin_entry_date'])?></td>
	</tr>
	<tr>	 
...
<table style="width:100%;font-size:11px;" cellspacing="0"  class="report-outer-table">
  ...
  <tr>
	  <td colspan="6" class="report-border-right report-border-bottom" style='text-align:center;font-weight:bold;font-size:13px;' >PRODUCT DETAILS </td>
  </tr>
	<thead>
			<tr>
...
?>
			<tr>
				<td class="report-border-right report-border-bottom" style='text-align:left;font-size:11px;'> 
					<?=$k?> </td>
				<td class="report-border-right report-border-bottom" style='font-family:zawgyi-one;text-align:left;font-size:11px;border-right:0px;'>
					<?php
						if($getDetail['gin_entry_product_detail_product_type'] == 4) {
				...
				<td class="report-border-right report-border-bottom" style='text-align:left;font-size:11px;border-right:0px;border-left:0px;'> 
					<?=$getDetail['colour_name']?></td>
				<td class="report-border-right report-border-bottom" style='text-align:left;font-size:11px;border-left:0px'> 
					<?=$arr_thick[number_format($getDetail['gin_entry_product_detail_product_thick'],0)] ? $arr_thick[number_format($getDetail['gin_entry_product_detail_product_thick'],0)].'mm' : '';?> </td>
				<?php
					if($getDetail['gin_entry_product_detail_product_type'] == 1) {
				?>
					<td class="report-border-right report-border-bottom" style='text-align:left;font-size:11px;'> 
					<?=$getDetail['gin_entry_product_detail_sale_length'];?></td>
					<?php
						...
						if($getDetail['gin_entry_product_detail_qty'] > 0) {
							$feet = $getDetail['gin_entry_product_detail_tot_length']/ $getDetail['gin_entry_product_detail_qty'];
							
						}else{
							if($getDetail['gin_entry_product_detail_sl_feet'] == "" || $getDetail['gin_entry_product_detail_sl_feet'] <= 0) {
								$feet = $getDetail['gin_entry_product_detail_sl_feet_in']/12;
							} else {
								$feet = $getDetail['gin_entry_product_detail_sl_feet'];
							}
						}
				...
				<?php
					...
					else if($getDetail['gin_entry_product_detail_product_type'] == 2){
				?>
					<td class="report-border-right report-border-bottom" style='text-align:left;font-size:11px;'>
						<?php
						  if($getDetail['gin_entry_product_detail_s_weight_inches'] == 0) {
							echo '';
						  } else {
							echo sprintf('%0.3f',$getDetail['gin_entry_product_detail_s_weight_inches']);
						  }
						?>
					</td>
					<!--<td class="report-border-right report-border-bottom" style='text-align:left;font-size:11px;'> 
						<?php
						  if($getDetail['gin_entry_product_detail_s_weight_met'] == 0) {
							echo '';
						  } else {
							echo round($getDetail['gin_entry_product_detail_s_weight_met']);
						  }
						?>
					</td>-->
				<?php } else { 
						if($getDetail['gin_entry_product_detail_sale_by'] == 'feet' && !empty($getDetail['gin_entry_product_detail_sale_feet'])) {
				?>					
					<td class="report-border-right report-border-bottom" ><?php echo round($getDetail['gin_entry_product_detail_sale_feet'])."'"; ?></td><!--<td class="report-border-right report-border-bottom" ></td>-->
				<?php 
					}
					else {
				?>
				...
				<!--<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;'> 
					<?php
					  if($getDetail['gin_entry_product_detail_qty'] == 0 || $getDetail['gin_entry_product_detail_sale_by'] == 'feet') {
						echo '';
					  } else {
						//echo sprintf('%0.2f',$getDetail['invoice_entry_product_detail_qty']);
						echo round($getDetail['gin_entry_product_detail_qty']);
					  }
					?>
				</td>-->
				<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;'> 
					<?php
						if($getDetail['gin_entry_product_detail_sale_by'] == 'feet') {
							echo round($getDetail['gin_entry_product_detail_qty'])."'";
						} else {
							echo round($getDetail['gin_entry_product_detail_qty']);
						}
...
<table style="width:100%;font-size:11px;" cellspacing="0"  class="report-outer-table">
  ...
  <tr>
<td colspan="8" class=" report-border-bottom" style='text-align:center;font-weight:bold;font-size:13px;' >Coil Details  </td>
</tr> 
	
	<thead >
		  <tr>
			<th rowspan="2" class="report-border-right report-border-bottom" style='text-align:center;font-weight:bold;font-size:11px; width:10%;'> Code</th>
			<th rowspan="2" class="report-border-right report-border-bottom" style='text-align:center;font-weight:bold;font-size:11px; width:10%;border-right:none;'> Coil</th>
			<th rowspan="2" class="report-border-right report-border-bottom" style='text-align:center;font-weight:bold;font-size:11px; width:10%;border-right:none;'> Color</th>
			<th rowspan="2" class="report-border-right report-border-bottom" style='text-align:center;font-weight:bold;font-size:11px; width:10%;'> Thick</th>
			<th colspan="2" class="report-border-right report-border-bottom" style='text-align:center;font-weight:bold;font-size:11px; width:10%;padding:7px;'> Length</th>
			<th colspan="2" class=" report-border-bottom" style='text-align:center;font-weight:bold;font-size:11px; width:10%;padding:7px;'> Weight</th>
			
		</tr>
		<tr>
			<th class="report-border-right report-border-bottom" style='text-align:center;font-weight:bold;font-size:11px;padding:7px;'>Feet</th>
			<th class="report-border-right report-border-bottom" style='text-align:center;font-weight:bold;font-size:11px;padding:7px;'>Meter</th>
			<th class="report-border-right report-border-bottom" style='text-align:center;font-weight:bold;font-size:11px;padding:7px;'>Ton</th>
			<th class=" report-border-bottom" style='text-align:center;font-weight:bold;font-size:11px;padding:7px;'>KG</th>
		</tr>
	</thead>
	...
	<tbody id="raw_product_detail_display">
		...
		<tr >
			<td class="report-border-right report-border-bottom" style='text-align:left;font-size:12px;'><?=$product_code?></td>
			<td class="report-border-right report-border-bottom" style='text-align:left;font-size:12px;border-right:0;'><?=$get_product_detail['brand_name']. ' ' .$product_name?></td>
			<td class="report-border-right report-border-bottom" style='text-align:left;font-size:12px;border-right:0;'><?=$product_colour_name?></td>
			<td class="report-border-right report-border-bottom" style='text-align:left;font-size:12px;'><?=$arr_thick[number_format($get_product_detail['gin_entry_raw_product_detail_product_thick'])]?>mm</td>
		...
		<tr >
			<td class="report-border-right report-border-bottom" style='text-align:left;font-size:12px;padding:11px;'></td>
			<td class="report-border-right report-border-bottom" style='text-align:left;font-size:12px;border-right:0;'></td>
			<td class="report-border-right report-border-bottom" style='text-align:left;font-size:12px;border-right:0;'></td>
			<td class="report-border-right report-border-bottom" style='text-align:left;font-size:12px;'></td>
			
			<td class="report-border-right report-border-bottom" style='text-align:left;font-size:12px;'></td>
			<td class="report-border-right report-border-bottom" style='text-align:left;font-size:12px;'></td>
			<td class="report-border-right report-border-bottom" style='text-align:left;font-size:12px;'></td>
			<td class=" report-border-bottom" style='text-align:left;font-size:12px;'></td>
...
<table style="padding-top:50px;" align="left">
	<tr>
