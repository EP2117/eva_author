								...
								<div class="panel-body">
									<div class="col-lg-6">
										...
										<div class="form-group">
											...
											<select name="gin_entry_from_godown_id" id="gin_entry_from_godown_id" class="form-control select2" style="width:100%">
												  <option value=""> - Select - </option>
												<?php
									...
									<div class="col-lg-6">
										...
										<div class="form-group">
											...
											<select name="gin_entry_to_godown_id" id="gin_entry_to_godown_id" class="form-control select2" style="width:100%">
												  <option value=""> - Select - </option>
												<?php
					   ...
					   <div class="panel panel-info">
								...
								<div class="panel-body">
									<div class="col-lg-6">
										...
										<div class="form-group">
											<label>From Warehouse</label>
											<select name="gin_entry_from_godown_id" id="gin_entry_from_godown_id" class="form-control select2" onChange="GetcustomerDetail()" style="width:100%">
												<option value=""> - Select - </option>
												<?php
												foreach($godown_list as $get_godown){
									...
									<div class="col-lg-6">
										...
										<div class="form-group">
											<label>To Warehouse</label>
											<select name="gin_entry_to_godown_id" id="gin_entry_to_godown_id" class="form-control select2" onChange="GetcustomerDetail()" style="width:100%">
												<option value=""> - Select - </option>
												<?php
												foreach($godown_Wlist as $get_godown){
                                        ...
                                        <div class="form-group">
											...
											<select name="gin_entry_type_id" id="gin_entry_type_id" class="form-control select2" style="width:100%" required onChange="getTableHeader(this.value)">
												...
												<?php
													foreach($arrQuotationType as $key => $value){
														$selected	= ($gin_entry_edit['gin_entry_type_id']==$key)?'selected="selected"':'';
												?>
							...
							<div class="panel-body">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="so_detail"  style=" width:100%" >
                                    ...
                                    <tbody id="so_detail_display">
										...
										<input type='hidden'  name='gin_entry_production_order_id' id='gin_entry_production_order_id' value="<?=$gin_entry_edit['gin_entry_production_order_id']?>" class='dc_id'  />
										<input type="hidden"  name="gin_entry_invoice_entry_id" id="gin_entry_invoice_entry_id" value="<?=$gin_entry_edit['gin_entry_invoice_entry_id']?>"  class="dc_id"  />
                                        </td>
										
										<td><?=$arr_producton_type[$sales_detail_edit['production_order_type']]?></td>
										<td><?=$sales_detail_edit['customer_name']?></td>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="product_detail"  style=" width:100%; overflow:scroll;" >
									...
									<tbody id="product_detail_display" >
										...
										foreach($gin_entry_prd_edit as $get_product_detail){
												...
												$product_uom_name		= $get_product_detail['uom_name'];
												$product_colour_name	= $get_product_detail['colour_name'];
											
											
										//echo $get_product_detail['product_name'];exit;
										...
										<tr class="rls" style="display:none">
                                            ...
                                            <input type="hidden"  name="gin_entry_product_detail_mother_child_type[]" id="gin_entry_product_detail_mother_child_type" value="<?=$get_product_detail['gin_entry_product_detail_mother_child_type']?>" />
											</td>
											...
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_width_inches[]" id="gin_entry_product_detail_width_inches<?=$row_cnt?>" value="<?=sprintf('%0.3f',$get_product_detail['gin_entry_product_detail_width_inches'])?>" onKeyUp="GetWcalc(2,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)"  />
											</td>
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_width_mm[]" id="gin_entry_product_detail_width_mm<?=$row_cnt?>" value="<?=sprintf('%0.3f',$get_product_detail['gin_entry_product_detail_width_mm'])?>" onKeyUp="GetWcalc(3,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" />
											</td>
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_s_width_inches[]" id="gin_entry_product_detail_s_width_inches<?=$row_cnt?>" value="<?=sprintf('%0.3f',$get_product_detail['gin_entry_product_detail_s_width_inches'])?>" onKeyUp="GetWcalS(2,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" />
											</td>
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_s_width_mm[]" id="gin_entry_product_detail_s_width_mm<?=$row_cnt?>" value="<?=sprintf('%0.3f',$get_product_detail['gin_entry_product_detail_s_width_mm'])?>" onKeyUp="GetWcalS(3,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" />
											</td>
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_sl_feet[]" id="gin_entry_product_detail_sl_feet<?=$row_cnt?>" value="<?=sprintf('%0.2f',$get_product_detail['gin_entry_product_detail_sl_feet'])?>" onKeyUp="GetLcalFeet(1,<?=$row_cnt?>)"  onBlur="GetTotalLength(<?=$row_cnt?>)" />
											</td>
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_sl_feet_in[]" id="gin_entry_product_detail_sl_feet_in<?=$row_cnt?>" value="<?=sprintf('%0.2f',$get_product_detail['gin_entry_product_detail_sl_feet_in'])?>" onKeyUp="GetLcalFeet(2,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" />
											</td>
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_sl_feet_mm[]" id="gin_entry_product_detail_sl_feet_mm<?=$row_cnt?>" value="<?=sprintf('%0.2f',$get_product_detail['gin_entry_product_detail_sl_feet_mm'])?>" onKeyUp="GetLcalFeet(3,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" />
											</td>
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_sl_feet_met[]" id="gin_entry_product_detail_sl_feet_met<?=$row_cnt?>" value="<?=sprintf('%0.2f',$get_product_detail['gin_entry_product_detail_sl_feet_met'])?>" onKeyUp="GetLcalFeet(3,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" />
											</td>
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_ext_feet[]" id="gin_entry_product_detail_ext_feet<?=$row_cnt?>" value="<?=sprintf('%0.2f',$get_product_detail['gin_entry_product_detail_ext_feet'])?>"  onBlur="GetTotalLength(<?=$row_cnt?>)" />
											</td>
											
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_ext_feet_in[]" id="gin_entry_product_detail_ext_feet_in<?=$row_cnt?>" onBlur="GetLcalFeet(2,<?=$row_cnt?>),GetTotalLength(<?=$row_cnt?>)"  value="<?= sprintf('%0.2f',$get_product_detail['gin_entry_product_detail_ext_feet_in'])?>"  /> 
											</td>
											
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_ext_feet_mm[]" id="gin_entry_product_detail_ext_feet_mm<?=$row_cnt?>" onblur="GetLcalFeet(3,<?=$row_cnt?>);GetTotalLength(<?=$row_cnt?>)" value="<?=sprintf('%0.2f',$get_product_detail['gin_entry_product_detail_ext_feet_mm'])?>"  />  
											</td>
											
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_ext_feet_met[]" id="gin_entry_product_detail_ext_feet_met<?=$row_cnt?>" onblur="GetLcalFeet(3,<?=$row_cnt?>);GetTotalLength(<?=$row_cnt?>)" value="<?=sprintf('%0.2f',$get_product_detail['gin_entry_product_detail_ext_feet_met'])?>"  /> 
											</td>
											
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_sale_length[]" id="gin_entry_product_detail_sale_length<?=$row_cnt?>"  value="<?=htmlspecialchars($get_product_detail['gin_entry_product_detail_sale_length']);?>" readonly />
											</td>
											
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_qty[]" id="gin_entry_product_detail_qty<?=$row_cnt?>"  value="<?=sprintf('%0.0f',$get_product_detail['gin_entry_product_detail_qty'])?>" readonly />
											</td>
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_tot_length[]" id="gin_entry_product_detail_tot_length<?=$row_cnt?>"  value="<?=sprintf('%0.2f',$get_product_detail['gin_entry_product_detail_tot_length'])?>" readonly />
											</td>
										...
										<tr class="rws" style="display:none">
											...
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_product_thick[]" id="gin_entry_product_detail_product_thick<?=$row_cnt?>" value="sss<?=$arr_thick[$get_product_detail['gin_entry_product_detail_product_thick']]?>"   />
											</td>
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_width_inches[]" id="gin_entry_product_detail_width_inches<?=$row_cnt?>" value="<?=sprintf('%0.3f',$get_product_detail['gin_entry_product_detail_width_inches'])?>" onKeyUp="GetWcalc(2,<?=$row_cnt?>)"  />
											</td>
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_width_mm[]" id="gin_entry_product_detail_width_mm<?=$row_cnt?>" value="<?=sprintf('%0.3f',$get_product_detail['gin_entry_product_detail_width_mm'])?>" onKeyUp="GetWcalc(3,<?=$row_cnt?>)"  />
											</td>
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_s_width_inches[]" id="gin_entry_product_detail_s_width_inches<?=$row_cnt?>" value="<?=sprintf('%0.3f',$get_product_detail['gin_entry_product_detail_s_width_inches'])?>" onKeyUp="GetLcalFeet(3,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" />
											</td>
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_s_width_mm[]" id="gin_entry_product_detail_s_width_mm<?=$row_cnt?>" value="<?=sprintf('%0.3f',$get_product_detail['gin_entry_product_detail_s_width_mm'])?>" onKeyUp="GetLcalFeet(3,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" />
											</td>
											
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_s_weight_inches[]" id="gin_entry_product_detail_s_weight_inches<?=$row_cnt?>" onblur="GetLcalFeet(2,<?=$row_cnt?>);GetTotalLength(<?=$row_cnt?>)"  value="<?=sprintf('%0.3f',$get_product_detail['gin_entry_product_detail_s_weight_inches'])?>"  /> 
 
											</td>
											
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_s_weight_mm[]" id="gin_entry_product_detail_s_weight_mm<?=$row_cnt?>" onblur="GetLcalFeet(3,<?=$row_cnt?>);GetTotalLength(<?=$row_cnt?>)" value="<?=sprintf('%0.3f',$get_product_detail['gin_entry_product_detail_s_weight_mm'])?>"  />
											</td>
											
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_tot_feet[]" id="gin_entry_product_detail_tot_feet<?=$row_cnt?>" onblur="GetLcalFeet(3,<?=$row_cnt?>);GetTotalLength(<?=$row_cnt?>)" value="<?=sprintf('%0.2f',$get_product_detail['gin_entry_product_detail_tot_feet'])?>"  />
											</td>
											
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_tot_meter[]" id="gin_entry_product_detail_tot_meter<?=$row_cnt?>"  value="<?=sprintf('%0.2f',$get_product_detail['gin_entry_product_detail_tot_meter'])?>" />
											</td>
										...
										<tr >
											...
											<td>
											<?=$get_product_detail['uom_name']?>
											
											<input class="form-control" type="hidden"  name="gin_entry_product_detail_product_uom_id[]" id="gin_entry_product_detail_product_uom_id<?=$row_cnt?>" value="<?=$get_product_detail['uom_id']?>" onBlur="GetTotalLength(<?=$row_cnt?>)"  />
											</td>
											<td>
											
											<?php
												if(isset($get_product_detail['product_is_opp']) && $get_product_detail['product_is_opp'] == 1) {
											?>
												<select  name="gin_entry_product_detail_sale_by[]" id="gin_entry_product_detail_sale_by<?=$row_cnt?>" class="form-control" style="width:30%;display:inline-block" readonly ><option value="qty" <?=$get_product_detail['gin_entry_product_detail_sale_by']=='qty'?'selected':''?>>QTY</option><option value="feet" <?=$get_product_detail['gin_entry_product_detail_sale_by']=='feet'?'selected':''?>>FEET</option></select>&nbsp;&nbsp;&nbsp;
											<?php
												}
												else {
											?>
												<select  name="gin_entry_product_detail_sale_by[]" id="gin_entry_product_detail_sale_by<?=$row_cnt?>" class="form-control" style="width:30%;display:inline-block" readonly ><option value="qty">QTY</option></select>&nbsp;&nbsp;&nbsp;
											<?php
												}
											?>
											<input class="form-control" type="text"  name="gin_entry_product_detail_qty[]" id="gin_entry_product_detail_qty<?=$row_cnt?>"  style="display:inline-block;width:60%" value="<?=sprintf('%0.0f',$get_product_detail['gin_entry_product_detail_qty'])?>" onKeyUp="GetWcalc(2,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" readonly />
...
<input type="hidden"  name="gin_entry_raw_product_detail_product_type[]" id="gin_entry_raw_product_detail_product_type<?=$row_cnt?>" value="<?=$get_product_detail['	gin_entry_raw_product_detail_product_type']?>" />
											...
											<td>
											<input class="form-control" type="text"  name="gin_entry_raw_product_detail_width_inches[]" id="gin_entry_raw_product_detail_width_inches<?=$row_cnt?>" value="<?=sprintf('%0.3f',$get_product_detail['gin_entry_raw_product_detail_width_inches'])?>" onKeyUp="GetWcalc(2,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)"  />
											</td>
											<td>
											<input class="form-control" type="text"  name="gin_entry_raw_product_detail_width_mm[]" id="gin_entry_raw_product_detail_width_mm<?=$row_cnt?>" value="<?=sprintf('%0.3f',$get_product_detail['gin_entry_raw_product_detail_width_mm'])?>" onKeyUp="GetWcalc(3,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" />
											</td>
											<td>
											<input class="form-control" type="text"  name="gin_entry_raw_product_detail_sl_feet[]" id="gin_entry_raw_product_detail_sl_feet<?=$row_cnt?>" value="<?=sprintf('%0.2f',$get_product_detail['gin_entry_raw_product_detail_sl_feet'])?>" onKeyUp="GetRLcalFeet(1,<?=$row_cnt?>)"  onBlur="GetRTotalLength(<?=$row_cnt?>)" readonly />
											</td>
											<td>
											<input class="form-control" type="text"  name="gin_entry_raw_product_detail_sl_feet_mm[]" id="gin_entry_raw_product_detail_sl_feet_mm<?=$row_cnt?>" value="<?=sprintf('%0.2f',$get_product_detail['gin_entry_raw_product_detail_sl_feet_mm'])?>" onKeyUp="GetRLcalFeet(2,<?=$row_cnt?>)" onBlur="GetRTotalLength(<?=$row_cnt?>)" readonly />
											</td>
											<td>
											<input class="form-control" type="text"  name="gin_entry_raw_product_detail_ton[]" id="gin_entry_raw_product_detail_ton<?=$row_cnt?>" value="<?=sprintf('%0.2f',$get_product_detail['gin_entry_raw_product_detail_ton'])?>" onKeyUp="GetRLcalFeet(3,<?=$row_cnt?>)" onBlur="GetRTotalLength(<?=$row_cnt?>)" readonly />
											</td>
											
											
											<td><input class="form-control" type="text"  name="gin_entry_raw_product_detail_kg[]" id="gin_entry_raw_product_detail_kg<?=$row_cnt?>" onBlur="GetRTotalLength(<?=$row_cnt?>);GetRLcalFeet(3,<?=$row_cnt?>);" value="<?=sprintf('%0.2f',$get_product_detail['gin_entry_raw_product_detail_kg'])?>" readonly  /> 
											</td>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<?php
										...
										$edit_status = editStatus('grn_entry_product_details','grn_entry_product_detail_gin_entry_id',$get_quotation['gin_entry_id'],'grn_entry_product_detail_deleted_status');
									...
									?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?=($get_quotation['production_order_type']>0)?$arr_producton_type[$get_quotation['production_order_type']]:""?></td>
