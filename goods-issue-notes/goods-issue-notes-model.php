<?php
	...
	function insertQuotation(){
		...
		//Product Detail
		$gin_entry_product_detail_sale_by  	= isset($_POST['gin_entry_product_detail_sale_by'])?$_POST['gin_entry_product_detail_sale_by']:'';
		...
		$gin_entry_product_detail_sale_length 		= isset($_POST['gin_entry_product_detail_sale_length'])?$_POST['gin_entry_product_detail_sale_length']:'';
			...
			if($detail_request_fields) {
				...
				$insert_gin_entry_product_detail 		= sprintf("INSERT INTO gin_entry_product_details 
																				(gin_entry_product_detail_uniq_id,gin_entry_product_detail_gin_entry_id,
																				 ...
																				 gin_entry_product_detail_added_ip,gin_entry_product_detail_mother_child_type, gin_entry_product_detail_sale_length, gin_entry_product_detail_sale_by) 
																	VALUES     ('%s', '%d', 
																				'%d', '%d',
																				'%d', '%d',
																				'%d', '%d', 
																		 ...
																		 mysql_real_escape_string($gin_entry_product_detail_sale_length[$i]),
																		 $gin_entry_product_detail_sale_by[$i]);
			...
			if($detail_request_fields) {
				$gin_entry_raw_product_detail_uniq_id 	= generateUniqId();
				 $insert_gin_entry_raw_product_detail 		= sprintf("INSERT INTO gin_entry_raw_product_details 
																				(gin_entry_raw_product_detail_uniq_id,
																				gin_entry_raw_product_detail_gin_entry_id,
																				 ...
																				 gin_entry_raw_product_detail_width_inches,
																				 gin_entry_raw_product_detail_width_mm,
																				 ...
																				 gin_entry_raw_product_detail_mother_child_type) 
																	VALUES     ('%s', '%d', 
																				'%d', '%d',
																				'%d', '%d', 
																				'%f', '%f', 
																		 ...
																		 $gin_entry_raw_product_detail_product_color_id[$i],
																		 $gin_entry_raw_product_detail_product_type[$i], 
																		 $gin_entry_raw_product_detail_product_thick[$i],
																		 ...
																		 $gin_entry_raw_product_detail_mother_child_type[$i]);
	...
	function editQuotation(){
		...
		$select_gin_entry		=	"SELECT 
												...
												production_order.production_order_no, production_order.production_order_validity_date, customers.customer_name, customers.customer_billing_address, customers.customer_mobile_no,
											 ...
											 FROM 
												...
												LEFT JOIN production_order ON production_order.production_order_id = gin_entry.gin_entry_production_order_id
												
												LEFT JOIN
												customers ON customers.customer_id = production_order.production_order_customer_id
...

	{
		...
		$select_gin_entry_product_detail 	= "	SELECT 
														...
														gin_entry_product_detail_sale_length,
														gin_entry_product_detail_sale_by,
				...
				if(isset($gin_entry_product_detail_id[$i]) && (!empty($gin_entry_product_detail_id[$i]))) {
					 ...
					 $update_gin_entry_product_detail = sprintf("UPDATE 
																		...
																		SET  
																			...
																			gin_entry_product_detail_sale_length 			= '%s'
																			gin_entry_product_detail_sale_by  				= '%s'
																		WHERE 
