...
function GetDetail(){
	...
	var t_id			= $('#advance_entry_type_id').val();
	if(t_id !='' && t_id !=0 ){
...
function AddproductDetail(){
		  ...
		  var t_id					= document.getElementById('advance_entry_type_id').value;
	for (var i = 0; i < document.getElementById('product_list_form').elements.length; i++) { 
		...
		if (document.getElementById('product_list_form').elements[i].checked == true) {
			...
			apnd	+= '<tr><td>'+product_brand_name+'</td><td>'+product_name+'<input type="hidden"  name="advance_entry_product_detail_product_id[]" id="advance_entry_product_detail_product_id" value="'+product_id+'" /><input type="hidden"  name="advance_entry_product_detail_product_brand_id[]" id="advance_entry_product_detail_product_brand_id" value="'+product_brand_id+'" /><input type="hidden"  name="advance_entry_product_detail_product_type[]" id="advance_entry_product_detail_product_type" value="'+product_type+'" />';
			
			apnd	+= '<td>'+product_colour_name+'<input type="hidden"  name="advance_entry_product_detail_product_color_id[]" id="advance_entry_product_detail_product_color_id'+row_cnt+'" value="'+product_colour_id+'"   /><input type="hidden"  name="advance_entry_product_detail_product_uom_id[]" id="advance_entry_product_detail_product_uom_id'+row_cnt+'" value="'+product_uom_id+'"   /></td>';
			
			apnd	+= '<td><input type="hidden"  name="advance_entry_product_detail_product_thick[]" id="advance_entry_product_detail_product_thick'+row_cnt+'" value="'+product_thick_ness+'"   /><input class="form-control" type="text"  name="advance_entry_product_detail_product_thick_val[]" id="advance_entry_product_detail_product_thick_val'+row_cnt+'" value="'+product_thick_ness_val+'"   /></td>';
			
			apnd	+= '<td><input class="form-control" type="text"  name="advance_entry_product_detail_width_inches[]" id="advance_entry_product_detail_width_inches'+row_cnt+'"  onkeyup="GetLcalc(2,'+row_cnt+')" onBlur="GetTotalLength('+row_cnt+')" value="'+product_inches+'"  /></td> <td><input class="form-control" type="text"  name="advance_entry_product_detail_width_mm[]" id="advance_entry_product_detail_width_mm'+row_cnt+'"  onkeyup="GetLcalc(3,'+row_cnt+')" onBlur="GetTotalLength('+row_cnt+')" value="'+product_inches_mm+'"  /></td>';
			...
			apnd	+= '<td><input class="form-control" type="text"  name="advance_entry_product_detail_width_inches[]" id="advance_entry_product_detail_width_inches'+row_cnt+'"  onkeyup="GetLcalc(2,'+row_cnt+')" value="'+product_inches+'"  /></td> <td><input class="form-control" type="text"  name="advance_entry_product_detail_width_mm[]" id="advance_entry_product_detail_width_mm'+row_cnt+'"   onkeyup="GetLcalc(3,'+row_cnt+')" value="'+product_inches_mm+'"  /></td>';
			
			apnd	+= '<td><input class="form-control" type="text"  name="advance_entry_product_detail_s_weight_inches[]" id="advance_entry_product_detail_s_weight_inches'+row_cnt+'"  onblur="GetWeightClc(1,'+row_cnt+')"  /></td> <td><input class="form-control" type="text"  name="advance_entry_product_detail_s_weight_mm[]" id="advance_entry_product_detail_s_weight_mm'+row_cnt+'"  onblur="GetWeightClc(2,'+row_cnt+')" /></td>';
			...
			apnd	+= '<td><input class="form-control" type="text"  name="advance_entry_product_detail_width_inches[]" id="advance_entry_product_detail_width_inches'+row_cnt+'"  onkeyup="GetLcalc(2,'+row_cnt+')" value="'+product_inches+'" onBlur="GetTotalLength('+row_cnt+')" /></td> <td><input class="form-control" type="text"  name="advance_entry_product_detail_width_mm[]" id="advance_entry_product_detail_width_mm'+row_cnt+'" onBlur="GetTotalLength('+row_cnt+')"  onkeyup="GetLcalc(3,'+row_cnt+')" value="'+product_inches_mm+'"  /></td>';
			
			apnd	+= '<td><input class="form-control" type="text"  name="advance_entry_product_detail_s_width_inches[]" id="advance_entry_product_detail_s_width_inches'+row_cnt+'" onkeyup="GetLcalS(2,'+row_cnt+')" onBlur="GetTotalLength('+row_cnt+')" /></td> <td><input class="form-control" type="text"  name="advance_entry_product_detail_s_width_mm[]" id="advance_entry_product_detail_s_width_mm'+row_cnt+'"   onkeyup="GetLcalS(3,'+row_cnt+')" onBlur="GetTotalLength('+row_cnt+')" /></td>';
			
			apnd	+= '<td><input class="form-control" type="text"  name="advance_entry_product_detail_sl_feet[]" id="advance_entry_product_detail_sl_feet'+row_cnt+'" onblur="GetLcalFeet(1,'+row_cnt+')" onBlur="GetTotalLength('+row_cnt+')" /></td> <td><input class="form-control" type="text"  name="advance_entry_product_detail_sl_feet_in[]" id="advance_entry_product_detail_sl_feet_in'+row_cnt+'" onblur="GetLcalFeet(1,'+row_cnt+')" onBlur="GetTotalLength('+row_cnt+')" /></td><td><input class="form-control" type="text"  name="advance_entry_product_detail_sl_feet_mm[]" id="advance_entry_product_detail_sl_feet_mm'+row_cnt+'" onblur="GetLcalFeet(3,'+row_cnt+')" onBlur="GetTotalLength('+row_cnt+')" /></td>';
			
			apnd	+= '<td><input class="form-control" type="text"  name="advance_entry_product_detail_qty[]" id="advance_entry_product_detail_qty'+row_cnt+'" onBlur="GetTotalLength('+row_cnt+'),discountPerFind('+row_cnt+');"   /></td><td><input class="form-control" type="text"  name="advance_entry_product_detail_tot_length[]" id="advance_entry_product_detail_tot_length'+row_cnt+'" readonly /></td><td><input class="form-control" type="text"  name="advance_entry_product_detail_rate[]" id="advance_entry_product_detail_rate'+row_cnt+'"   onBlur="discountPerFind('+row_cnt+')"  /></td><td><input class="form-control" type="text"  name="advance_entry_product_detail_total[]" id="advance_entry_product_detail_total'+row_cnt+'" readonly=""  /></td></tr>';
				
				
			}else{ 
			
			apnd	+= '<tr><td>'+product_name+'<input type="hidden"  name="advance_entry_product_detail_product_id[]" id="advance_entry_product_detail_product_id" value="'+product_id+'" /><input type="hidden"  name="advance_entry_product_detail_product_type[]" id="advance_entry_product_detail_product_type" value="'+product_type+'" /></td>';
...

{
	...
	var tax_amount 				= (isNaN(tax_amount)? 0.00 : parseFloat(tax_amount));
	 ...
	 document.getElementById('advance_entry_tax_amount').value	= tax_amount;
	...
	document.getElementById('advance_entry_net_amount').value 	= net_amount;
...
function GetTotalLength(id){
	...
	document.getElementById('advance_entry_product_detail_tot_length'+id).value = total_length_val.toFixed(2);
