								...
								<div class="panel-body">
									...
									<div class="col-lg-6">
										...
										<div class="form-group">
											...
											<select name="advance_entry_type_id" id="advance_entry_type_id" class="form-control select2" style="width:100%" required onChange="getTableHeader(this.value)">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="product_detail"  style=" width:100%" >
                                    ...
                                    <tbody id="product_detail_display" >
										...
										foreach($advance_entry_prd_edit as $get_product_detail){
											...
											if($get_product_detail['advance_entry_product_detail_product_type']==1){
										...
										<tr class="rls" style="display:none">
											...
											<input class="form-control" type="text"  name="advance_entry_product_detail_product_thick[]" id="advance_entry_product_detail_product_thick<?=$row_cnt?>" value="<?=$get_product_detail['advance_entry_product_detail_product_thick']?>"   />
										...
										<tr class="rws" style="display:none">
											...
											<input type="hidden"  name="advance_entry_product_detail_product_thick[]" id="advance_entry_product_detail_product_thick<?=$row_cnt?>" value="<?=$get_product_detail['advance_entry_product_detail_product_thick']?>"   />
											<input class="form-control" type="text"  name="advance_entry_product_detail_product_thick_val[]" id="advance_entry_product_detail_product_thick_val<?=$row_cnt?>" value="<?=$arr_thick[$get_product_detail['advance_entry_product_detail_product_thick']]?>"   />
											</td>
										...
										<tr class="ccs" style="display:none">
											...
											<input class="form-control" type="text"  name="advance_entry_product_detail_product_thick[]" id="advance_entry_product_detail_product_thick<?=$row_cnt?>" value="<?=$get_product_detail['advance_entry_product_detail_product_thick']?>" onBlur="GetTotalLength(<?=$row_cnt?>)"  />
