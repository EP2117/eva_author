...
?>
			...
			<tr class="odd gradeX">
				<td>
				<input type="checkbox" name="dam_grn_entry_raw_product_detail_id[]" id="dam_grn_entry_raw_product_detail_id<?php echo $record_so_detail['grn_entry_raw_product_detail_id'];?>" value="<?php echo $record_so_detail['grn_entry_raw_product_detail_id']; ?>" />
				...
				<input type="hidden" name="product_thick_ness" id="dam_product_thick_ness<?php echo $record_so_detail['grn_entry_raw_product_detail_id'];?>" value="<?php echo $arr_thick[$record_so_detail['product_con_entry_child_product_detail_thick_ness']]; ?>" >
				<input type="hidden" name="product_thick_ness_id" id="dam_product_thick_ness_id<?php echo $record_so_detail['grn_entry_raw_product_detail_id'];?>" value="<?php echo $record_so_detail['product_con_entry_child_product_detail_thick_ness']; ?>" >
				<input type="hidden" name="product_id" id="dam_product_id<?php echo $record_so_detail['grn_entry_raw_product_detail_id'];?>" value="<?php echo $record_so_detail['grn_entry_raw_product_detail_product_id']; ?>" >
