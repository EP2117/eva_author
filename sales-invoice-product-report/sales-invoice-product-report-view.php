...
<head>
    ...
    <title>Invoice Product Entry</title>
<?php 
...
?>
<script type="text/javascript" src="<?php echo PROJECT_PATH.'/sales-invoice-product-report/sales-invoice-product-report-javascript.js'; ?>"></script>
</head>
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Invoice Product Report</h1>
								...
								?>
                                    ...
                                    <tbody >
										...
										<td class="text-right"><?php echo $sno++;?></td>	
											...
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['invoice_entry_product_detail_s_width_inches']);?></td>
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['invoice_entry_product_detail_s_width_mm']);?></td>
											<!--<td><?php echo $get_val['invoice_entry_product_detail_sl_feet'];?></td>
											<td><?php echo $get_val['invoice_entry_product_detail_sl_feet_met'];?></td>-->
