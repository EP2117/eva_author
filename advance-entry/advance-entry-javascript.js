	...
	table.$('.check_prd_id:checkbox:checked').each(function(){ 
			...
			$("#product_detail_rls_display").append(apnd);
				...
				row_cnt=Number(row_cnt)+1;
						...
						apnd	+= '<tr><td style=" width:9%"><input type="hidden"  name="advance_entry_product_detail_mother_child_type[]" id="advance_entry_product_detail_mother_child_type'+row_cnt+'" value="'+mother_child_type+'" />'+product_brand_name+'</td><td  style=" width:9%">'+product_name+'<input type="hidden"  name="advance_entry_product_detail_product_id[]" id="advance_entry_product_detail_product_id'+row_cnt+'" value="'+product_id+'" /><input type="hidden"  name="advance_entry_product_detail_mas_product_id[]" id="advance_entry_product_detail_mas_product_id'+row_cnt+'" value="'+mas_product_id+'" /> <input type="hidden"  name="advance_entry_product_detail_product_brand_id[]" id="advance_entry_product_detail_product_brand_id'+row_cnt+'" value="'+product_brand_id+'" /><input type="hidden"  name="advance_entry_product_detail_product_type[]" id="advance_entry_product_detail_product_type" value="'+product_type+'" /><input type="hidden"  name="advance_entry_product_detail_entry_type[]" id="advance_entry_product_detail_entry_type" value="'+t_id+'" /><input type="hidden"  name="advance_entry_product_detail_id[]" id="advance_entry_product_detail_id'+row_cnt+'" value="" /></td>';
						...
						apnd	+= '<td><input class="form-control" type="text"  name="advance_entry_product_detail_s_weight_inches[]" id="advance_entry_product_detail_s_weight_inches'+row_cnt+'"  onblur="GetLcalFeet(9,'+row_cnt+');GetWeightClc(1,'+row_cnt+');RawdiscountPerFind('+row_cnt+')" ; /></td> <td><input class="form-control" type="text"  name="advance_entry_product_detail_s_weight_mm[]" id="advance_entry_product_detail_s_weight_mm'+row_cnt+'"  onblur="GetWeightClc(2,'+row_cnt+')" /><input type="hidden"  name="advance_entry_product_detail_qty[]" id="advance_entry_product_detail_qty'+row_cnt+'"  /></td><td><input type="text" class="form-control" name="advance_entry_product_detail_s_weight_met[]" id="advance_entry_product_detail_s_weight_met'+row_cnt+'"/></td>';
						
						apnd	+= '</td><td><input class="form-control" type="text"  name="advance_entry_product_detail_rate[]" id="advance_entry_product_detail_rate'+row_cnt+'" onBlur="RawdiscountPerFind('+row_cnt+')"   /></td><td><input class="form-control" type="text"  name="advance_entry_product_detail_total[]" id="advance_entry_product_detail_total'+row_cnt+'"  /><input class="form-control" type="hidden"  name="advance_entry_product_detail_sl_feet_mm[]" id="advance_entry_product_detail_sl_feet_mm'+row_cnt+'"  /><input class="form-control" type="hidden"  name="advance_entry_product_detail_sl_feet_met[]" id="advance_entry_product_detail_sl_feet_met'+row_cnt+'"  /> <input class="form-control" type="hidden"  name="advance_entry_product_detail_sl_feet[]" id="advance_entry_product_detail_sl_feet'+row_cnt+'"  /> <input class="form-control" type="hidden"  name="advance_entry_product_detail_sl_feet_in[]" id="advance_entry_product_detail_sl_feet_in'+row_cnt+'" /></td></tr>';	
			...
			$("#product_detail_rws_display").append(apnd);
				...
				row_cnt=Number(row_cnt)+1;
					...
					apnd	+= '<tr><td><input type="hidden"  name="advance_entry_product_detail_mother_child_type[]" id="advance_entry_product_detail_mother_child_type'+row_cnt+'" value="'+mother_child_type+'" />'+product_name+'<input type="hidden"  name="advance_entry_product_detail_product_id[]" id="advance_entry_product_detail_product_id'+row_cnt+'" value="'+product_id+'" /><input type="hidden"  name="advance_entry_product_detail_product_type[]" id="advance_entry_product_detail_product_type"  value="'+product_type+'" /><input type="hidden"  name="advance_entry_product_detail_entry_type[]" id="advance_entry_product_detail_entry_type" value="'+t_id+'" /><input type="hidden"  name="advance_entry_product_detail_id[]" id="advance_entry_product_detail_id'+row_cnt+'" value="" /></td>';
...
{ 
	...
	document.getElementById('advance_entry_dis_amount').value 	= dis_amount;
	...
	var tax_amount 				= (isNaN(tax_amount)? 0.00 : parseFloat(tax_amount));
	 ...
	 var net_amount				= parseFloat(transport_amount)+parseFloat(gross_amount)-(parseFloat(advance_amount))-(parseFloat(dis_amount));
	 //alert(net_amount);

	/*var net_amount				= parseFloat(transport_amount)+parseFloat(gross_amount);

	var net_amount				= parseFloat(net_amount)+parseFloat(dis_amount));
...
function GetTotalLength(id){
	...
	document.getElementById('advance_entry_product_detail_tot_length'+id).value = (sales_length*product_qty);
	document.getElementById('advance_entry_product_detail_inv_tot_length'+id).value = total_length_val;
...
var pr_id=$("#advance_entry_product_detail_product_id"+id).val();
var child_type=$("#advance_entry_product_detail_mother_child_type"+id).val();
var thick=$("#advance_entry_product_detail_product_thick"+id).val();
var brand_id=$("#advance_entry_product_detail_product_brand_id"+id).val();
var width_inches=$("#advance_entry_product_detail_s_width_inches"+id).val();
	...
	$.get(
		...
		function(data) {
			...
			if(calculation_id==10){
				...
				document.getElementById('advance_entry_product_detail_s_weight_inches'+id).value 	= data_t[4];
				document.getElementById('advance_entry_product_detail_s_weight_mm'+id).value 		= data_t[5];
			}
			else if(calculation_id==3){
				...
				document.getElementById('advance_entry_product_detail_sl_feet'+id).value 		= data_t[2];
				document.getElementById('advance_entry_product_detail_sl_feet_in'+id).value 		= data_t[3];
				document.getElementById('advance_entry_product_detail_sl_feet_mm'+id).value 		= data_t[4];
				document.getElementById('advance_entry_product_detail_sl_feet_met'+id).value 		= data_t[5];
			}
			/*document.getElementById('advance_entry_product_detail_sl_feet'+id).value 			= parseFloat(data_t[0]);
