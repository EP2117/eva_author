...
$select="SELECT *	FROM account_sub WHERE account_sub_deleted_status=	0 AND account_sub_type_id = '".$id."'"; 
...
function GetAutoNo($advance_entry_branch_id){
	...
	function insertQuotation(){
	 ...
	 $select_branch	= "SELECT branch_prefix FROM branches WHERE  branch_id = '".$_POST['advance_entry_branch_id']."' ";
		...
		$advance_entry_no                   			= 'A'.$res['branch_prefix'].GetAutoNo($_POST['advance_entry_branch_id']);
		...
		$advance_entry_payment_mode                    = trim($_POST['advance_entry_payment_mode']);
		$advance_entry_acc_bank_id						= trim($_POST['advance_entry_acc_bank_id']); 
		$advance_entry_brand_id     					= trim($_POST['advance_entry_brand_id']);
		...
		$insert_advance_entry 							= sprintf("INSERT INTO advance_entry  (advance_entry_uniq_id, advance_entry_date,
																							  ...
																							  advance_entry_acc_bank_id,advance_entry_brand_id) 
																			VALUES 	 		 ('%s', '%s', 
																							  '%d', '%s', 
																							  '%f', '%f', 
																							  '%f', '%f', 
																							 ...
																							 $advance_entry_dis_amount,$advance_entry_payment_mode,
																							 $advance_entry_acc_bank_id,$advance_entry_brand_id);  
...
$advance_entry_product_detail_mother_child_type 			= $_POST['advance_entry_product_detail_mother_child_type'];
...
$advance_entry_product_detail_s_weight_met		=isset($_POST['advance_entry_product_detail_s_weight_met'])?$_POST['advance_entry_product_detail_s_weight_met']:'';
			 	...
			 	$insert_advance_entry_product_detail 		= sprintf("INSERT INTO advance_entry_product_details 
																				(advance_entry_product_detail_uniq_id,advance_entry_product_detail_advance_entry_id,
																				 ...
																				 advance_entry_product_detail_added_ip ,advance_entry_product_detail_entry_type,
																				  advance_entry_product_detail_s_weight_met,advance_entry_product_detail_mother_child_type) 
																	VALUES     ('%s', '%d', 
																				'%d', '%d',
																				'%d', '%d',
																				'%d', '%f', 
																		 ...
																		 $advance_entry_product_detail_s_weight_met[$i],$advance_entry_product_detail_mother_child_type[$i]);
	...
	function editQuotation(){
		...
		$select_advance_entry		=	"SELECT 
											 ...
											 ON
												...
												brands
											 ON
												brand_id		=  advance_entry_brand_id
											 ...
											 ORDER BY 
												...
												advance_entry_no ASC";
									//echo $select_advance_entry	;exit;			
...

	{
	 ...
	 $select_advance_entry_product_detail 		= "SELECT 
														...
														WHERE 
															advance_entry_product_detail_deleted_status		 	= 0 							
															AND advance_entry_product_detail_mother_child_type=1
															AND  advance_entry_product_detail_advance_entry_id 		= '".$advance_entry_id."'";
//echo $select_advance_entry_product_detail;exit;
		...
		$select_advance_entry_product_detail 		= "SELECT 
															...
															product_con_entry_child_product_detail_product_id as product_id,
														...
														WHERE 
															advance_entry_product_detail_deleted_status		 	= 0 							
															AND advance_entry_product_detail_mother_child_type=2
															AND advance_entry_product_detail_advance_entry_id 		= '".$advance_entry_id."'";
//echo $select_advance_entry_product_detail;exit;
		$result_advance_entry_product_detail 	= mysql_query($select_advance_entry_product_detail);
		$count_advance_entry 					= mysql_num_rows($result_advance_entry_product_detail);
	...
	function updateQuotation(){
		...
		$advance_entry_id                   			= trim($_POST['advance_entry_id']);//echo $advance_entry_id ;exit;
		...
		$advance_entry_dis_amount                 		= trim($_POST['advance_entry_dis_amount']);
		$advance_entry_payment_mode                    = trim($_POST['advance_entry_payment_mode']);
		$advance_entry_acc_bank_id						= trim($_POST['advance_entry_acc_bank_id']); //echo $advance_entry_acc_bank_id	;exit;
		$advance_entry_brand_id     					= trim($_POST['advance_entry_brand_id']);
		...
		$update_customer 					= sprintf("	UPDATE 
														...
														SET 
															...
															advance_entry_payment_mode				= '%d',
															advance_entry_acc_bank_id				= '%d',
															advance_entry_brand_id					='%d',
														...
														WHERE               
															...
															$advance_entry_payment_mode,
															$advance_entry_acc_bank_id,
															$advance_entry_brand_id,
...
//print_r($advance_entry_product_detail_id);exit;

		for($i = 0; $i < count($advance_entry_product_detail_product_id); $i++) {

			$detail_request_fields = ((!empty($advance_entry_product_detail_product_id[$i])) &&

									 (!empty($advance_entry_product_detail_rate[$i])));
					...
					$advance_entry_product_detail_uniq_id 	= generateUniqId();
					 ...
					 $insert_advance_entry_product_detail 		= sprintf("INSERT INTO advance_entry_product_details 
																	...
																	VALUES     ('%s', '%d', 
																		 ...
																		 $advance_entry_product_detail_rate[$i],$advance_entry_product_detail_total[$i],
																		 $_SESSION[SESS.'_session_user_id'],$ip,$advance_entry_product_detail_entry_type[$i],
																		 $advance_entry_product_detail_mother_child_type[$i]);				//exit;
																	// echo $insert_advance_entry_product_detail; exit;
				mysql_query($insert_advance_entry_product_detail);
					$detail_id	= mysql_insert_id();
				}
