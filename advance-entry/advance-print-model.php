...

	{
	 ...
	 $select_advance_entry_product_detail 		= "SELECT 
														...
														WHERE 
															...
															AND advance_entry_product_detail_mother_child_type=1							AND 
		...
		$select_advance_entry_product_detail1 		= "SELECT 
															A.*,
														...
														WHERE 
															advance_entry_product_detail_deleted_status		 	= 0 							
															AND advance_entry_product_detail_mother_child_type=2							AND 
															advance_entry_product_detail_advance_entry_id 		= '".$advance_entry_id."'";

		$result_advance_entry_product_detail1 	= mysql_query($select_advance_entry_product_detail1);
		$count_advance_entry1 					= mysql_num_rows($result_advance_entry_product_detail1);
		
		while($record_advance_entry_product_detail1 = mysql_fetch_array($result_advance_entry_product_detail1)) {
			$arr_advance_entry_product_detail[] = $record_advance_entry_product_detail1;
		}
