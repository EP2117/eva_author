...
<body >
   ...
   <tr>
	  <td width="50%" colspan="2" class="report-border-left report-border-right report-border-bottom" style='text-align:left;font-weight:bold;font-size:13px;' >ADVANCE NO : &nbsp;<?=$invoice_entry_edit['advance_entry_no']?></td>
		...
		//if($getDetail['advance_entry_product_detail_entry_type']==1){
			?>
				<tr>
					...
					<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
						<?=number_format($getDetail['advance_entry_product_detail_sl_feet'],3,'.','')?> </td>
						<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
						<?=number_format($getDetail['advance_entry_product_detail_sl_feet_in'],2,'.','')?> </td>
						<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
						<?=number_format($getDetail['advance_entry_product_detail_sl_feet_mm'])?> </td>
						<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					...
					<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
						<?=round($getDetail['advance_entry_product_detail_qty'])?> </td>
					<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
						<?=number_format($getDetail['advance_entry_product_detail_tot_length'],2,'.','')?> </td>
					<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
						<?=round($getDetail['advance_entry_product_detail_rate'])?> </td>
					<td class="report-border-bottom" style='text-align:center;font-size:11px;' > 
						<?=round($getDetail['advance_entry_product_detail_total'])?> </td>
				</tr>
...
<table style="width:100%;font-size:11px;" cellspacing="0"  class="report-outer-table">
	<tr>
		...
		<td class="report-border-right report-border-bottom" style='text-align:right;font-weight:bold;font-size:11px;width:15%' > <?=round($invoice_entry_edit['advance_entry_gross_amount'])?> &nbsp;&nbsp;</td>
	</tr>
	<tr>
		<td colspan="2" class="report-border-right " style='text-align:center;font-weight:bold;font-size:11px;width:60%' >  </td>
		...
		<td class="report-border-right report-border-bottom" style='text-align:right;font-weight:bold;font-size:11px;width:15%' > <?=round($invoice_entry_edit['advance_entry_transport_amount'])?> &nbsp;&nbsp;</td>
	</tr>
	<tr>
		<td colspan="2" class="report-border-right " style='text-align:center;font-weight:bold;font-size:11px;width:60%' >  </td>
		<td class="report-border-right report-border-bottom" style='text-align:left;font-weight:bold;font-size:11px;width:25%' > Dis : &nbsp;&nbsp;&nbsp;&nbsp; <?=round($invoice_entry_edit['advance_entry_dis_per'])?> % </td>
		<td class="report-border-right report-border-bottom" style='text-align:right;font-weight:bold;font-size:11px;width:15%' > <?=round($invoice_entry_edit['advance_entry_dis_amount'])?> &nbsp;&nbsp;</td>
	</tr>
	<tr>
		<td colspan="2" class="report-border-right " style='text-align:center;font-weight:bold;font-size:11px;width:60%' >  </td>
		<!--<td class="report-border-right report-border-bottom" style='text-align:left;font-weight:bold;font-size:11px;width:25%' > Tax : &nbsp;&nbsp;&nbsp;&nbsp; <?=round($invoice_entry_edit['advance_entry_tax_per'])?> % </td>-->
		<td class="report-border-right report-border-bottom" style='text-align:left;font-weight:bold;font-size:11px;width:25%' > Tax : &nbsp;&nbsp;&nbsp;&nbsp; 5 % </td>
		<td class="report-border-right report-border-bottom" style='text-align:right;font-weight:bold;font-size:11px;width:15%' > <?=round($invoice_entry_edit['advance_entry_tax_amount'])?> &nbsp;&nbsp;</td>
	</tr>
	<tr>
		<td colspan="2" class="report-border-right " style='text-align:center;font-weight:bold;font-size:11px;width:60%' >  </td>
		...
		<td class="report-border-right report-border-bottom" style='text-align:right;font-weight:bold;font-size:11px;width:15%' > <?=round($invoice_entry_edit['advance_entry_advance_amount'])?> &nbsp;&nbsp;</td>
	</tr>
	<tr>
		<td colspan="2" class="report-border-right " style='text-align:center;font-weight:bold;font-size:11px;width:60%' >  </td>
		...
		<td class="report-border-right report-border-bottom" style='text-align:right;font-weight:bold;font-size:11px;width:15%' > <?=round($invoice_entry_edit['advance_entry_net_amount'])?> &nbsp;&nbsp;</td>
	</tr>
</table>
