        ...
        <div id="page-wrapper">
            ...
            <div id="page-inner">
				...
				if(isset($_GET['print_status']) && $_GET['print_status']==1)
				{
				 ?>
				 <script>
				 window.open("advance-print.php?id=<?=$_GET['advance_id']?>","_blank");
				 </script>
				<?php }?>
							...
							<div class="panel-body">
								...
								<table class="table table-striped table-bordered table-hover" style=" width:100%" >
									...
									<tr>
										...
										<td><input type="text" class="form-control" name="advance_entry_transport_amount" id="advance_entry_transport_amount"  value="0" onKeyUp="totalAmount()" ></td>
									...
									<tr>
										...
										<td style="width:20%"><input type="text" class="form-control" name="advance_entry_dis_per" id="advance_entry_dis_per" onKeyUp="totalAmount()" value="0"></td>
									...
									<tr>
										...
										<td style="width:20%"><input type="text" class="form-control" name="advance_entry_tax_per" id="advance_entry_tax_per"  value="21"   onKeyUp="totalAmount()" ></td>

										<td><input type="text" class="form-control" name="advance_entry_tax_amount" id="advance_entry_tax_amount"  value="0" readonly  ></td>
									...
									<tr>
										...
										<td><input type="text" class="form-control" name="advance_entry_advance_amount" id="advance_entry_advance_amount" value="0" onKeyUp="totalAmount()" ></td>
									...
									<tr>
									    <td style="width:50%; text-align:right">&nbsp; Payment Mode</td>
										<td colspan="2"><select class='form-control' name='advance_entry_payment_mode' id='advance_entry_payment_mode' onchange='placeBank(this.value);'>
											    <option value='' >-Select-</option>
												<option value='1' >Cash</option>
												<option value='2' >Bank</option>
												</select></td>
										<td class="form-group"><select class='form-control'  name='advance_entry_acc_bank_id' id='advance_entry_acc_bank_id'><option value=''>--Select--</option></select></td>
									</tr>
								...
								<div class="panel-body">
									<div class="col-lg-12">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="advance_entry_no" id="advance_entry_no" style="width:460px;" value="<?=$advance_entry_edit['advance_entry_no']?>" ><input type="hidden" class="form-control" name="advance_entry_id" id="advance_entry_id" style="width:460px;" value="<?=$advance_entry_edit['advance_entry_id']?>" >
										</div>
									</div>
									<div class="col-lg-6">
										...
										<div class="form-group">
											...
											<select name="advance_entry_brand_id" id="advance_entry_brand_id" class="form-control select2" style="width:100%" required>
												...
												?>
														...
														<option value="<?=$get_brand['brand_id']?>" <?php if($advance_entry_edit['advance_entry_brand_id']==$get_brand['brand_id']){ ?> selected <?php }?>><?=$get_brand['brand_name']?></option>
					...
					<div class="col-md-12">
						...
						<div class="panel panel-info">
							...
							<tr>
								...
								<td><input class="form-control" type="text"  name="advance_entry_product_detail_sl_feet_in[]" id="advance_entry_product_detail_sl_feet_in<?=$row_cnt; ?>"  onBlur="GetTotalLength(<?=$row_cnt; ?>),GetLcalFeet(1,<?=$row_cnt; ?>)" value="<?=$get_product_detail['advance_entry_product_detail_sl_feet_in']?>" /> </td>
								...
								<td><input class="form-control" type="text"  name="advance_entry_product_detail_qty[]" id="advance_entry_product_detail_qty<?=$row_cnt; ?>"  onBlur="GetTotalLength(3,<?=$row_cnt; ?>),discountPerFind(<?=$row_cnt; ?>),GetTotalLength(<?=$row_cnt; ?>);"  value="<?=round($get_product_detail['advance_entry_product_detail_qty'])?>" /></td> 
								<td><input class="form-control" type="text"  name="advance_entry_product_detail_tot_length[]" id="advance_entry_product_detail_tot_length<?=$row_cnt; ?>" readonly value="<?=round($get_product_detail['advance_entry_product_detail_tot_length'])?>"  />
								 <input  type="hidden"  name="advance_entry_product_detail_inv_tot_length[]" id="advance_entry_product_detail_inv_tot_length<?=$row_cnt; ?>"   value="<?=round($get_product_detail['advance_entry_product_detail_inv_tot_length'])?>" /></td>
								 <td><input class="form-control" type="text"  name="advance_entry_product_detail_rate[]" id="advance_entry_product_detail_rate<?=$row_cnt; ?>"   onBlur="discountPerFind(<?=$row_cnt; ?>)" value="<?=round($get_product_detail['advance_entry_product_detail_rate'])?>" /></td>
					
								 <td><input class="form-control" type="text"  name="advance_entry_product_detail_total[]" id="advance_entry_product_detail_total<?=$row_cnt; ?>"   value="<?=round($get_product_detail['advance_entry_product_detail_total'])?>" /></td>
							...
							<tr>
								...
								<input type="hidden"  name="advance_entry_product_detail_qty[]" id="advance_entry_product_detail_qty<?=$row_cnt; ?>" value="<?=round($get_product_detail['advance_entry_product_detail_qty'])?>" /></td>
								<td><input class="form-control" type="text"  name="advance_entry_product_detail_s_weight_met[]" id="advance_entry_product_detail_s_weight_met<?=$row_cnt; ?>"  onblur="GetWeightClc(2,<?=$row_cnt; ?>)" value="<?=$get_product_detail['advance_entry_product_detail_s_weight_met']?>"/></td>
								
								<td><input class="form-control" type="text"  name="advance_entry_product_detail_rate[]" id="advance_entry_product_detail_rate<?=$row_cnt; ?>" onBlur="RawdiscountPerFind(<?=$row_cnt; ?>)" value="<?=round($get_product_detail['advance_entry_product_detail_rate'])?>" /></td>
								<td><input class="form-control" type="text"  name="advance_entry_product_detail_total[]" id="advance_entry_product_detail_total<?=$row_cnt; ?>"  value="<?=round($get_product_detail['advance_entry_product_detail_total'])?>"/><input class="form-control" type="hidden"  name="advance_entry_product_detail_sl_feet_mm[]" id="advance_entry_product_detail_sl_feet_mm<?=$row_cnt; ?>" value="<?=($get_product_detail['advance_entry_product_detail_sl_feet_mm'])?>" /><input class="form-control" type="hidden"  name="advance_entry_product_detail_sl_feet_met[]" id="advance_entry_product_detail_sl_feet_met<?=$row_cnt; ?>"  value="<?=($get_product_detail['advance_entry_product_detail_sl_feet_met'])?>"/> <input class="form-control" type="hidden"  name="advance_entry_product_detail_sl_feet[]" id="advance_entry_product_detail_sl_feet<?=$row_cnt; ?>"  value="<?=($get_product_detail['advance_entry_product_detail_sl_feet'])?>"/> <input class="form-control" type="hidden"  name="advance_entry_product_detail_sl_feet_in[]" id="advance_entry_product_detail_sl_feet_in<?=$row_cnt; ?>" value="<?=($get_product_detail['advance_entry_product_detail_sl_feet_in'])?>"/></td>
								<td><?php if($arr_cnt>1) { ?><a href="index.php?product_detail_id=<?=$get_product_detail['advance_entry_product_detail_id']?>&advance_entry_uniq_id=<?php echo $advance_entry_edit['advance_entry_uniq_id']?>&product_detail_delete=" title="" class="glyphicon glyphicon-trash " style="color:red"></a><?php } ?></td>	
							...
							<tr>
								...
								<td><input class="form-control" type="text"  name="advance_entry_product_detail_qty[]" id="advance_entry_product_detail_qty<?=$row_cnt; ?>"  onBlur="AccdiscountPerFind(<?=$row_cnt; ?>)"  value="<?=round($get_product_detail['advance_entry_product_detail_qty'])?>"/></td>
								<td><input class="form-control" type="text"  name="advance_entry_product_detail_rate[]" id="advance_entry_product_detail_rate<?=$row_cnt; ?>" onBlur="AccdiscountPerFind(<?=$row_cnt; ?>)"   value="<?=round($get_product_detail['advance_entry_product_detail_rate'])?>"/></td>
								<td><input class="form-control" type="text"  name="advance_entry_product_detail_total[]" id="advance_entry_product_detail_total<?=$row_cnt; ?>"   value="<?=round($get_product_detail['advance_entry_product_detail_total'])?>"/></td>
								<td><?php if($arr_cnt>1) { ?><a href="index.php?product_detail_id=<?=$get_product_detail['advance_entry_product_detail_id']?>&advance_entry_uniq_id=<?php echo $advance_entry_edit['advance_entry_uniq_id']?>&product_detail_delete=" title="" class="glyphicon glyphicon-trash " style="color:red"></a><?php } ?></td>	
								...
								<table class="table table-striped table-bordered table-hover" style=" width:100%" >
									...
									<tr>
									    <td style="width:50%; text-align:right">&nbsp; Payment Mode</td>
										<td colspan="2"><select class='form-control' name='advance_entry_payment_mode' id='advance_entry_payment_mode' onchange='placeBank(<?=$advance_entry_edit['advance_entry_payment_mode']?>);'>
											
												<option value='1' <?=($advance_entry_edit['advance_entry_payment_mode']==1)?'selected':''?> >Cash</option>
												<option value='2' <?=($advance_entry_edit['advance_entry_payment_mode']==2)?'selected':''?> >Bank</option>
												</select></td>
										<td><select class='form-control' name='advance_entry_acc_bank_id' id='advance_entry_acc_bank_id'>
										    <option value=''>--Select--</option>
										    <?php foreach(bank($advance_entry_edit['advance_entry_payment_mode']) as $get_value){?>
												<option value='<?= $get_value['account_sub_id'];?>' <?php if($advance_entry_edit['advance_entry_acc_bank_id']==$get_value['account_sub_id']){echo 'selected="selected"';}?>><?= $get_value['account_sub_name'];?></option>
											<?php }?>
										    </select></td>
									</tr>
                                ...
                                <input type="hidden"  name="advance_entry_no" id="advance_entry_no" value="<?=$advance_entry_edit['advance_entry_no']?>" />	
				...
				//alert(<?=$advance_entry_edit['advance_entry_payment_mode']?>);
				getTableHeader(<?=$advance_entry_edit['advance_entry_type_id']?>);
				//placeBank(<?=$advance_entry_edit['advance_entry_payment_mode']?>);
				</script>
...
<input type="hidden" value="<?php echo $_SESSION[SESS.'_financial_year_to_date']; ?>" id="pic_to">
    ...
    <!-- /. FOOTER  -->
    	...
    	$.get('get_bank.php', {bank_id:bank_id}, function(data) { $('#advance_entry_acc_bank_id').html( data ); });
