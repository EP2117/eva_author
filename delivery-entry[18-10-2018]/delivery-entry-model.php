<?php
	function GetAutoNo(){
		$select_invoice_no = "SELECT MAX(delivery_entry_no) AS maxval FROM delivery_entry 
	...
	function insertQuotation(){
		...
		$delivery_entry_no                   				= trim($_POST['delivery_entry_no']);
			...
			if($detail_request_fields) {
				...
				$insert_delivery_entry_product_detail 		= sprintf("INSERT INTO delivery_entry_product_details 
																				(delivery_entry_product_detail_uniq_id,delivery_entry_product_detail_delivery_entry_id,
																				 ...
																				 delivery_entry_product_detail_s_width_inches,delivery_entry_product_detail_s_width_mm,
																				 ...
																				 delivery_entry_product_detail_invoice_entry_id,delivery_entry_product_detail_entry_type) 
																	VALUES     ('%s', '%d', 
																				'%d', 
																				'%d', '%f', 
																				'%f', '%f',
																		 ...
																		 $delivery_entry_product_detail_qty[$i],$delivery_entry_product_detail_tot_length[$i],
	...
	function listQuotation(){
		...
		$select_delivery_entry		=	"SELECT 
											 ...
											 WHERE 
												...
												delivery_entry_deleted_status 	= 	0 
				...
				if(isset($delivery_entry_product_detail_id[$i]) && (!empty($delivery_entry_product_detail_id[$i]))) {
					 $update_delivery_entry_product_detail = sprintf("UPDATE 
																		...
																		WHERE 
																			...
																			$delivery_entry_product_detail_qty[$i],
