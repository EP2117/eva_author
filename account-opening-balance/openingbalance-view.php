        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
					...
					<div style="text-align:center;color:#00FF00" id="vital_msg"></div>
					...
					<div class="panel panel-default">
						...
						<div class="col-lg-12" style="padding-top:30px;">
							<div class="form-group">
								<button name="opening_balinsertUpdate" id="opening_balinsertUpdate" type="button"class="btn btn-success" onClick="productList()">Update</button>
							</div>	
						</div>	
					</div>			
					</form>	
