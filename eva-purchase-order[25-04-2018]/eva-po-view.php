									...
									<div class="panel-body">
										...
										<div class="col-lg-6">										
											...
											<div class="form-group" id="s_rate"<?php if(1<=$var){ ?>style="display:block;"<?php }else{?> style="display:none;" <?php }?>>
											 ...
											 <div class="form-group">
												<label >Brand</label>
												<select name="po_brand_id" id="po_brand_id" class="form-control select2" style="width:100%"  >
													 <option value=""> - Select - </option>
													<?php
										...
										<table id="purcase_table" class="table table-striped table-bordered table-hover">
											...
											<?php $count_val = !empty($editpurchaseProd) ? count($editpurchaseProd) :''; ?>
												<tr>
													...
													<th style="width:10%;">Frg:rate</th>
													<th style="width:12%;">Qty</th>
													<th style="width:8%;">Ton</th>
													<th style="width:8%;">Kg</th>
													<th style="width:8%;" nowrap="nowrap">Rate By Currency</th>
													<th style="width:15%;" nowrap="nowrap">Unit price  &nbsp;&nbsp;&nbsp; </th>
													<td width="5%">
											...
											<?php 
												...
												<tr id="remove_req_<?php echo $i; ?>">
													...
													<td>
														...
														<input type="hidden" name="prod_id_<?php echo $i; ?>" value="<?php echo $editpurchaseProd[$j]['pRp_product_id']; ?>">
														<input type="hidden" name="pid_<?php echo $i; ?>" value="<?php echo $editpurchaseProd[$j]['purOrdPorductId']; ?>">																
														<div class="ui-widget"><input type="text" class="form-control" name="prod_name_<?php echo $i; ?>" id="prod_name_<?php echo $i; ?>"  onkeypress="return o_obj.Alpha_Numeric(this,event);" value="<?php echo $editpurchaseProd[$j]['product_name']; ?>">
														</div>
													</td>
													<td  id="prod_brand_<?php echo $i; ?>">																
														<input type="text" class="form-control" name="prod_brand_<?php echo $i; ?>" id="prod_brand_<?php echo $i; ?>"  onkeypress="return o_obj.Alpha_Numeric(this,event);" value="<?php echo $editpurchaseProd[$j]['brand_name']; ?>" readonly="">
													</td>
													<td  id="prod_uom_<?php echo $i; ?>">																
														<input type="text" class="form-control" name="prod_uom_<?php echo $i; ?>" id="prod_uom_<?php echo $i; ?>"  onkeypress="return o_obj.Alpha_Numeric(this,event);" value="<?php echo $editpurchaseProd[$j]['product_uom_name']; ?>" readonly="">
													</td>
													<td>																
														<input type="text" class="form-control" style="text-align:right;" name="rate_<?php echo $i; ?>" id="rate_<?php echo $i; ?>"  onkeypress="return o_obj.Alpha_Numeric(this,event);" value="<?php echo $editpurchaseProd[$j]['pRp_rate']; ?>" onChange="return get_currency_amt(<?php echo $i; ?>),amnt_calulation_Qty(this.value,this,<?php echo $i; ?>,1);">
													</td>
													<td>																
														<input type="text" class="form-control" style="text-align:right;" name="frignrate_<?php echo $i; ?>" id="frignrate_<?php echo $i; ?>"  onkeypress="return o_obj.Alpha_Numeric(this,event);" value="<?php echo $editpurchaseProd[$j]['pRp_frignrate']; ?>" onChange="return amnt_calulation_Qty(this.value,this,<?php echo $i; ?>,2);">
													</td>
													<!--<td>																
													...
													<td>																
														<input type="text" class="form-control" name="qty_<?php echo $i; ?>" id="qty_<?php echo $i; ?>"  onkeypress="return o_obj.Alpha_Numeric(this,event);" value="<?php echo $editpurchaseProd[$j]['pRp_qty']; ?>"   onBlur="return get_currency_amt(<?php echo $i; ?>);">
													</td>
													<td><input type="text" class="form-control" name="prod_ton_<?php echo $i; ?>" id="prod_ton_<?php echo $i; ?>"  onBlur="return ton_calculation(<?=$i?>,1),get_currency_amt(<?php echo $i; ?>),amnt_calulation_Qty(this.value,this,<?php echo $i; ?>,2);" value="<?php echo $editpurchaseProd[$j]['pRp_ton']; ?>"></td>
													<td><input type="text" class="form-control" name="prod_kg_<?php echo $i; ?>" id="prod_kg_<?php echo $i; ?>"  onBlur="return ton_calculation(<?=$i?>,2);" value="<?php echo $editpurchaseProd[$j]['pRp_kg']; ?>"></td>
													
													<td >																
														<input type="text" class="form-control unit_cur_amnt" style="text-align:right;" name="rate_by_currency_<?php echo $i; ?>" id="rate_by_currency_<?php echo $i; ?>"  onkeypress="return o_obj.Alpha_Numeric(this,event);" value="<?php echo $editpurchaseProd[$j]['pRp_rate_by_currency']; ?>">
													</td>
													<td>																
														<input type="text" class="form-control unit_amnt" style="text-align:right;" name="unitprice_<?php echo $i; ?>" id="unitprice_<?php echo $i; ?>"  onkeypress="return o_obj.Alpha_Numeric(this,event);" value="<?php echo $editpurchaseProd[$j]['pRp_unitprice']; ?>">
													</td>
											...
											<tfoot>
												<tr>
													...
													<th colspan="">
													<input type="text" class="form-control" style="text-align:right" name="tot_amount" id="tot_amount"  onkeypress="return o_obj.Alpha_Numeric(this,event);"  value="<?php echo empty($editPurchase['pR_tot_amount'])?"":$editPurchase['pR_tot_amount']; ?>"  ></th><th>
													<input type="text" class="form-control" style="text-align:right" name="total_amnt" id="total_amnt"  onkeypress="return o_obj.Alpha_Numeric(this,event);"  value="<?php echo empty($editPurchase['pR_totalAmnt'])?"":$editPurchase['pR_totalAmnt']; ?>"  ></th>
												...
												<tr>
													...
													<th colspan="">
													<input type="text" class="form-control"  style="text-align:right"  name="advance_amount" id="advance_amount"  onkeypress="return o_obj.Alpha_Numeric(this,event);"  value="<?php echo empty($editPurchase['pR_advanceAmnt'])?"":$editPurchase['pR_advance_amount']; ?>" onKeyUp="net_amount();" ></th><th>
													<input type="text" class="form-control"  style="text-align:right"  name="advance_amnt" id="advance_amnt"  onkeypress="return o_obj.Alpha_Numeric(this,event);"  value="<?php echo empty($editPurchase['pR_advanceAmnt'])?"":$editPurchase['pR_advanceAmnt']; ?>" onKeyUp="get_net_amt();" ></th>
												...
												<tr>
													...
													<th colspan="">
													<input type="text" class="form-control"  style="text-align:right"  name="net_tot_amount" id="net_tot_amount"  onkeypress="return o_obj.Alpha_Numeric(this,event);"  value="<?php echo empty($editPurchase['pR_net_total_amount'])?"":$editPurchase['pR_net_total_amount']; ?>"  ></th><th>
													<input type="text" class="form-control"  style="text-align:right"  name="net_total_amnt" id="net_total_amnt"  onkeypress="return o_obj.Alpha_Numeric(this,event);"  value="<?php echo empty($editPurchase['pR_net_total_amnt'])?"":$editPurchase['pR_net_total_amnt']; ?>"  ></th>
													
												</tr>
												<tr>
													<th style="text-align:right;">Remarks</th>
													<th colspan="9"><textarea class="form-control pull-right" rows="1" name="remarks" id="remarks"><?php echo empty($editPurchase['pR_remarks'])?"":$editPurchase['pR_remarks']; ?></textarea>	</th>
												</tr>
											</tfoot>											
										</table>					
									</div>
									...
									<table class="table table-striped table-bordered table-hover" id="dataTables-eva-po">
										...
										?>
											<tr class="odd gradeX">
												...
												<td class="center">
												<a href="index.php?page=edit&id=<?php echo $result['purchaseId']?>" title="" class="glyphicon glyphicon-pencil pull-left"								style="color:blue"></a>&nbsp;&nbsp;</td>
												<td style="text-align:center"><input type="checkbox" id="select_all" name="select_all[]" value="<?php echo $result['purchaseId']?>"></td>
											</tr>
										<?php } ?>
										</tbody>
									</table>
