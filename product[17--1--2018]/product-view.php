            ...
            <div id="page-inner">
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="panel panel-info"  style="display:none" id="multi_contacts">
							...
							<div class="panel-body" >
                                ...
                                <table class="table table-striped table-bordered table-hover" id="multi-contact">
                                    ...
                                    <tbody id="multi-contact-display">
										...
										<input name="product_detail_raw_product_thick[]" type="text" class="form-control" id="product_detail_raw_product_thick_<?=$i?>" value="<?=$get_product_det['product_thick_ness']?>"/>
										...
										<input name="product_detail_raw_product_thick[]" type="text" value="" class="form-control" id="product_detail_raw_product_thick_<?=$i?>	"/>
