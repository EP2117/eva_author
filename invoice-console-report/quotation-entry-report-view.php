...
?>
<script type="text/javascript" src="<?php echo PROJECT_PATH.'/invoice-console-report/quotation-entry-javascript.js'; ?>"></script>
</head>
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Invoice Console Report</h1>
									...
									<div class="form-group">
										<label class="control-label">To Date</label>
										 <div class="input-group date">
										  ...
										  <input type="text" class="form-control pull-right" name="search_to_date" autocomplete="off" id="search_to_date" value="<?=searchValue('search_to_date')?>" />
										</div>
									</div>
							...
							<?php if(isset($_REQUEST['search_report'])){?>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-invoice-entry">
									...
									<?php
										...
										if($get_value['invoice_entry_total_amount']>0){
									?>
										 <tr  class="odd gradeX">
										...
										<?php }?>
									<?php $amt=$amt+$get_value['invoice_entry_total_amount']; } ?>
									<tr>
