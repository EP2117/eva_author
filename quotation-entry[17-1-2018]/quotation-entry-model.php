<?php
	function GetAutoNo(){
		$select_invoice_no = "SELECT MAX(quotation_entry_no) AS maxval FROM quotation_entry 
	...
	function insertQuotation(){
		...
		$quotation_entry_type_id                   			= trim($_POST['quotation_entry_type_id']);
		...
		$quotation_entry_gross_amount                 		= NdateDatabaseFormat($_POST['quotation_entry_gross_amount']);
		$quotation_entry_transport_amount                 	= NdateDatabaseFormat($_POST['quotation_entry_transport_amount']);
		$quotation_entry_tax_per                 			= NdateDatabaseFormat($_POST['quotation_entry_tax_per']);
		$quotation_entry_tax_amount                 		= NdateDatabaseFormat($_POST['quotation_entry_tax_amount']);
		$quotation_entry_advance_amount                		= NdateDatabaseFormat($_POST['quotation_entry_advance_amount']);
		$quotation_entry_net_amount                 		= NdateDatabaseFormat($_POST['quotation_entry_net_amount']);
...
$quotation_entry_product_detail_total 			  = $_POST['quotation_entry_product_detail_total'];
		...
		// echo $quotation_entry_product_detail_qty[$i]; exit;
			$detail_request_fields 							= 	((!empty($quotation_entry_product_detail_product_id[$i])) && 
									 							(!empty($quotation_entry_product_detail_qty[$i])));
		...
		pageRedirection("quotation-entry/index.php?page=add&msg=1");
	}
	...
	function listQuotation(){
		...
		$select_quotation_entry		=	"SELECT 
											 ...
											 WHERE 
												...
												quotation_entry_deleted_status 	= 	0 
