								...
								<div class="panel-body">
									...
									<div class="col-lg-6">
										...
										<div class="form-group">
											...
											<select name="quotation_entry_type_id" id="quotation_entry_type_id" class="form-control select2" style="width:100%" required onChange="getTableHeader(this.value)">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="product_detail"  style=" width:100%" >
                                    ...
                                    <tbody id="product_detail_display" >
										...
										foreach($quotation_entry_prd_edit as $get_product_detail){
											...
											if($get_product_detail['quotation_entry_product_detail_product_type']==1){
...
<input type="hidden"  name="quotation_entry_product_detail_product_type[]" id="quotation_entry_product_detail_product_type<?=$row_cnt?>" value="<?=$get_product_detail['quotation_entry_product_detail_product_type']?>" />
											...
											<input class="form-control" type="text"  name="quotation_entry_product_detail_product_thick[]" id="quotation_entry_product_detail_product_thick<?=$row_cnt?>" value="<?=$get_product_detail['quotation_entry_product_detail_product_thick']?>"   />
...
<input type="hidden"  name="quotation_entry_product_detail_product_type[]" id="quotation_entry_product_detail_product_type<?=$row_cnt?>" value="<?=$get_product_detail['quotation_entry_product_detail_product_type']?>" />
											...
											<input class="form-control" type="text"  name="quotation_entry_product_detail_product_thick_val[]" id="quotation_entry_product_detail_product_thick_val<?=$row_cnt?>" value="<?=$arr_thick[$get_product_detail['quotation_entry_product_detail_product_thick']]?>"   />
											</td>
