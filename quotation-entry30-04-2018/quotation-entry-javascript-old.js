...
function AddproductDetail(){
	...
	for (var i = 0; i < document.getElementById('product_list_form').elements.length; i++) { 
		if (document.getElementById('product_list_form').elements[i].checked == true) {
			...
			var t_id 					= document.getElementById('product_t_id'+ord_id).value;
			...
			var count_product_id 	     = document.getElementById('count_product_id'+ord_id).value;
...
{//alert();
	...
	document.getElementById('quotation_entry_dis_amount').value 	= dis_amount;
