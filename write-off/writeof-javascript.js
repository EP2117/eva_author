...
function AddproductDetail(){
	for (var i = 0; i < document.getElementById('product_list_form').elements.length; i++) {
		...
		if (document.getElementById('product_list_form').elements[i].checked ==true) {
			...
			apnd	+= '<tr><td style="width:30%"><input type="hidden"  name="writeoff_entry_product_detail_mother_child_type[]" id="writeoff_entry_product_detail_mother_child_type" value="'+product_mother_child_type+'" />'+product_name+'<input type="hidden"  name="writeoff_entry_product_detail_product_id[]" id="writeoff_entry_product_detail_product_id" value="'+product_id+'" /><input type="hidden"  name="writeoff_entry_product_detail_product_type[]" id="writeoff_entry_product_detail_product_type"  value="'+product_type+'" /></td>';
