						...
						<div class="row">
							...
							<div id="receipt" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								...
								<div class="panel panel-info">
									...
									if($wr_type_id==2){?>
									<tr>
									<td><?=$editwriteoffProd[$d]['brand_name'] ?>
                                    <input type="hidden"  name="writeoff_entry_product_detail_mother_child_type[]" id="writeoff_entry_product_detail_mother_child_type" value="<?=$editwriteoffProd[$d]['writeoff_entry_product_detail_mother_child_type']?>" /></td>
