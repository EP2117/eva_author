...
?>
			...
			<tr class="odd gradeX">
                ...
                <input type="hidden" name="product_mother_child_type" id="product_mother_child_type<?php echo $record_so_detail['damage_entry_product_detail_id'];?>" value="<?php echo $record_so_detail['damage_entry_product_detail_mother_child_type']; ?>" />
