...
?>
		...
		?>
					...
					<tr class="odd gradeX">
						...
						<input type="hidden" name="gin_entry_type" id="gin_entry_type<?php echo $record_gin_entry['gin_entry_id'];?>" value="<?=$arr_producton_type[$record_gin_entry['production_order_type']]?>" >
