...
<?php
	...
	$type_id		= $_REQUEST['type_id']; //echo $type_id;exit;
...
//AND invoice_entry_type_id											= '".$type_id."'
...
?>
		...
		?>
					...
					<tr class="odd gradeX">
						...
						<input type="hidden" name="invoice_entry_po_cnt" id="invoice_entry_po_cnt<?php echo $record_invoice_entry['invoice_entry_id'];?>" value="<?=$po_cnt?>" ><input type="hidden" name="type_id" id="type_id<?php echo $record_invoice_entry['invoice_entry_id'];?>" value="<?=$_REQUEST['type_id']?>" >
						</td>
