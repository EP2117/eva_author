								...
								<div class="panel-body">
									...
									<div class="col-lg-6">
										...
										<div class="form-group">
											...
											<select name="production_order_customer_id" id="production_order_customer_id" class="form-control select2" onChange="GetcustomerDetail()" style="width:100%" required>
										...
										<div class="form-group">
											...
											<label>Delivery Date</label>
											 ...
											 <div class="input-group date">
											  ...
											  <input type="text" class="form-control" name="production_order_validity_date" id="production_order_validity_date" >
                                ...
                                <table class="table table-striped table-bordered table-hover" id="product_detail"  style="width:100%" >
                                    ...
                                    <thead style="display:none" class="rls">
                                         ...
                                         <tr>
											...
											<th rowspan="2" style="vertical-align:middle;border:solid 1px #ddd;"> LENGTH</th>
								...
								<div class="panel-body">
									...
									<div class="col-lg-6">
										...
										<div class="form-group">
											...
											<select name="production_order_customer_id" id="production_order_customer_id" class="form-control select2" onChange="GetcustomerDetail()" style="width:100%">
										...
										<div class="form-group">
											...
											<label>Delivery Date</label>
											 ...
											 <div class="input-group date">
											  ...
											  <input type="text" class="form-control" name="production_order_validity_date" id="production_order_validity_date" value="<?=dateGeneralFormatN($production_order_edit['production_order_validity_date'])?>">
					...
					<div class="col-md-12">
						...
						<div class="panel panel-info">
							...
							<div class="panel-body">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="product_detail"  style="width:100%; overflow:scroll;" >
                                    ...
                                    <thead style="display:none" class="rls">
                                         ...
                                         <tr>
											...
											<th rowspan="2" style="vertical-align:middle;"> SALE<br />QTY </th>
											<th rowspan="2" style="vertical-align:middle;"> PO<br />QTY </th>
											<th rowspan="2" style="vertical-align:middle;"> NON-PO<br />QTY </th>
									...
									<thead style="display:none" class="rws">
                                         ...
                                         <tr>
											...
											<th colspan="2"> SALES WIDTH</th>
											<th colspan="3"> SALES WEIGHT</th>
											<th rowspan="2" style="vertical-align:middle;"> PO Done</th>
									...
									<thead style="display:none" class="as">
                                         ...
                                         <tr>
											...
											<!--<th style="vertical-align:middle;">SALE QTY</th>-->
											<th style="vertical-align:middle;" class="text-center sale-by">SALE BY</th>
											
											<th style="vertical-align:middle;">PO QTY </th>
											
											<th style="vertical-align:middle;">NON-PO QTY </th>
...
<input type="hidden"  name="production_order_product_detail_product_type[]" id="production_order_product_detail_product_type<?=$row_cnt?>" value="<?=$get_product_detail['production_order_product_detail_product_type']?>"  />
											...
											<input class="form-control" type="text"  name="production_order_product_detail_product_thick[]" id="production_order_product_detail_product_thick<?=$row_cnt?>" value="<?=$arr_thick[number_format($get_product_detail['production_order_product_detail_product_thick'],0)]?>" readonly />

											</td>

											<td>

											<input class="form-control" type="text"  name="production_order_product_detail_width_inches[]" id="production_order_product_detail_width_inches<?=$row_cnt?>" value="<?=sprintf('%0.3f',$get_product_detail['production_order_product_detail_width_inches']);?>" readonly /><!-- onKeyUp="GetWcalc(2,<?=$row_cnt?>)"  onBlur="GetTotalLength(<?=$row_cnt?>)" -->

											</td>

											<td>

											<input class="form-control" type="text"  name="production_order_product_detail_width_mm[]" id="production_order_product_detail_width_mm<?=$row_cnt?>" value="<?=round($get_product_detail['production_order_product_detail_width_mm'])?>ss"   readonly /> <!-- onKeyUp="GetWcalc(3,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)"-->

											</td>

											<td>

											<input class="form-control" type="text"  name="production_order_product_detail_s_width_inches[]" id="production_order_product_detail_s_width_inches<?=$row_cnt?>" value="<?=sprintf('%0.3f',$get_product_detail['production_order_product_detail_s_width_inches'])?>"   readonly /> <!-- onKeyUp="GetWcalS(2,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" -->
											...
											<input class="form-control" type="text"  name="production_order_product_detail_s_width_mm[]" id="production_order_product_detail_s_width_mm<?=$row_cnt?>" value="<?=round($get_product_detail['production_order_product_detail_s_width_mm'])?>"  readonly />
											<!-- onKeyUp="GetWcalS(3,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" -->

											</td>
											<td>

											<input class="form-control" type="text"  name="production_order_product_detail_sl_feet[]" id="production_order_product_detail_sl_feet<?=$row_cnt?>" value="<?=sprintf('%0.2f',$get_product_detail['production_order_product_detail_sl_feet'])?>" readonly />
											<!--  onKeyUp="GetLcalFeet(1,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" -->

											</td>
											<td>

											<input class="form-control" type="text"  name="production_order_product_detail_sl_feet_in[]" id="production_order_product_detail_sl_feet_in<?=$row_cnt?>" value="<?=sprintf('%0.3f',$get_product_detail['production_order_product_detail_sl_feet_in'])?>" readonly />
											<!-- onKeyUp="GetLcalFeet(2,<?=$row_cnt?>)"  onBlur="GetTotalLength(<?=$row_cnt?>)" -->

											</td>
											<td>

											<input class="form-control" type="text"  name="production_order_product_detail_sl_feet_mm[]" id="production_order_product_detail_sl_feet_mm<?=$row_cnt?>" value="<?=round($get_product_detail['production_order_product_detail_sl_feet_mm'])?>"  readonly /> <!-- onKeyUp="GetLcalFeet(3,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" -->

											</td>
											
											<td>

											<input class="form-control" type="text"  name="production_order_product_detail_sale_length[]" id="production_order_product_detail_sale_length<?=$row_cnt?>"  value="<?=htmlspecialchars($get_product_detail['production_order_product_detail_sale_length']);?>" readonly />

											</td>
											
											<td>

											<input class="form-control" type="text"  name="production_order_product_detail_tot_length[]" id="production_order_product_detail_tot_length<?=$row_cnt?>"  value="<?=sprintf('%0.3f',$get_product_detail['production_order_product_detail_tot_length'])?>" readonly />

											</td>

											<td>

											<input class="form-control" type="text"  name="production_order_product_detail_qty[]" id="production_order_product_detail_qty<?=$row_cnt?>"  value="<?=round($get_product_detail['production_order_product_detail_qty'])?>" readonly />	
											<!-- onKeyUp="get_stock(<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" -->
											...
											<input class="form-control allow_decimal" type="text"  name="production_order_product_detail_po_qty[]" id="production_order_product_detail_po_qty<?=$row_cnt?>"  value="<?=$get_product_detail['production_order_product_detail_po_qty']?>"  onBlur="check_quantity('po',<?php echo $row_cnt; ?>);">

											</td>

											<td>

											<input class="form-control allow_decimal" type="text"  name="production_order_product_detail_non_po_qty[]" id="production_order_product_detail_non_po_qty<?=$row_cnt?>"  value="<?=$get_product_detail['production_order_product_detail_non_po_qty']?>"  onBlur="check_quantity('non_po',<?php echo $row_cnt; ?>);">
...
<input type="hidden"  name="production_order_product_detail_product_type[]" id="production_order_product_detail_product_type<?=$row_cnt?>" value="<?=$get_product_detail['production_order_product_detail_product_type']?>" />
											...
											<input class="form-control" type="text"  name="production_order_product_detail_width_inches[]" id="production_order_product_detail_width_inches<?=$row_cnt?>" value="<?=$get_product_detail['production_order_product_detail_width_inches']?>" onKeyUp="GetWcalc(2,<?=$row_cnt?>)" readonly />

											</td>

											<td>

											<input class="form-control" type="text"  name="production_order_product_detail_width_mm[]" id="production_order_product_detail_width_mm<?=$row_cnt?>" value="<?=$get_product_detail['production_order_product_detail_width_mm']?>" onKeyUp="GetWcalc(3,<?=$row_cnt?>)" readonly  />

											</td>
											<td>

											<input class="form-control" type="text"  name="production_order_product_detail_s_width_inches[]" id="production_order_product_detail_s_width_inches<?=$row_cnt?>" value="<?=$get_product_detail['production_order_product_detail_s_width_inches']?>" onKeyUp="GetWcalS(2,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" readonly />
											...
											<input class="form-control" type="text"  name="production_order_product_detail_s_width_mm[]" id="production_order_product_detail_s_width_mm<?=$row_cnt?>" value="<?=$get_product_detail['production_order_product_detail_s_width_mm']?>" onKeyUp="GetWcalS(3,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" readonly />
											...
											<input class="form-control" type="text"  name="production_order_product_detail_s_weight_inches[]" id="production_order_product_detail_s_weight_inches<?=$row_cnt?>" value="<?=$get_product_detail['production_order_product_detail_s_weight_inches']?>" onKeyUp="GetWcalS(3,<?=$row_cnt?>)" readonly />
											</td>
											<td>

											<input class="form-control" type="text"  name="production_order_product_detail_s_weight_mm[]" id="production_order_product_detail_s_weight_mm<?=$row_cnt?>" value="<?=$get_product_detail['production_order_product_detail_s_weight_mm']?>" onKeyUp="GetWcalS(3,<?=$row_cnt?>)" readonly />
											</td>
                                            
                                            <td>

											<input class="form-control" type="text"  name="production_order_product_detail_s_weight_met[]" id="production_order_product_detail_s_weight_met<?=$row_cnt?>" value="<?=$get_product_detail['production_order_product_detail_s_weight_met']?>" onKeyUp="GetWcalS(2,<?=$row_cnt?>)" readonly />

											</td>
											
											<td>
											<input type="checkbox" name="production_order_product_detail_po_done[]" id="production_order_product_detail_po_done<?=$row_cnt?>" <?php if($get_product_detail['production_order_product_detail_po_done']==1) echo "checked"; ?> />
											</td>
...
<input type="hidden"  name="production_order_product_detail_product_type[]" id="production_order_product_detail_product_type<?=$row_cnt?>" value="<?=$get_product_detail['production_order_product_detail_product_type']?>" />
											...
											<input class="form-control" type="text"  name="production_order_product_detail_product_thick[]" id="production_order_product_detail_product_thick<?=$row_cnt?>" value="<?=$get_product_detail['production_order_product_detail_product_thick']?>" onBlur="GetTotalLength(<?=$row_cnt?>)" readonly />

											</td>

											<td>

											<input class="form-control" type="text"  name="production_order_product_detail_width_inches[]" id="production_order_product_detail_width_inches<?=$row_cnt?>" value="<?=$get_product_detail['production_order_product_detail_width_inches']?>" onKeyUp="GetWcalc(2,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" readonly />

											</td>

											<td>

											<input class="form-control" type="text"  name="production_order_product_detail_width_mm[]" id="production_order_product_detail_width_mm<?=$row_cnt?>" value="<?=$get_product_detail['production_order_product_detail_width_mm']?>" onKeyUp="GetWcalc(3,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" readonly />
											...
											<input class="form-control" type="text"  name="production_order_product_detail_sl_feet[]" id="production_order_product_detail_sl_feet<?=$row_cnt?>" value="<?=sprintf('%0.2f',$get_product_detail['production_order_product_detail_sl_feet'])?>" onKeyUp="GetWcalFeet(1,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" readonly />

											</td>
											<td>

											<input class="form-control" type="text"  name="production_order_product_detail_sl_feet_in[]" id="production_order_product_detail_sl_feet_in<?=$row_cnt?>" value="<?=$get_product_detail['production_order_product_detail_sl_feet_in']?>" onKeyUp="GetWcalFeet(2,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)"  readonly />

											</td>
											<td>

											<input class="form-control" type="text"  name="production_order_product_detail_sl_feet_mm[]" id="production_order_product_detail_sl_feet_mm<?=$row_cnt?>" value="<?=$get_product_detail['production_order_product_detail_sl_feet_mm']?>" onKeyUp="GetWcalFeet(3,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)"  readonly />
											...
											<input class="form-control" type="text"  name="production_order_product_detail_qty[]" id="production_order_product_detail_qty<?=$row_cnt?>"  value="<?=$get_product_detail['production_order_product_detail_qty']?>"  onBlur="get_stock(<?php echo $row_cnt; ?>);" readonly >
...
<input type="hidden"  name="production_order_product_detail_product_type[]" id="production_order_product_detail_product_type<?=$row_cnt?>" value="<?=$get_product_detail['production_order_product_detail_product_type']?>" />
										...
										?>
											<select  name="production_order_product_detail_sale_by[]" id="production_order_product_detail_sale_by<?=$row_cnt?>" class="form-control" style="width:30%;display:inline-block" readonly >
											<?php
												if($get_product_detail['production_order_product_detail_sale_by'] == 'qty') {
											?>
											<option value="qty" selected>QTY</option></select>&nbsp;&nbsp;&nbsp;
											<input class="form-control" style="display:inline-block;width:60%" type="text"  name="production_order_product_detail_qty[]" id="production_order_product_detail_qty<?=$row_cnt?>" value="<?=$get_product_detail['production_order_product_detail_qty'];?>"  readonly />
											<?php
												} 
												else {
											?>
											<option value="feet" selected>FEET</option></select>&nbsp;&nbsp;&nbsp;
											<input class="form-control" style="display:inline-block;width:60%" type="text"  name="production_order_product_detail_qty[]" id="production_order_product_detail_qty<?=$row_cnt?>" value="<?=$get_product_detail['production_order_product_detail_sale_feet'];?>"  readonly />
											<?php
												}
											?>
										...
										?>
											<select  name="production_order_product_detail_sale_by[]" id="production_order_product_detail_sale_by<?=$row_cnt?>" class="form-control" style="width:30%;display:inline-block" readonly ><option value="qty">QTY</option></select>&nbsp;&nbsp;&nbsp;
											<input class="form-control" style="display:inline-block;width:60%" type="text"  name="production_order_product_detail_qty[]" id="production_order_product_detail_qty<?=$row_cnt?>" value="<?=round($get_product_detail['production_order_product_detail_qty']);?>" readonly />
										<?php
											}
										?>
											<!--<input class="form-control" type="text"  name="production_order_product_detail_qty[]" id="production_order_product_detail_qty<?=$row_cnt?>"  value="<?=$get_product_detail['production_order_product_detail_qty']?>" readonly />-->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									?>
                                        ...
                                        <tr class="odd gradeX">
											...
											<?php	
												if($get_quotation['production_order_process_status'] == 0) {
											?>
											<td class="text-primary" id="po<?php echo $get_quotation['production_order_id']; ?>">New</td>
											<?php
												}
												else {
											?>
											<td class="text-danger" id="po<?php echo $get_quotation['production_order_id']; ?>">In-Process</td>
											<?php
												}
											?>
											<td>
											...
											<?php
												...
												$chk_query = mysql_query("Select * From gin_entry Where gin_entry_production_order_id = ".$get_quotation['production_order_id']." AND gin_entry_deleted_status = 0") or die(mysql_error());
											...
											<?php// if($edit_status == 1){ ?>
												...
												<?php	
												if($get_quotation['production_order_process_status'] == 1) {
												?>
												<a  title='Reset' class="glyphicon glyphicon-refresh pull-left" style="color:red;cursor:pointer;padding-left:20px;" id="reset<?php echo $get_quotation['production_order_id']; ?>" onClick="reset_order('<?php echo $get_quotation['production_order_id']; ?>')"></a>
												<?php } ?>
	...
	$(function() {
		var from	= $('#pic_from').val();
		var to	= $('#pic_to').val();
		$( "#production_order_date" ).datepicker({dateFormat:'dd/mm/yy',minDate:from,changeMonth:true,changeYear:false,});
		$( "#production_order_validity_date" ).datepicker({dateFormat:'dd/mm/yy',minDate:from,changeMonth:true,changeYear:false,});
	});
