...
//$production_order_no =$res['branch_prefix'].GetAutoNo($_POST['production_order_branch_id']); //echo $invoice_entry_no;exit;
		...
		$production_order_no                   			= trim($_POST['production_order_no']).'-'.GetAutoNo($_POST['production_order_invoice_entry_id']); //echo $_POST['production_order_no'];exit();
		...
		$production_order_validity_date                 	= NdateDatabaseFormat($_POST['production_order_validity_date']);
...
$production_order_product_detail_sale_length 		= isset($_POST['production_order_product_detail_sale_length'])?$_POST['production_order_product_detail_sale_length']:'';
		...
		$insert_production_order 					= sprintf("INSERT INTO production_order  (production_order_uniq_id, production_order_date, production_order_validity_date,
																			...
																			VALUES 	 		 ('%s', '%s', '%s',
																							  ...
																							  '%s', '%d', '%d' , '%s')", 
																		  	   		   		 ...
																		  	   		   		 $production_order_uniq_id, $production_order_date, $production_order_validity_date,
...
//print_r($production_order_product_detail_product_id);exit;
				...
				$production_order_product_detail_uniq_id 	= generateUniqId();
				 $insert_production_order_product_detail 		= sprintf("INSERT INTO production_order_product_details 
																	...
																	VALUES     ('%s', '%d', 
																		 ...
																		 mysql_real_escape_string($production_order_product_detail_sale_length[$i]),
	...
	function listQuotation(){
		...
		$select_production_order		=	"SELECT 
												...
												production_order_process_status,
												branch_prefix,
												customer_name
...

	{
		...
		$production_order_id 	= getId('production_order', 'production_order_id', 'production_order_uniq_id', dataValidation($_GET['id'])); 
		 ...
		 $select_production_order_product_detail 	= "	SELECT 
															...
															production_order_product_detail_product_thick,
															p_uom.product_uom_name as p_uom_name,product_product_uom_id,
															product_colour_name,
															brand_name,
															product_is_opp,
															production_order_product_detail_product_type,
															...
															production_order_product_detail_non_po_qty,
															production_order_product_detail_po_done
														...
														ON 
															...
															product_colours  
														ON 
															product_colour_id 					= production_order_product_detail_product_color_id
														LEFT JOIN 
															brands 
														ON 
														...
														//	echo $select_production_order_product_detail;exit;
		$result_production_order_product_detail 	= mysql_query($select_production_order_product_detail) or die(mysql_error());
	...
	function updateQuotation(){
		...
		$production_order_product_detail_po_qty 			= $_POST['production_order_product_detail_po_qty'];
		$production_order_product_detail_non_po_qty 		= $_POST['production_order_product_detail_non_po_qty'];
		$production_order_product_detail_po_done 			= $_POST['production_order_product_detail_po_done'];
...
$production_order_product_detail_sl_feet_met		= isset($_POST['production_order_product_detail_sl_feet_met'])?$_POST['production_order_product_detail_sl_feet_met']:'';
		...
		$update_customer 					= sprintf("	UPDATE 
														...
														SET 
															...
															production_order_validity_date 				= '%s',
														...
														WHERE               
															...
															$production_order_date,
															$production_order_validity_date,
		...
		for($i = 0; $i < count($production_order_product_detail_product_id); $i++) {
			if(isset($production_order_product_detail_po_done[$i]) && $production_order_product_detail_po_done[$i] == 'on') {
				$po_done = 1;
				$process_status = 1;
			} else {
				$po_done = 0;
			...
			if(!empty($production_order_product_detail_po_qty[$i]) || !empty($production_order_product_detail_non_po_qty[$i])) {
				$process_status = 1;
			}
			/* $detail_request_fields = ((!empty($production_order_product_detail_product_id[$i])) &&
				...
				if(isset($production_order_product_detail_id[$i]) && (!empty($production_order_product_detail_id[$i]))) {
					$update_production_order_product_detail = sprintf("UPDATE 
																		...
																		SET  
																			...
																			production_order_product_detail_sale_length  				= '%s',
																			production_order_product_detail_tot_length  				= '%f',
																			production_order_product_detail_qty  						= '%f',
																			production_order_product_detail_po_qty  					= '%f',
																			production_order_product_detail_non_po_qty  				= '%f',
																			production_order_product_detail_po_done  					= '%d',
																		...
																		WHERE 
																			...
																			$production_order_product_detail_tot_length[$i],
																			$production_order_product_detail_qty[$i],
																			$production_order_product_detail_po_qty[$i],
																			$production_order_product_detail_non_po_qty[$i],
																			$po_done,
			...
			//echo $update_production_order_product_detail; exit;
					mysql_query($update_production_order_product_detail) or die(mysql_error());
					...
					$production_order_product_detail_uniq_id 	= generateUniqId();
					 ...
					 $insert_production_order_product_detail 		= sprintf("INSERT INTO production_order_product_details 
																	...
																	VALUES     ('%s', '%d', 
																		 ...
																		 $production_order_product_detail_qty[$i],
																		 mysql_real_escape_string($production_order_product_detail_sale_length[$i]),$production_order_product_detail_tot_length[$i],
		...
		$update_status 					= sprintf("	UPDATE 
															production_order 
														SET 
															production_order_process_status				= '%d',
															production_order_modified_by 				= '%d',
															production_order_modified_on 				= UNIX_TIMESTAMP(NOW()),
															production_order_modified_ip				= '%s'
														WHERE               
