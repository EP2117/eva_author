								...
								<div class="panel-body">
									...
									<div class="col-lg-6">
										...
										<div class="form-group" style="display:inline-block;">
                                            ...
                                            <select name="width_cutting_sw_check" id="width_cutting_sw_check" class="selectbox" >
									...
									<div class="col-lg-6">
										...
										<div class="form-group">
											...
											<select name="width_cutting_godown_id" id="width_cutting_godown_id" class="form-control select2" style="width:100%" onChange="removeTableDetails()">
												  <option value=""> - Select - </option>
												<?php
                                        ...
                                        <div class="form-group">
											...
											<select name="width_cutting_brand_id" id="width_cutting_brand_id" class="form-control select2" style="width:100%" required onChange="removeTableDetails()">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
					   ...
					   <div class="panel panel-info">
								...
								<div class="panel-body">
									...
									<div class="col-lg-6">
										...
										<div class="form-group">
											...
											<label>Warehouse</label>
						<?php $detailCnt = count($width_cutting_prd_edit) + count($width_cutting_width_edit) + count($product_con_entry_child_prd_edit); ?>
                        ...
                        <?php if($detailCnt==0){ ?>
								...
								<?php }else{ ?>
                                <input type="hidden" name="width_cutting_godown_id" id="width_cutting_godown_id" class="form-control" value="<?=$width_cutting_edit['width_cutting_godown_id']?>" >
                                <input type="text" name="width_cutting_godown_name" id="width_cutting_godown_name" class="form-control" value="<?=$width_cutting_edit['godown_name']?>" >
                                <?php } ?>
										</div>
...
<?php }else{ ?>
                                <input type="hidden" name="width_cutting_brand_id" id="width_cutting_brand_id" class="form-control" value="<?=$width_cutting_edit['width_cutting_brand_id']?>" >
                                <input type="text" name="width_cutting_brand_name" id="width_cutting_brand_name" class="form-control" value="<?=$width_cutting_edit['brand_name']?>" >
                                <?php } ?>
										</div>
