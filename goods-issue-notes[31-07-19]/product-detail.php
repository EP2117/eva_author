...
?>
			...
			<tr class="odd gradeX">
				...
				<input type="hidden" name="product_colour_id" id="product_colour_id<?php echo $record_so_detail1['production_order_product_detail_id'];?>2" value="<?php echo $record_so_detail1['production_order_product_detail_product_color_id']; ?>" >
				...
				<input type="hidden" name="product_type" id="product_type<?php echo $record_so_detail1['production_order_product_detail_id'];?>2" value="<?php echo $record_so_detail1['production_order_product_detail_product_type']; ?>" />
