...
<?php
		 ...
		 $query	="SELECT 
				 ...
				 WHERE 
						...
						AND product_con_entry_child_product_detail_id = '".$product_id."'";
						//echo $query;exit;
...
<input type="hidden" name="product_colour_id" id="raw_product_colour_id<?php echo $record_so_detail['product_con_entry_child_product_detail_id'];?>2" value="<?php echo $record_so_detail['product_con_entry_child_product_detail_color_id']; ?>" >
				...
				<input type="hidden" name="product_sl_feet_mm" id="raw_product_sl_feet_mm<?php echo $record_so_detail['product_con_entry_child_product_detail_id'];?>2" value="<?php echo $record_so_detail['closing_length_meter']*-1; ?>" >
				<input type="hidden" name="product_sl_feet" id="raw_product_sl_feet<?php echo $record_so_detail['product_con_entry_child_product_detail_id'];?>2" value="<?php echo $record_so_detail['closing_length_feet']*-1; ?>" >
				<input type="hidden" name="raw_product_ton" id="raw_product_ton<?php echo $record_so_detail['product_con_entry_child_product_detail_id'];?>2" value="<?php echo $record_so_detail['closing_weight_tone']*-1; ?>" >
				<input type="hidden" name="raw_product_kg" id="raw_product_kg<?php echo $record_so_detail['product_con_entry_child_product_detail_id'];?>2" value="<?php echo $record_so_detail['closing_weight_kg']*-1; ?>" >
