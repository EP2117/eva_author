								...
								<div class="panel-body">
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												...
												<select class="form-control select2" name="product_brand_id" id="product_brand_id" required style="width:100%" onChange="addRow()">
											...
											<div class="form-group">
												...
												<select class="form-control select2" name="product_purchase_uom_id" id="product_purchase_uom_id" style="width:100%">
											...
											<!-- Added by AuthorsMM for Opp Product -->
											<div class="form-group" id="opp_div" style="display:none;">

												<label>Opp Product &nbsp;&nbsp;&nbsp;</label>

												<input type="checkbox"  name="opp_product" id="opp_product"  />

											</div>
											<!-- Added by AuthorsMM for extra length -->
											<div class="form-group" id="extra_div" style="display:none;">

												<label>Extra Length</label>

												<input class="form-control" type="text"  name="extra_length" id="extra_length"  />
										...
										<div class="col-md-6">
												...
												<select class="form-control select2" name="product_product_category_id" id="product_product_category_id" required style="width:100%" />
											...
											<div class="form-group">
												...
												<select class="form-control select2" name="product_code_type" id="product_code_type" onChange="checkCode(this.value)" style="width:100%">
					...
					<div class="col-md-12">
						...
						<div class="panel panel-info"  style="display:none" id="multi_contact">
							...
							<div class="panel-heading">
							  ...
							  <!--Selling Cost Details--> Raw Details
                                ...
                                <table class="table table-striped table-bordered table-hover" id="multi-contact" >
                                    ...
                                    <tbody id="multi-contact-display">
										...
										<td width="12%">
											...
											<select name="product_detail_raw_product_id[]" id="product_detail_raw_product_id_1" class="form-control " onFocus="get_product();">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="multi-contacts" >
                                    ...
                                    <tbody id="multi-contact-displays">
										...
										<td>
											...
											<select name="product_detail_raw_product_id1[]" id="product_detail_raw_product_id1_1" class="form-control select2" style="width:100%">
								...
								<div class="panel-body">
										...
										<div class="col-lg-6">
											...
											<div class="form-group">
												...
												<select class="form-control select2" name="product_brand_id" id="product_brand_id" style="width:100%" onChange="addRow()">
										...
										<div class="form-group">
											...
											<!-- Added by AuthorsMM for opp product -->
											<div class="form-group" id="opp_div" <?php if($product_edit['product_type'] =="2") { ?> style="display:block;" <?php } else { ?>style="display:none;"<?php } ?>>

												<label>Opp Product &nbsp;&nbsp;&nbsp;</label>

												<input type="checkbox"  name="opp_product" id="opp_product" <?php echo $product_edit['product_is_opp'] == 1 ? "checked" : ''; ?>  />

											</div>
											
											<!-- Added by AuthorsMM for extra length -->
											<div class="form-group" id="extra_div" <?php if($product_edit['product_type'] =="3") { ?> style="display:block;" <?php } else { ?>style="display:none;"<?php } ?>>

												<label>Extra Length</label>

												<input class="form-control" type="text"  name="extra_length" id="extra_length" value="<?php echo $product_edit['product_extra_length']; ?>"  />
										...
										<div class="col-lg-6">
												...
												<select class="form-control select2" name="product_product_category_id" id="product_product_category_id" style="width:100%" />
                                ...
                                <table class="table table-striped table-bordered table-hover" id="multi-contact">
                                    ...
                                    <tbody id="multi-contact-display">
										...
										<td width="12%">
											...
											<!--<input type="text" name="product_name"  value="<?=$get_product_det['product_name'].'-'.$get_product_det['product_code']?>" />
                                            <input type="hidden" name="product_detail_raw_product_id[]" id="product_detail_raw_product_id_<?=$i?>" class="form-control " value="<?=$get_product_det['product_detail_raw_product_id']?>">-->
											
											<select name="product_detail_raw_product_id[]" id="product_detail_raw_product_id_<?=$count?>" class="form-control select2">
												<option value="<?=$get_product_det['product_detail_raw_product_id']?>"  ><?=$get_product_det['brand_name']?></option>
