...
<?php
	...
	$m_id = $_GET['m_id'];
  	...
  	$select_product 		= "	SELECT  
								...
								LEFT JOIN 
									(SELECT 
										damage_stock_product_frm_detail_product_invoice_detail_id, 
										SUM(damage_stock_product_frm_detail_qty) AS sus_qty 
									FROM 
										damage_stock_product_frm_details  	
									WHERE 
										damage_stock_product_frm_detail_deleted_status 				= 0  					
									GROUP BY 
										damage_stock_product_frm_detail_product_invoice_detail_id) sus_table 
								ON 
									damage_stock_product_frm_detail_product_invoice_detail_id 		= product_invoice_product_detail_id								 
							 	WHERE 
...
?>
		...
		<table class="table datatable table-bordered" id="product_frm_detail_popup">
			<thead>
				<tr>
				  <th width="5%" >#</th>
...
$('#product_frm_detail_popup').DataTable( {
					responsive: true
} );
</script>