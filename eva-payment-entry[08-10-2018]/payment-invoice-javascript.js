...
function balance_calculation_amt(val,obj,sno){
	var inv_type		=  $("#payment_type_"+sno).val();
	 var cur_rate		=  $("#payment_currency_rate").val();
	 var pur_amnt 		= 	$("#purchaseamnt_"+sno).val().replace(/,/g, '');
	 var pur_amnt    	=	 Number(pur_amnt);
	 var advnc_amnt 	= 0;
	 var paid_amnt  	= $("#paidamnt_"+sno).val().replace(/,/g, '');
...
function balance_calculation(amt,obj,sno,type){
	var inv_type		=  $("#payment_type_"+sno).val();
	 var pay_amt		=  $("#amount_"+sno).val();
	var  frgn_amt 		= $("#amount_cur_"+sno).val();
	 var currency_rate	=  $("#payment_currency_rate").val();
	 if(type==1){
		 var frgn_amt		= 0;
	 ...
	 if(type==2){
		var pay_amt		= 0
	 	if(currency_rate!='' && currency_rate>0){
			var pay_amt		= Number(currency_rate)*Number(frgn_amt);
			$("#amount_"+sno).val(pay_amt)
		}
	 }
	 
	 
		
	var purchase_amt		=  $("#purchaseamnt_"+sno).val();
	var purchase_ad_amt		=  $("#advanceamnt_"+sno).val();
	var purchase_pd_amt		=  $("#paidamnt_"+sno).val();
	if(purchase_pd_amt==''){
		purchase_pd_amt	= 0;
	}	
	...
	var purchase_fg_amt		=  $("#purchaseamnt_cur_"+sno).val();
	var purchase_fg_ad_amt	=  $("#advanceamnt_cur_"+sno).val();
	var purchase_fg_pd_amt	=  $("#paidamnt_cur_"+sno).val();
 ...
 function discount_calculation(val,id){
	 var p_amt=$('#purchaseamnt_'+id).val();
