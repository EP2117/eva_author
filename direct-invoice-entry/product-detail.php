...
<?php
   		$select_product 			= "SELECT  
											...
											product_brand_id,
											product_colour_id,
											product_mm_qty,product_type,
											product_extra_length,
											IFNULL(product_detail_raw_product_id1, 0)
										...
										ON
											...
											product_details_one.product_detail_product_id1 = products.product_id
...
?>
			...
			<tr class="odd gradeX">
				...
				<input type="hidden" name="product_extra_length" id="product_extra_length<?php echo $record_so_detail['product_id'];?>1" value="<?php echo htmlspecialchars(ucfirst($record_so_detail['product_extra_length'])); ?>" >
				<input type="hidden" name="product_detail_raw_product_id1" id="product_detail_raw_product_id1<?php echo $record_so_detail['product_id'];?>1" value="<?php echo htmlspecialchars(ucfirst($record_so_detail['product_detail_raw_product_id1'])); ?>" >
				...
				<input type="hidden" name="product_type" id="product_type<?php echo $record_so_detail['product_id'];?>1" value="<?php echo $t_id;?>" >
                ...
                <input type="hidden" name="product_mother_child_type" id="product_mother_child_type<?php echo $record_so_detail['product_id'];?>1" value="1" >
				<input type="hidden" name="product_is_opp" id="product_is_opp<?php echo $record_so_detail['product_id'];?>1" value="<?php echo $record_so_detail['product_is_opp']; ?>" >
				
				<?php
					if($record_so_detail['product_is_opp'] == 1 || $record_so_detail['product_type'] == '2') {
						$result_opp = mysql_query("Select stock_ledger_product_feet_per_quantity From stock_ledger Where stock_ledger_type = 'in' AND stock_ledger_product_id = ".$record_so_detail['product_id']." LIMIT 1");
						$opp_arr = mysql_fetch_assoc($result_opp);
						$feet_per_qty = $opp_arr['stock_ledger_product_feet_per_quantity'];
				?>
				<input type="hidden" name="product_opp_feet_per_qty" id="product_opp_feet_per_qty<?php echo $record_so_detail['product_id'];?>1" value="<?php echo $feet_per_qty; ?>" >
				<?php
					} else {
				?>
				<input type="hidden" name="product_opp_feet_per_qty" id="product_opp_feet_per_qty<?php echo $record_so_detail['product_id'];?>1" value="0" >
				<?php
					}
				?>
				
				<input type="hidden" name="product_category_id" id="product_category_id<?php echo $record_so_detail['product_id'];?>1" value="<?php echo $record_so_detail['product_product_category_id']; ?>" >
...
<?php  }
    ...
    <?php
   		/* $select_product 			= "SELECT  
											...
											product_con_entry_child_product_detail_ton_qty,product_con_entry_child_product_detail_uom_id,brand_name,
										...
										WHERE 
											...
											product_con_entry_child_product_detail_product_id 							NOT IN (".$m_id.")								AND
...
?>
			...
			<!--<tr class="odd gradeX">
				...
				<input type="checkbox" class="check_prd_id" name="chk_product_id[]" id="chk_product_id<?php echo $record_so_detail['product_con_entry_child_product_detail_id'];?>2" value="<?php echo $record_so_detail['product_con_entry_child_product_detail_id']; ?>2" />
				<input type="hidden" name="product_id" id="product_id<?php echo $record_so_detail['product_con_entry_child_product_detail_id'];?>2" value="<?php echo $record_so_detail['product_con_entry_child_product_detail_id']; ?>" >
				...
				<input type="hidden" name="product_code" id="product_code<?php echo $record_so_detail['product_con_entry_child_product_detail_id'];?>2" value="<?php echo $record_so_detail['product_con_entry_child_product_detail_code']; ?>" >
					...
					<input type="hidden" name="product_brand_id" id="product_brand_id<?php echo $record_so_detail['product_con_entry_child_product_detail_id'];?>2" value="<?php echo $record_so_detail['product_con_entry_child_product_detail_product_brand_id']; ?>" >
				...
				<input type="hidden" name="product_inches" id="product_inches<?php echo $record_so_detail['product_con_entry_child_product_detail_id'];?>2" value="<?php echo $record_so_detail['product_con_entry_child_product_detail_ton_qty']; ?>" >
				<input type="hidden" name="product_inches_mm" id="product_inches_mm<?php echo $record_so_detail['product_con_entry_child_product_detail_id'];?>2" value="<?php echo $record_so_detail['product_con_entry_child_product_detail_kg_qty']; ?>" >
                ...
                <input type="hidden" name="product_mother_child_type" id="product_mother_child_type<?php echo $record_so_detail['product_con_entry_child_product_detail_id'];?>2" value="2" >
				</td>
