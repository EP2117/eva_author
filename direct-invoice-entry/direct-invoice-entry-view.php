							...
							<div class="panel-body">
                                    ...
                                    <thead  >
										<tr>
                                         ...
                                         <tr>
											...
											<th rowspan="2" style="vertical-align:middle;" class="text-center"> Inches</th>
											<th colspan="2" class="text-center">SALES WIDTH</th>
											<th rowspan="2" style="vertical-align:middle;border:solid 1px #ddd;" class="text-center">LENGTH</th>
											<!--<th colspan="4" class="text-center"> SALES LENGTH</th> -->
											<th rowspan="2" style="vertical-align:middle; border:solid 1px #ddd;" nowrap="nowrap" class="text-center">QTY</th>
											<th rowspan="2" style="vertical-align:middle;" nowrap="nowrap" class="text-center">Total Length</th>
											<th rowspan="2" style="vertical-align:middle;" nowrap="nowrap" class="text-center">Rate</th>
											<th rowspan="2" style="vertical-align:middle;" nowrap="nowrap" class="text-center">Amount </th>
										</tr>
										<tr>
											...
											<!--<th nowrap="nowrap" class="text-center">FEET</th>
											<th nowrap="nowrap" class="text-center">FT.IN</th>
											<th nowrap="nowrap" class="text-center">MM</th>
											<th nowrap="nowrap" class="text-center">Met</th>-->
										</tr>
                                    </thead>
								...
								<table class="table table-striped table-bordered table-hover" id="product_detail_rws"  style="width:100%;display:none">
									<thead>
										...
										<tr>
											<!--<th nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; INCHES &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
											<th nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; MM &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>-->
											<th nowrap="nowrap" class="text-center">INCHES</th>
											<th nowrap="nowrap" class="text-center">MM</th>
											<th nowrap="nowrap" class="text-center">TON</th>
											<th nowrap="nowrap" class="text-center">KG</th>
											<th nowrap="nowrap" class="text-center">Met</th>
										</tr>
                                    </thead>
									...
									<thead >
										<tr>
                                         ...
                                         <tr>
											...
											<th style="vertical-align:middle;" class="text-center sale-by">SALE BY</th>
								...
								<table class="table table-striped table-bordered table-hover" style=" width:100%" >
									...
									<tr id="tax_details">
										...
										<td colspan="2">Commercial Tax</td>
										...
										<input type="hidden" class="form-control" name="invoice_entry_tax_per" id="invoice_entry_tax_per" value="" ></td>

										<td><input type="text" class="form-control" name="invoice_entry_tax_amount" id="invoice_entry_tax_amount"  onBlur="totalAmount()" value="0"></td>
									...
									<tr>
										...
										<td><input type="text" class="form-control" name="invoice_entry_total_amount" id="invoice_entry_total_amount" onBlur="totalAmount()" ></td>
									</tr>
									<tr>
										<td style="width:50%">&nbsp;</td>
...
<!--
									...
									<div class="col-lg-6">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="invoice_entry_prd_type_txt" id="invoice_entry_prd_type_txt" value="<?=$invoice_entry_prd_type?>" >
											<input type="hidden" class="form-control" name="invoice_entry_prd_type" id="invoice_entry_prd_type" value="<?=$invoice_entry_edit['invoice_entry_prd_type']?>" >
										</div>
							...
							<div class="panel-body">
								...
								<table class="table table-striped table-bordered table-hover" id="product_detail_rls"  style="width:100%;display:none"><!--display:none-->
                                    <thead  >
										<tr>
                                         ...
                                         <tr>
											...
											<th rowspan="2" style="vertical-align:middle;border:solid 1px #ddd;" class="text-center"> LENGTH</th>
											<!--<th colspan="4" class="text-center"> SALES LENGTH</th>-->
											<th rowspan="2" style="vertical-align:middle;" nowrap="nowrap" class="text-center">QTY</th>
											<th rowspan="2" style="vertical-align:middle;" nowrap="nowrap" class="text-center"> Total Length</th>
											<th rowspan="2" style="vertical-align:middle;" nowrap="nowrap" class="text-center"> Rate</th>
											<th rowspan="2" style="vertical-align:middle;" nowrap="nowrap" class="text-center"> Amount </th>
										</tr>
									...
									<?php 
										...
										<input type="hidden"  name="invoice_entry_product_category_id[]" id="invoice_entry_product_category_id<?=$row_cnt?>" value="<?=$get_product_detail['product_product_category_id']?>" />
										<input type="hidden" name="invoice_entry_product_opp_feet_per_qty[]" id="invoice_entry_product_opp_feet_per_qty<?=$row_cnt?>" value="0" >
										<input type="hidden" name="invoice_entry_product_is_opp[]" id="invoice_entry_product_is_opp<?=$row_cnt?>" value="0" >
										<input type="hidden" name="invoice_entry_product_detail_sale_by[]" id="invoice_entry_product_detail_sale_by<?=$row_cnt?>" value="" >
									
										<input type="hidden"  name="invoice_entry_product_detail_mother_child_type[]" id="invoice_entry_product_detail_mother_child_type<?=$row_cnt?>" value="<?=$get_product_detail['invoice_entry_product_detail_mother_child_type']?>" />
										...
										<input type="hidden"  name="invoice_entry_product_detail_product_brand_id[]" id="invoice_entry_product_detail_product_brand_id<?=$row_cnt?>" value="<?=$get_product_detail['brand_id']?>" />
										...
										<td><select  name="invoice_entry_product_detail_product_color_id[]" id="invoice_entry_product_detail_product_color_id<?=$row_cnt?>" readonly>
										<option value=""> --Select-- </option>
										...
										<td><select  name="invoice_entry_product_detail_product_thick[]" id="invoice_entry_product_detail_product_thick<?=$row_cnt?>" readonly >
										<option value=""> --Select-- </option>
										...
										<td><input class="form-control" type="text"  name="invoice_entry_product_detail_width_inches[]" id="invoice_entry_product_detail_width_inches<?=$row_cnt?>"   onBlur="GetTotalLength(<?=$row_cnt?>),GetWcalc(2,<?=$row_cnt?>)" value="<?=sprintf('%0.3f',$get_product_detail['invoice_entry_product_detail_width_inches']);?>"  style="width:70px;" /></td>
										<td><!--<input class="form-control" type="hidden"  name="invoice_entry_product_detail_width_inches[]" id="invoice_entry_product_detail_width_inches<?=$row_cnt?>"   onBlur="GetTotalLength(<?=$row_cnt?>),GetWcalc(2,<?=$row_cnt?>)" value="<?=sprintf('%0.3f',$get_product_detail['invoice_entry_product_detail_width_inches']);?>"  />-->
										<input class="form-control" type="hidden"  name="invoice_entry_product_detail_width_mm[]" id="invoice_entry_product_detail_width_mm<?=$row_cnt?>"  onBlur="GetTotalLength(<?=$row_cnt?>),GetWcalc(3,<?=$row_cnt?>)" value="<?=round($get_product_detail['invoice_entry_product_detail_width_mm']);?>"  />
										<input class="form-control" type="text"  name="invoice_entry_product_detail_s_width_inches[]" id="invoice_entry_product_detail_s_width_inches<?=$row_cnt?>"   onkeyup="GetLcalS(2,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" value="<?=sprintf('%0.3f',$get_product_detail['invoice_entry_product_detail_s_width_inches']);?>" style="width:70px;" /></td>
										 <td>
											<input class="form-control" type="text"  name="invoice_entry_product_detail_s_width_mm[]" id="invoice_entry_product_detail_s_width_mm<?=$row_cnt?>" value="<?=round($get_product_detail['invoice_entry_product_detail_s_width_mm']);?>"  style="width:70px;" readonly />
											
											<!--<input class="form-control" type="text"  name="invoice_entry_product_detail_s_width_mm[]" id="invoice_entry_product_detail_s_width_mm<?=$row_cnt?>" onKeyUp="GetLcalS(3,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" value="<?=round($get_product_detail['invoice_entry_product_detail_s_width_mm']);?>"  style="width:70px;" />-->
											
										</td>
										 
										 <td><input class="form-control" type="text"  name="invoice_entry_product_detail_sale_length[]" id="invoice_entry_product_detail_sale_length<?=$row_cnt?>" value="<?=htmlspecialchars($get_product_detail['invoice_entry_product_detail_sale_length']);?>" onBlur="changeSaleLength('<?=$row_cnt?>')" style="width:90px;"/><!-- </td> commented </td> by EP for Sale Length hiding -->
										 
										 <!-- sale length textboxes -->
										 <!--
										
										<td><input class="form-control" type="text"  name="invoice_entry_product_detail_sl_feet[]" id="invoice_entry_product_detail_sl_feet<?=$row_cnt?>" value="<?=round($get_product_detail['invoice_entry_product_detail_sl_feet']);?>" style="width:80px;" readonly /></td> 
										<td><input class="form-control" type="text"  name="invoice_entry_product_detail_sl_feet_in[]" id="invoice_entry_product_detail_sl_feet_in<?=$row_cnt?>" value="<?=sprintf('%0.3f',$get_product_detail['invoice_entry_product_detail_sl_feet_in']);?>" style="width:70px;" readonly /></td>
										<td><input class="form-control" type="text"  name="invoice_entry_product_detail_sl_feet_mm[]" id="invoice_entry_product_detail_sl_feet_mm<?=$row_cnt?>" value="<?=round($get_product_detail['invoice_entry_product_detail_sl_feet_mm']);?>" style="width:80px;" readonly /></td>
										<td><input class="form-control" type="text"  name="invoice_entry_product_detail_sl_feet_met[]" id="invoice_entry_product_detail_sl_feet_met<?=$row_cnt?>"  value="<?=sprintf('%0.3f',$get_product_detail['invoice_entry_product_detail_sl_feet_met']);?>" style="width:80px;" readonly />-->
										...
										<input type="hidden"  name="invoice_entry_product_detail_s_weight_inches[]" id="invoice_entry_product_detail_s_weight_inches<?=$row_cnt?>" value="<?=sprintf('%0.3f',$get_product_detail['invoice_entry_product_detail_s_weight_inches']);?>"/>
										<input type="hidden"  name="invoice_entry_product_detail_s_weight_mm[]" id="invoice_entry_product_detail_s_weight_mm<?=$row_cnt?>"  value="<?=round($get_product_detail['invoice_entry_product_detail_s_weight_mm']);?>"/></td>
										
										<td><input class="form-control" type="text"  name="invoice_entry_product_detail_qty[]" id="invoice_entry_product_detail_qty<?=$row_cnt?>" onBlur="GetTotalLength(<?=$row_cnt?>);GetTotalLength(3,<?=$row_cnt?>);discountPerFind(<?=$row_cnt?>);" value="<?=round($get_product_detail['invoice_entry_product_detail_qty']);?>" style="width:60px;" /></td> 
										<td><input class="form-control" type="text"  name="invoice_entry_product_detail_tot_length[]" id="invoice_entry_product_detail_tot_length<?=$row_cnt?>" readonly  value="<?=sprintf('%0.3f',$get_product_detail['invoice_entry_product_detail_tot_length']); ?>" style="width:90px;" readonly /> 
										...
										<td><input class="form-control" type="text"  name="invoice_entry_product_detail_rate[]" id="invoice_entry_product_detail_rate<?=$row_cnt?>"   onBlur="discountPerFind(<?=$row_cnt?>)" value="<?=round($get_product_detail['invoice_entry_product_detail_rate']); ?>" style="width:90px;" /></td>
										<td><input class="form-control" type="text" name="invoice_entry_product_detail_total[]" id="invoice_entry_product_detail_total<?=$row_cnt?>"   value="<?=round($get_product_detail['invoice_entry_product_detail_total']); ?>" style="width:100px;" readonly /></td></td>	
								...
								<input type="hidden"  name="invoice_entry_product_detail_entry_type[]" id="invoice_entry_product_detail_entry_type<?=$row_cnt?>" value="<?=$get_product_detail['invoice_entry_product_detail_entry_type']?>" /></td>
									...
									<td><input class="form-control" type="text"  name="invoice_entry_product_detail_width_inches[]" id="invoice_entry_product_detail_width_inches<?=$row_cnt?>"   onBlur="GetWcalc(2,<?=$row_cnt?>)" value="<?=sprintf('%0.3f',$get_product_detail['invoice_entry_product_detail_width_inches']);?>"  />
									<input class="form-control" type="hidden"  name="invoice_entry_product_detail_width_mm[]" id="invoice_entry_product_detail_width_mm<?=$row_cnt?>"  onBlur="GetTotalLength(<?=$row_cnt?>),GetWcalc(3,<?=$row_cnt?>)" value="<?=round($get_product_detail['invoice_entry_product_detail_width_mm']);?>"  />
									</td>
									
									<td><input class="form-control" type="text"  name="invoice_entry_product_detail_s_width_inches[]" onBlur="GetTotalLength(<?=$row_cnt?>)" id="invoice_entry_product_detail_s_width_inches<?=$row_cnt?>"   onkeyup="GetLcalS(2,<?=$row_cnt?>)" value="<?=sprintf('%0.3f',$get_product_detail['invoice_entry_product_detail_s_width_inches']);?>"/></td> 
									<td>
										<input class="form-control" type="text"  name="invoice_entry_product_detail_s_width_mm[]" id="invoice_entry_product_detail_s_width_mm<?=$row_cnt?>"  value="<?=round($get_product_detail['invoice_entry_product_detail_s_width_mm']);?>" readonly />
										
										<!--<input class="form-control" type="text"  name="invoice_entry_product_detail_s_width_mm[]" id="invoice_entry_product_detail_s_width_mm<?=$row_cnt?>" onKeyUp="GetLcalS(3,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" value="<?=round($get_product_detail['invoice_entry_product_detail_s_width_mm']);?>" /> -->
									</td>
										
										<td><input class="form-control" type="text"  name="invoice_entry_product_detail_s_weight_inches[]" onBlur="GetWeightClc(1,<?=$row_cnt?>),RawdiscountPerFind(<?=$row_cnt?>)"id="invoice_entry_product_detail_s_weight_inches<?=$row_cnt?>"    value="<?=sprintf('%0.3f',$get_product_detail['invoice_entry_product_detail_s_weight_inches']);?>"/></td> 
										<td><input class="form-control" type="text"  name="invoice_entry_product_detail_s_weight_mm[]" id="invoice_entry_product_detail_s_weight_mm<?=$row_cnt?>"  onblur="GetWeightClc(2,<?=$row_cnt?>)" value="<?=round($get_product_detail['invoice_entry_product_detail_s_weight_mm'])?>"/>
										<td><input class="form-control" type="text"  name="invoice_entry_product_detail_s_weight_met[]" id="invoice_entry_product_detail_s_weight_met<?=$row_cnt?>"  value="<?=sprintf('%0.3f',$get_product_detail['invoice_entry_product_detail_s_weight_met']);?>"/></td>
										...
										<td><input class="form-control" type="text"  name="invoice_entry_product_detail_rate[]" id="invoice_entry_product_detail_rate<?=$row_cnt?>" onBlur="RawdiscountPerFind(<?=$row_cnt?>)"   value="<?=round($get_product_detail['invoice_entry_product_detail_rate']); ?>"/></td>
										<td><input class="form-control" type="text"  name="invoice_entry_product_detail_total[]" id="invoice_entry_product_detail_total<?=$row_cnt?>"  value="<?=round($get_product_detail['invoice_entry_product_detail_total']); ?>"/><input class="form-control" type="hidden"  name="invoice_entry_product_detail_sl_feet_mm[]" id="invoice_entry_product_detail_sl_feet_mm<?=$row_cnt?>"  value="<?=round($get_product_detail['invoice_entry_product_detail_sl_feet_mm']);?>" /><input class="form-control" type="hidden"  name="invoice_entry_product_detail_sl_feet_met[]" id="invoice_entry_product_detail_sl_feet_met<?=$row_cnt?>"  value="<?=sprintf('%0.3f',$get_product_detail['invoice_entry_product_detail_sl_feet_met']);?>" /> <input class="form-control" type="hidden"  name="invoice_entry_product_detail_sl_feet[]" id="invoice_entry_product_detail_sl_feet<?=$row_cnt?>"  value="<?=round($get_product_detail['invoice_entry_product_detail_sl_feet'])?>" /> <input class="form-control" type="hidden"  name="invoice_entry_product_detail_sl_feet_in[]" id="invoice_entry_product_detail_sl_feet_in<?=$row_cnt?>"  value="<?=sprintf('%0.3f',$get_product_detail['invoice_entry_product_detail_sl_feet_in']);?>" /></td>
									...
									<td>
										...
										<?php
											if($get_product_detail['product_is_opp'] == 1) {
												$result_opp = mysql_query("Select stock_ledger_product_feet_per_quantity From stock_ledger Where stock_ledger_type = 'in' AND stock_ledger_product_id = ".$get_product_detail['invoice_entry_product_detail_product_id']." LIMIT 1");
												$opp_arr = mysql_fetch_assoc($result_opp);
												$feet_per_qty = $opp_arr['stock_ledger_product_feet_per_quantity'];
										?>
										<input type="hidden" name="invoice_entry_product_opp_feet_per_qty[]" id="invoice_entry_product_opp_feet_per_qty<?=$row_cnt?>" value="<?php echo $feet_per_qty; ?>" >
										<input type="hidden" name="invoice_entry_product_is_opp[]" id="invoice_entry_product_is_opp<?=$row_cnt?>" value="1" >
										<?php
											} else {
										?>
										<input type="hidden" name="invoice_entry_product_opp_feet_per_qty[]" id="invoice_entry_product_opp_feet_per_qty<?=$row_cnt?>" value="0" >
										...
										<?php
											if($get_product_detail['product_is_opp'] == 1) {
										?>
											<select  name="invoice_entry_product_detail_sale_by[]" id="invoice_entry_product_detail_sale_by<?=$row_cnt?>" class="form-control" style="width:30%;display:inline-block" ><option value="qty" <?=$get_product_detail['invoice_entry_product_detail_sale_by']=='qty'?'selected':''?>>QTY</option><option value="feet" <?=$get_product_detail['invoice_entry_product_detail_sale_by']=='feet'?'selected':''?>>FEET</option></select>&nbsp;&nbsp;&nbsp;
											<input class="form-control" style="display:inline-block;width:60%" type="text"  name="invoice_entry_product_detail_qty[]" id="invoice_entry_product_detail_qty<?=$row_cnt?>"  onBlur="AccdiscountPerFind(<?=$row_cnt?>)"  value="<?=$get_product_detail['invoice_entry_product_detail_sale_by']=='qty'?$get_product_detail['invoice_entry_product_detail_qty']:$get_product_detail['invoice_entry_product_detail_sale_feet'];?>"  />
										<?php
											}
											else {
										?>
											<select  name="invoice_entry_product_detail_sale_by[]" id="invoice_entry_product_detail_sale_by<?=$row_cnt?>" class="form-control" style="width:30%;display:inline-block" ><option value="qty">QTY</option></select>&nbsp;&nbsp;&nbsp;
											<input class="form-control" style="display:inline-block;width:60%" type="text"  name="invoice_entry_product_detail_qty[]" id="invoice_entry_product_detail_qty<?=$row_cnt?>"  onBlur="AccdiscountPerFind(<?=$row_cnt?>)"  value="<?=round($get_product_detail['invoice_entry_product_detail_qty']);?>"  />
										<?php
											}
										?>
									 ...
									 <td><input class="form-control" type="text"  name="invoice_entry_product_detail_rate[]" id="invoice_entry_product_detail_rate<?=$row_cnt?>" onBlur="AccdiscountPerFind(<?=$row_cnt?>)"  value="<?=round($get_product_detail['invoice_entry_product_detail_rate']); ?>" /></td>
								...
								<table class="table table-striped table-bordered table-hover" style=" width:100%" >
									...
									<tr>
										...
										<td style="width:20%;text-align:right"><input type="text" class="form-control" name="invoice_entry_gross_amount" id="invoice_entry_gross_amount" value="<?=number_format($invoice_entry_edit['invoice_entry_gross_amount'])?>" ></td>
									...
									<tr>
										...
										<td style="text-align:right"><input type="text" class="form-control" name="invoice_entry_transport_amount" id="invoice_entry_transport_amount" onBlur="totalAmount()"  value="<?=number_format($invoice_entry_edit['invoice_entry_transport_amount'])?>"/></td>
									...
									<tr id="tax_details">
										...
										<!--<td style="width:20%;text-align:right"><input type="text" class="form-control" name="invoice_entry_tax_per" id="invoice_entry_tax_per" onBlur="totalAmount()"  value="<?=number_format($invoice_entry_edit['invoice_entry_tax_per'])?>"/></td>-->
										<input type="hidden" class="form-control" name="invoice_entry_tax_per" id="invoice_entry_tax_per" value="<?=number_format($invoice_entry_edit['invoice_entry_tax_per'])?>"/>

										<td style="text-align:right"><input type="text" class="form-control" name="invoice_entry_tax_amount" id="invoice_entry_tax_amount" value="<?=number_format($invoice_entry_edit['invoice_entry_tax_amount'])?>" onBlur="totalAmount()" /></td>
									...
									<tr>
										<td style="width:50%">&nbsp;</td>
										<td colspan="2">Total</td>
										<td><input type="text" class="form-control" name="invoice_entry_total_amount" id="invoice_entry_total_amount" value="<?=number_format($invoice_entry_edit['invoice_entry_total_amount'])?>" onBlur="totalAmount()"></td>
									</tr>
									<tr>
										<td style="width:50%">&nbsp;</td>
										<td colspan="2">Advance</td>
										<td><input type="text" class="form-control" name="invoice_entry_advance_amount" id="invoice_entry_advance_amount" onBlur="totalAmount()" value="<?=number_format($invoice_entry_edit['invoice_entry_advance_amount'])?>" ></td>
									</tr>
									<tr>
									...
									<tr>
										<td style="width:50%">&nbsp;</td>
										<td colspan="2">Balance</td>
										<td><input type="text" class="form-control" name="invoice_entry_net_amount" id="invoice_entry_net_amount" value="<?=number_format($invoice_entry_edit['invoice_entry_net_amount'])?>"  ></td>
									</tr>
									...
									<tr>
										...
										<td>
											<select class='form-control' name='invoice_entry_acc_bank_id' id='invoice_entry_acc_bank_id'>
										    <option value=''>--Select--</option>
										    <?php 
												$acc = bank($invoice_entry_edit['invoice_entry_payment_mode']);
												if(count($acc) > 0) {
												foreach($acc as $get_value){?>
									...
									?>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <?php
												...
												$chk_query = mysql_query("Select * From production_order Where production_order_invoice_entry_id = ".$get_invoice['invoice_entry_id']." AND production_order_process_status = 1");
											?>
                                            <td class="center">
											<?php
...
<input type="hidden" value="<?php echo $_SESSION[SESS.'_financial_year_to_date']; ?>" id="pic_to">
	...
	$( "#search_to_date" ).datepicker({dateFormat:'dd/mm/yy',minDate:from, maxDate:'', onClose: function( selectedDate ) { $( "#search_from_date" ).datepicker( "option", "maxDate", selectedDate )}});
		...
		$("#quotation_entry_list_form").submit(function(){
		    var checkedNum = $('input[name="deleteCheck[]"]:checked').length;
			if (!checkedNum) {
				alert('Please select checkbox you want to delete.');
				return false;
			}
		});
		</script>
