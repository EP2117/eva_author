                    ...
                    <div class="col-md-12">
						...
						<div class="row">
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="panel-heading">
							<!--<a href="<?php echo PROJECT_PATH.'/stock-available/stock-print.php?brandid='.searchValue('brandid').'&todate='.searchValue('todate').'&account_sub_id='.searchValue('account_sub_id').'&branchid='.searchValue('branchid').'&productname='.searchValue('productname').'&colorid='.searchValue('colorid').'&width='.searchValue('width').'&branchid='.searchValue('branchid').'&warehouseid='.searchValue('warehouseid').'&from_date='.searchValue('from_date').'&to_date='.searchValue('to_date').'&thik='.searchValue('thik').'&productcode='.searchValue('productcode');  ?>" title="Download PDF" target="_blank" align="right">
							<img src="<?php echo PROJECT_PATH.'/images/pdf-icon.png'; ?>" width="28" border="0"   alt="Download PDF" title="Download PDF">
							</a>-->
							<a href="<?php echo PROJECT_PATH.'/account-ledger/stock-available-excel.php?fromdate='.searchValue('fromdate').'&todate='.searchValue('todate').'&account_sub_id='.searchValue('account_sub_id').'&branchid='.searchValue('branchid');  ?>" title="Download PDF" target="_blank" align="right">
							<img src="<?php echo PROJECT_PATH.'/images/excel-icon.png'; ?>" width="28" border="0"   alt="Download PDF" title="Download PDF">
								...
								<div class="row">
									...
									<?php				
											...
											$desc = '';
											//echo "<pre>"; print_r($list_transaction); echo "</pre>";
										  if($list_transaction) {
												$s_no	= 1;
