  ...
  <tr>
    <?php 
		...
		if(!empty($r[1]) && $r[0]!= 'Product Code') {
			...
			$product_weight_ton				= number_format(($product_weight_kg/1000),'2','.','');
			...
			if($product_id=='' || $product_id==0){
				...
				$product_id=mysql_insert_id();
					...
					stockLedger('in',$product_id,$product_id,$product_id,$product_feet,$product_feet_mm,$product_weight_ton,$product_weight_kg,'1', $branchid,  $product_con_entry_godown_id, '2018-06-01',$product_code,'OPEN-ENTRY', '2',$product_width,$product_width_mm,$product_colour_id,$thick_id);
		}
