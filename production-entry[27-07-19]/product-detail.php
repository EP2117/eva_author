...
?>
			...
			<tr class="odd gradeX">
				...
				<input type="hidden" name="uom_id" id="uom_id<?php echo $record_so_detail['grn_entry_product_detail_id'];?>" value="<?php echo $record_so_detail['product_product_uom_id']; ?>" />
					<input type="hidden" name="grn_id" id="grn_id<?php echo $record_so_detail['grn_entry_product_detail_id'];?>" value="<?php echo $record_so_detail['grn_entry_id']; ?>" /><input type="hidden" name="mother_child_type" id="mother_child_type<?php echo $record_so_detail['grn_entry_product_detail_id'];?>" value="<?php echo $record_so_detail['grn_entry_product_detail_mother_child_type']; ?>" />
