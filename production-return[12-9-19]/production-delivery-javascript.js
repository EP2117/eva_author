...
function AddproductDetail(){
	...
	for (var k = 0; k < x.length; k++) {
		if (x[k].checked ==true) {
			...
			apnd	+= '<tr><td><input type="hidden"  name="prn_entry_product_detail_mother_child_type[]" id="prn_entry_product_detail_mother_child_type" value="'+product_mother_child_type+'" />'+product_code+'</td><td>'+product_brand_name+'</td><td>'+product_name+'<input type="hidden"  name="prn_entry_product_detail_product_id[]" id="prn_entry_product_detail_product_id" value="'+product_id+'" /><input type="hidden"  name="prn_entry_product_detail_product_type[]" id="prn_entry_product_detail_product_type" value="'+product_type+'" /><input type="hidden"  name="prn_entry_product_detail_production_detail_id[]" id="prn_entry_product_detail_production_detail_id" value="'+detail_id+'" />';
