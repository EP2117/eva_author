...
{//alert();
	...
	document.getElementById('quotation_entry_dis_amount').value 	= dis_amount.toFixed(0);
	...
	var tax_amount 				= (isNaN(tax_amount)? 0.00 : parseFloat(tax_amount));
	 ...
	 document.getElementById('quotation_entry_tax_amount').value	= tax_amount.toFixed(0);
	...
	document.getElementById('quotation_entry_net_amount').value 	= net_amount.toFixed(0);
