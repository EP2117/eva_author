...
<body >
   ...
   <tr>
	  ...
	  <td colspan="2" class="report-border-right report-border-bottom" style='text-align:left;font-weight:bold;font-size:13px;width:50%;' >QUOTATION NO : &nbsp;<?=$invoice_entry_edit['quotation_entry_no']?></td>
	...
	<tr>	 
	 ...
	 <td colspan="2" class="report-border-right report-border-bottom" style='text-align:left;font-weight:bold;font-size:13px;width:50%;' >INVOICE NO : <?=$invoice_entry_edit['invoice_entry_no']?></td>
	</tr>
	<tr>	 
...
<table style="width:100%;font-size:11px;" cellspacing="0"  class="report-outer-table">
	...
	<tr>
		...
		<td class="report-border-right report-border-bottom" style='text-align:left;font-weight:bold;font-size:11px;width:25%' > Tax : &nbsp;&nbsp;&nbsp;&nbsp; <?=round($invoice_entry_edit['invoice_entry_tax_per'])?> % </td>
