		...
		// echo $invoice_entry_product_detail_qty[$i]; exit;
			...
			if($detail_request_fields) {
				...
				if($invoice_entry_type==1 && $_SESSION[SESS.'_session_user_branch_type']==1){
					...
					//echo $ton_qty;
					reduceRawMaterial($child_type,$produt_id,$product_thick,$product_colour_id,$width_inches,$tot_length,$invoice_entry_no,$invoice_entry_date,$invoice_entry_id,$detail_id,$invoice_entry_branch_id,$entry_type,$invoice_entry_product_detail_entry_type[$i],$ton_qty,$kg_qty,$detail_qty);	
					}
				}
