...
<head>
    ...
    <title>Direct Invoice Product Entry</title>
<?php 
...
?>
<script type="text/javascript" src="<?php echo PROJECT_PATH.'/sales-direct-invoice-product-report/sales-invoice-product-report-javascript.js'; ?>"></script>
</head>
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Direct Invoice Product Report</h1>
                        ...
                        <div class="panel-body">
							...
							<div class="row" style="margin-left:3px;margin-right:3px;">
								...
								<div class="col-lg-4">
									...
									$select =(in_array($key,$ser_val))?'checked="checked"':'';?>
								...
								<table class="table table-striped table-bordered table-hover" id="product_detail_rls" >
                                    ...
                                    <thead >
										 ...
										 <th rowspan="2" class="text-center" style="vertical-align:middle;">#</th>
											...
											<th rowspan="2" style="vertical-align:middle;" class="text-center"> INVOICE NO</th>
                                    ...
                                    <tbody >
										...
										<td class="text-right"><?php echo $sno++;?></td>	
											...
											<td class="text-right"><?php echo $arr_thick[$get_val['invoice_entry_product_detail_product_thick']];?></td>
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['invoice_entry_product_detail_s_width_inches']);?></td>
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['invoice_entry_product_detail_s_width_mm']);?></td>
											<!--<td><?php echo sprintf('%0.2f', $get_val['invoice_entry_product_detail_sl_feet']);?></td>
											<td><?php echo $get_val['invoice_entry_product_detail_sl_feet_met'];?></td>-->
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['invoice_entry_product_detail_s_weight_inches']);?></td>
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['invoice_entry_product_detail_s_weight_mm']); ?></td>
											<td class="text-right"><?php echo round($get_val['invoice_entry_product_detail_s_weight_met']); ?></td>
											<!--<td><?php echo number_format($get_val['invoice_entry_product_detail_qty'],3,'.','');?></td>-->
											<td class="text-right"><?php echo number_format($get_val['invoice_entry_product_detail_rate']);?></td>
											<?php 
											 $search_with_amt=searchValue('search_with_amt');
											if($search_with_amt=='search_with_amt'){?>
											<td class="text-right"><?php echo number_format($get_val['invoice_entry_product_detail_total']);?></td>
											<?php
												}
											?>
										...
										$subinches=$subinches+$get_val['invoice_entry_product_detail_s_width_inches'];
										$submm = $submm+$get_val['invoice_entry_product_detail_s_width_mm'];
										$subton = $subton+$get_val['invoice_entry_product_detail_s_weight_inches'];
										$subkg = $subkg+$get_val['invoice_entry_product_detail_s_weight_mm'];
										$submet = $submet+$get_val['invoice_entry_product_detail_s_weight_met'];
										$subrate = $subrate+$get_val['invoice_entry_product_detail_rate'];
										$subtotal = $subtotal+$get_val['invoice_entry_product_detail_total'];
										$grandinches=$grandinches+$get_val['invoice_entry_product_detail_s_width_inches'];
										$grandmm = $grandmm+$get_val['invoice_entry_product_detail_s_width_mm'];
										$grandton = $grandton+$get_val['invoice_entry_product_detail_s_weight_inches'];
										$grandkg = $grandkg+$get_val['invoice_entry_product_detail_s_weight_mm'];
										$grandmet = $grandmet+$get_val['invoice_entry_product_detail_s_weight_met'];
										$grandrate = $grandrate+$get_val['invoice_entry_product_detail_rate'];
										$grandtotal = $grandtotal+$get_val['invoice_entry_product_detail_total'];
								...
								?>
									<thead>
                                         ...
                                         <tr>
											...
											<th style="vertical-align:middle;" class="text-center"> INVOICE NO</th>
                                    ...
                                    <tbody >
										...
										<td class="text-right"><?php echo $sno++;?></td>	
											...
											<td><?php echo $get_val['product_name'];?></td>
											<td><?php echo $get_val['product_uom_name'];?></td>
											<td class="text-right"><?php echo round($get_val['invoice_entry_product_detail_qty']);?></td>
											<td class="text-right"><?php echo number_format($get_val['invoice_entry_product_detail_rate']);?></td>
											<?php 
											 $search_with_amt=searchValue('search_with_amt');
											if($search_with_amt=='search_with_amt'){?>
								...
								?>
                                    ...
                                    <tbody >
										...
										<td class="text-right"><?php echo $sno++;?></td>	
											...
											<!--<td><?php echo sprintf('%0.2f', $get_val['invoice_entry_product_detail_sl_feet']);?></td>
											<td><?php echo $get_val['invoice_entry_product_detail_sl_feet_met'];?></td>-->
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['invoice_entry_product_detail_sl_feet']);?></td>
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['invoice_entry_product_detail_sl_feet_in']);?></td>
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['invoice_entry_product_detail_sl_feet_mm']); ?></td>
											<td class="text-right"><?php echo round($get_val['invoice_entry_product_detail_sl_feet_met']); ?></td>
											<td class="text-right"><?php echo round($get_val['invoice_entry_product_detail_qty']);?></td>
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['invoice_entry_product_detail_tot_length']);?></td>
											<td class="text-right"><?php echo number_format($get_val['invoice_entry_product_detail_rate']);?></td>
											<?php 
											 $search_with_amt=searchValue('search_with_amt');
											if($search_with_amt=='search_with_amt'){?>
										...
										$product_id=$get_val['invoice_entry_product_detail_product_id'];
										$subqty=$subqty+$get_val['invoice_entry_product_detail_qty'];
										$sublength=$sublength+$get_val['invoice_entry_product_detail_tot_length'];
										$subinches=$subinches+$get_val['invoice_entry_product_detail_s_width_inches'];
										$submm = $submm+$get_val['invoice_entry_product_detail_s_width_mm'];
										$subft = $subft+$get_val['invoice_entry_product_detail_sl_feet'];
										$subftin = $subftin+$get_val['invoice_entry_product_detail_sl_feet_in'];
										$sublmm= $sublmm+$get_val['invoice_entry_product_detail_sl_feet_mm'];
										$submet = $submet+$get_val['invoice_entry_product_detail_sl_feet_met'];
										$subrate = $subrate+$get_val['invoice_entry_product_detail_rate'];
										$subtotal = $subtotal+$get_val['invoice_entry_product_detail_total'];
										$grandinches=$grandinches+$get_val['invoice_entry_product_detail_s_width_inches'];
										$grandmm = $grandmm+$get_val['invoice_entry_product_detail_s_width_mm'];
										$grandft = $grandft+$get_val['invoice_entry_product_detail_sl_feet'];
										$grandftin = $grandftin+$get_val['invoice_entry_product_detail_sl_feet_in'];
										$grandlmm= $grandlmm+$get_val['invoice_entry_product_detail_sl_feet_mm'];
										$grandmet = $grandmet+$get_val['invoice_entry_product_detail_sl_feet_met'];
										$grandrate = $grandrate+$get_val['invoice_entry_product_detail_rate'];
										$grandtotal = $grandtotal+$get_val['invoice_entry_product_detail_total'];
										$grandqty=$grandqty+$get_val['invoice_entry_product_detail_qty'];
										$grandlength=$grandlength+$get_val['invoice_entry_product_detail_tot_length'];
										}?>
										<tr>
											<td colspan="8" class="text-right"> Sub Total</td>
											<td style="text-align:right"><?php //echo number_format($subinches,3,'.','');?></td>
