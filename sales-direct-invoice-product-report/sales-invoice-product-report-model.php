<?php  
	...
	{
		$where = " WHERE invoice_entry_deleted_status =0 AND invoice_entry_direct_type =1 AND invoice_entry_financial_year = '".$_SESSION[SESS.'_session_financial_year']."' AND invoice_entry_company_id = '".$_SESSION[SESS.'_session_company_id']."'";
