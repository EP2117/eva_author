...
<table style="width:100%;font-size:11px;" cellspacing="0"  class="report-outer-table">
	...
	<tr>
		<td colspan="2" class="report-border-right " style='text-align:center;font-weight:bold;font-size:11px;width:60%' >  </td>
		<td class="report-border-right report-border-bottom" style='text-align:left;font-weight:bold;font-size:11px;width:25%' > Dis : &nbsp;&nbsp;&nbsp;&nbsp; <?=number_format($invoice_entry_edit['advance_entry_dis_per'],0,'.','')?> % </td>
		<td class="report-border-right report-border-bottom" style='text-align:right;font-weight:bold;font-size:11px;width:15%' > <?=number_format($invoice_entry_edit['advance_entry_dis_amount'],0,'.','')?> &nbsp;&nbsp;</td>
	</tr>
	<tr>
		<td colspan="2" class="report-border-right " style='text-align:center;font-weight:bold;font-size:11px;width:60%' >  </td>
