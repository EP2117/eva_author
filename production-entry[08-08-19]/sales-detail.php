...
?>
		...
		?>
					...
					<tr class="odd gradeX">
						...
						<input type="hidden" name="grn_entry_type" id="grn_entry_type<?php echo $record_grn_entry['grn_entry_id'];?>" value="<?=$arr_producton_type[$record_grn_entry['grn_entry_type_id']]?>" >
					...
					<input type="hidden" name="customer_name" id="customer_name<?php echo $record_grn_entry['grn_entry_id'];?>" value="<?=$record_grn_entry['customer_name']?>" >
						...
						<td><?=$arr_producton_type[$record_grn_entry['grn_entry_type_id']]?></td>
