	   ...
	   $select_invoice_entry_product_detail 		= "SELECT 
		...
		while($record_quotation_entry_product_detail = mysql_fetch_array($result_quotation_entry_product_detail)) {
		 ...
		 $select_invoice_entry_product_detail1 		= "SELECT 
															A.*,
															product_uom_name as p_colour_name,
															...
															product_colour_name as c_colour_name,
															brand_name
														FROM 
															invoice_entry_product_details A
														LEFT JOIN 
...
$invoice_entry_product_detail_id 			  	  = $_POST['invoice_entry_product_detail_id'];
		...
		if($invoice_entry_advance_amount>0){
		update_transaction($invoice_entry_id, $invoice_entry_no, $invoice_entry_date, 'advance_invoice', $acc_col_dr_id, $acc_cr_id, 'C', $acc_amount, $invoice_entry_remark, $invoice_entry_branch_id, $invoice_entry_advance_amount);	
		update_transaction($invoice_entry_id, $invoice_entry_no, $invoice_entry_date, 'advance_invoice', $acc_cr_id, $acc_col_dr_id, 'D', $acc_amount, $invoice_entry_remark, $invoice_entry_branch_id, $invoice_entry_advance_amount);			
		}
