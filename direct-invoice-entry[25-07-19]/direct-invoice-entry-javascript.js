...
function AddproductDetail(){
		...
		table.$('.check_prd_id:checkbox:checked').each(function(){ 
			...
			$("#product_detail_rws_display").append(apnd);
				...
				apnd	+= '<tr><td><input type="hidden"  name="invoice_entry_product_detail_mother_child_type[]" id="invoice_entry_product_detail_mother_child_type" value="'+product_mother_child_type+'" />'+product_name+'<input type="hidden"  name="invoice_entry_product_detail_product_id[]" id="invoice_entry_product_detail_product_id'+row_cnt+'" value="'+product_id+'" /><input type="hidden"  name="invoice_entry_product_detail_product_type[]" id="invoice_entry_product_detail_product_type"  value="'+product_type+'" /><input type="hidden"  name="invoice_entry_product_detail_entry_type[]" id="invoice_entry_product_detail_entry_type" value="1" /></td>';
...
function GetLcalFeet(calculation_id,id){
	...
	$.get(
		...
		{calculation_id:calculation_id,calc_amount:calc_amount,pr_id:pr_id},
