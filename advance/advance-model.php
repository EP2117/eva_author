<?php 
	...
	function listadvance(){
		...
		$query  = "SELECT empAdvanceId,ad_amount,employee_name,branch_name, DATE_FORMAT(ad_date ,'%d/%m/%Y') AS ad_date,ad_entry_type
				    FROM emp_advance
