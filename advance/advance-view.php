									...
									<div class="panel panel-info">
										...
										<div class="panel-body">
											...
											<div class="col-lg-6">
												...
												<div class="form-group">
												<label>Advance Entry Type</label>
												<select name="ad_entry_type" id="ad_entry_type" class="form-control">
												<option value="">-Select-</option>
												<?php echo $advance = empty($salarydeduct_edit['ad_entry_type'])?"":$salarydeduct_edit['ad_entry_type']; ?>
												<option value="1" <?php if($advance==1){?> selected="selected" <?php }?>>Advance</option>
												<option value="2" <?php if($advance==2){?> selected="selected" <?php }?>>Donation</option>
												<option value="3" <?php if($advance==3){?> selected="selected" <?php }?>>Fine</option>
												</select>
												</div>	
									...
									<table class="table table-striped table-bordered table-hover" id="dataTables-example">
										...
										?>
											<tr class="odd gradeX">
												...
												<td><?php if($result['ad_entry_type']==1){ echo  "Advance";} elseif($result['ad_entry_type']==2){echo "Donation";} elseif($result['ad_entry_type']==3){echo "Fine";}else{ echo "";} ?></td>                                      
												<td class="center">
