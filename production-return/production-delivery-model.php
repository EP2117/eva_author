	...
	function updateQuotation(){
		...
		// echo $pdo_entry_product_detail_qty[$i]; exit;
			...
			if($prn_entry_type_id==4){
							...
							$product_con_entry_godown_id						= 	$prn_entry_to_godown_id;
							//echo $product_detail_qty;exit;
							stockLedger(1, 'in',$prn_entry_id,$detail_id,$produt_id,$length_feet,$length_meter,$ton_qty,$kg_qty,$product_detail_qty, $prn_entry_branch_id,  $product_con_entry_godown_id, $prn_entry_date, $prn_entry_no,$stock_ledger_entry_type, '1',$width_inches,$width_mm,$product_colour_id,$product_thick);
							...
							$product_con_entry_godown_id						= 	$prn_entry_from_godown_id;
							stockLedger(1, 'out',$prn_entry_id,$detail_id,$produt_id,$length_feet,$length_meter,$ton_qty,$kg_qty,(-1*$product_detail_qty), $prn_entry_branch_id,  $product_con_entry_godown_id, $prn_entry_date, $prn_entry_no,$stock_ledger_entry_type, '1',$width_inches,$width_mm,$product_colour_id,$product_thick);
