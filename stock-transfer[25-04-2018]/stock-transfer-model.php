			...
			if($detail_request_fields) {
				...
				mysql_query($insert_stock_transfer_product_detail);
					...
					if($stock_transfer_type_id==1){
						...
						$rec_product									= 	getProductGetail($produt_id);
						$brand_id										= 	$rec_product['product_brand_id'];
						$product_type										= 	$rec_product['product_type'];
						$total_ton										=  	GetTotallenWei($brand_id,$product_thick,$width_inches,'');
					...
					stockLedger('out',$stock_transfer_id,$detail_id,$produt_id,$length_feet,$length_meter,$ton_qty,$kg_qty,$product_detail_qty, $stock_transfer_branch_id,  $stock_transfer_from_godown_id, $stock_transfer_date, $stock_transfer_no,$stock_ledger_entry_type, $prd_type,$width_inches,$width_mm,$product_colour_id,$product_thick);
					$product_detail_qty									= 	$stock_transfer_product_detail_qty[$i];
					stockLedger('in',$stock_transfer_id,$detail_id,$produt_id,$length_feet,$length_meter,$ton_qty,$kg_qty,$product_detail_qty, $stock_transfer_branch_id,  $stock_transfer_to_godown_id, $stock_transfer_date, $stock_transfer_no,$stock_ledger_entry_type, $prd_type,$width_inches,$width_mm,$product_colour_id,$product_thick);
	...
	function listQuotation(){
		...
		$select_stock_transfer		=	"SELECT 
											 ...
											 WHERE 
												...
												stock_transfer_deleted_status 	= 	0									
...

	{
		...
		$stock_transfer_id 	= getId('stock_transfer', 'stock_transfer_id', 'stock_transfer_uniq_id', dataValidation($_GET['id'])); 
		 ...
		 $select_stock_transfer_product_detail 	= "	SELECT 
														...
														stock_transfer_product_detail_weight_tone,
