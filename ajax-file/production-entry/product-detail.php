...
?>
			...
			<tr class="odd gradeX">
				<td>
				<input type="checkbox" name="grn_entry_product_detail_id[]" id="grn_entry_product_detail_id<?php echo $record_so_detail['grn_entry_product_detail_id'];?>" value="<?php echo $record_so_detail['grn_entry_product_detail_id']; ?>" />
