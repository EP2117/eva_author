...
function GetWDetail(){
	...
	var apnd  = '<tr>';
		...
		apnd += '<td><input type="text" class="form-control" style="text-align:right;" name="production_entry_work_detail_from_date[]" id="production_entry_work_detail_from_date'+sno+'"></td>';
		apnd += '<td><input type="text" class="form-control" style="text-align:right;" name="production_entry_work_detail_to_date[]" id="production_entry_work_detail_to_date'+sno+'"></td>';
										...
										<div class="form-group">
											...
											<label class="control-label">Date</label>
											 ...
											 <div class="input-group date">
											  ...
											  <input type="text" class="form-control" name="production_entry_date" id="production_entry_date" required>
...
<input type="hidden"  name="production_entry_product_detail_product_type[]" id="production_entry_product_detail_product_type<?=$row_cnt?>" value="<?=$get_product_detail['production_entry_product_detail_product_type']?>" />
											...
											<input class="form-control" type="text"  name="production_entry_product_detail_product_thick[]" id="production_entry_product_detail_product_thick<?=$row_cnt?>" value="<?=$get_product_detail['production_entry_product_detail_product_thick']?>"   />
                                ...
                                <table class="table table-striped table-bordered table-hover" id="raw_product_detail"  style=" width:100%" >
                                    ...
                                    <tbody id="raw_product_detail_display">
										...
										<tr >
											...
											<input class="form-control" type="text"  name="production_entry_raw_product_detail_product_thick[]" id="production_entry_raw_product_detail_product_thick<?=$row_cnt?>" value="<?=$get_product_detail['production_entry_raw_product_detail_product_thick']?>"   />
