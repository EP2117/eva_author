...
?>
			...
			<tr class="odd gradeX">
				...
				<input type="hidden" name="product_colour_id" id="raw_product_colour_id<?php echo $record_so_detail['grn_entry_raw_product_detail_id'];?>" value="<?php echo $record_so_detail['grn_entry_raw_product_detail_product_colour_id']; ?>" >
				...
				<input type="hidden" name="product_thick_ness" id="raw_product_thick_ness<?php echo $record_so_detail['grn_entry_raw_product_detail_id'];?>" value="<?php echo $arr_thick[$record_so_detail['grn_entry_raw_product_detail_product_thick']]; ?>" >
				<input type="hidden" name="product_thick_ness_id" id="product_thick_ness_id<?php echo $record_so_detail['grn_entry_raw_product_detail_id'];?>" value="<?php echo $record_so_detail['grn_entry_raw_product_detail_product_thick']; ?>" >
				<input type="hidden" name="product_id" id="raw_product_id<?php echo $record_so_detail['grn_entry_raw_product_detail_id'];?>" value="<?php echo $record_so_detail['grn_entry_raw_product_detail_product_id']; ?>" >
