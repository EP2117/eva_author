   		 ...
   		 $select_product 			= "	SELECT  
										...
										ON 
											...
											(SELECT 
												...
												SUM(credit_note_entry_product_detail_qty+credit_note_entry_product_detail_s_weight_inches) AS inv_qty 
											FROM 
												credit_note_entry_product_details  	
											WHERE 
												credit_note_entry_product_detail_deleted_status 				= 0  					
											GROUP BY 
												credit_note_entry_product_detail_invoice_detail_id) inv_table 
										ON 
											 	credit_note_entry_product_detail_invoice_detail_id 	= invoice_entry_product_detail_id		
...
<?php
		...
		while ($record_so_detail = mysql_fetch_array($result_product)){
			  $balance_qty = $record_so_detail['invoice_entry_product_detail_qty'] - $record_so_detail['received_qty'];
					...
					$product_type_id		= $record_so_detail['invoice_entry_product_detail_entry_type'];
...
?>
			...
			<tr class="odd gradeX">
				...
				<input type="hidden" name="product_color_id" id="product_color_id<?php echo $record_so_detail['invoice_entry_product_detail_id'];?>" value="<?php echo $product_color_id; ?>" >
				...
				<input type="hidden" name="product_mother_child_type" id="product_mother_child_type<?php echo $record_so_detail['invoice_entry_product_detail_id'];?>" value="<?php echo $record_so_detail['invoice_entry_product_detail_mother_child_type ']; ?>" />
				...
				<input type="hidden" name="product_type_id" id="product_type_id<?php echo $record_so_detail['invoice_entry_product_detail_id'];?>" value="<?php echo $product_type_id; ?>" />
				<input type="hidden" name="product_type" id="product_type<?php echo $record_so_detail['invoice_entry_product_detail_id'];?>" value="<?php echo $record_so_detail['invoice_entry_product_detail_product_type']; ?>" />
				...
				?>
				<input type="hidden" name="product_opp_feet_per_qty" id="product_opp_feet_per_qty<?php echo $record_so_detail['invoice_entry_product_detail_id'];?>" value="<?php echo $feet_per_qty; ?>" >
				<?php
					} else {
				?>
				<input type="hidden" name="product_opp_feet_per_qty" id="product_opp_feet_per_qty<?php echo $record_so_detail['invoice_entry_product_detail_id'];?>" value="0" >
				<?php
					}
				?>
