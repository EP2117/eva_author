...
function AddproductDetail(){
	...
	for (var i = 0; i < x.length; i++) {
		if (x[i].checked ==true) {
			...
			var product_s_weight_met			= document.getElementById('product_s_weight_met'+ord_id).value;
			...
			apnd	+= '<td><input class="form-control" type="text" onblur="get_stock('+row_cnt+')"  name="production_order_product_detail_qty[]" id="production_order_product_detail_qty'+row_cnt+'" value="'+product_qty+'"  /></td></tr>';
