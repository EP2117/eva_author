...
?>
			...
			<tr class="odd gradeX">
				...
				<input type="hidden" name="product_type" id="product_type<?php echo $record_so_detail['product_id'];?>2" value="1" >
				...
				<input type="hidden" name="product_t_id" id="product_t_id<?php echo $record_so_detail['product_id'];?>2" value="<?php echo $t_id; ?>" >
