        ...
        <div id="page-wrapper">
            ...
            <div id="page-inner">
				...
				if(isset($_GET['print_status']) && $_GET['print_status']==1)
				{
				 ?>
				 <script>
				 window.open("quotation-entry-print.php?id=<?=$_GET['quotation_id']?>","_blank");
				 </script>
				<?php }?>
							...
							<input type="checkbox" name="quotation_entry_type_id[]"  id="quotation_entry_type_id<?=$key?>" value="<?=$key?>" onClick="getTableHeader(this.value)" /> <?=$value?><br/>
									...
									<div class="col-lg-6">
										...
										<div class="form-group">
											...
											<label class="control-label">Date</label>
											 ...
											 <div class="input-group date">
											  ...
											  <input type="text" class="form-control" name="quotation_entry_date" id="quotation_entry_date" value="<?=date('d/m/Y')?>" required>
										...
										<div class="form-group">
											...
											<select name="quotation_entry_brand_id" id="quotation_entry_brand_id" class="form-control select2" style="width:100%" required>
							...
							<div class="panel-body">
							 	...
							 	<div class="table-responsive">
									...
									<table class="table table-striped table-bordered table-hover" id="product_detail_rws"  style="width:100%;display:none">
										<thead>
											<tr>
												<td colspan="17"><button type="button" onClick="GetDetail('2');" data-toggle="modal" data-target="#myModal" data-id="1" class="glyphicon glyphicon-plus"></button></td>
											</tr>
											 <tr>
												<th rowspan="2" style="vertical-align:middle;"> BRAND</th>
												<th rowspan="2" style="vertical-align:middle;"> NAME</th>
									...
									<table class="table table-striped table-bordered table-hover" style=" width:100%" >
										...
										<tr>
											...
											<td style="width:20%"><input type="text" class="form-control" name="quotation_entry_gross_amount" id="quotation_entry_gross_amount"  value="0"></td>
										...
										<tr>
											...
											<td><input type="text" class="form-control" name="quotation_entry_transport_amount" id="quotation_entry_transport_amount" value="0" onBlur="totalAmount()" ></td>
										...
										<td><input type="text" class="form-control" name="quotation_entry_dis_amount" id="quotation_entry_dis_amount" value="0" ></td>
										...
										<tr>
											...
											<td><input type="text" class="form-control" name="quotation_entry_tax_amount" id="quotation_entry_tax_amount"  value="0"></td>
										...
										<tr>
											...
											<td><input type="text" class="form-control" name="quotation_entry_advance_amount" id="quotation_entry_advance_amount" onBlur="totalAmount()"  value="0"></td>
										...
										<tr>
											...
											<td><input type="text" class="form-control" name="quotation_entry_net_amount" id="quotation_entry_net_amount"  value="0" ></td>
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="panel panel-info">
							...
							<tr>
								<td><input type="hidden"  name="quotation_entry_product_mother_child_type[]" id="quotation_entry_product_mother_child_type<?=$row_cnt; ?>" value="<?=$get_product_detail['quotation_entry_product_mother_child_type']?>" /><?=$product_brand_name?></td><td><?=$product_name?><input type="hidden"  name="quotation_entry_product_detail_product_id[]" id="quotation_entry_product_detail_product_id<?=$row_cnt; ?>" value="<?=$get_product_detail['quotation_entry_product_detail_product_id']?>" />
								...
								<td><input class="form-control" type="text"  name="quotation_entry_product_detail_sl_feet_in[]" id="quotation_entry_product_detail_sl_feet_in<?=$row_cnt; ?>" onblur="GetLcalFeet(1,<?=$row_cnt; ?>);GetTotalLength(<?=$row_cnt; ?>);" value="<?=$get_product_detail['quotation_entry_product_detail_sl_feet_in']?>"  /></td>
								...
								<td><input class="form-control" type="text"  name="quotation_entry_product_detail_qty[]" id="quotation_entry_product_detail_qty<?=$row_cnt; ?>" onBlur="GetTotalLength(<?=$row_cnt; ?>);GetTotalLength(<?=$row_cnt; ?>);discountPerFind(<?=$row_cnt; ?>);"  value="<?=round($get_product_detail['quotation_entry_product_detail_qty'])?>"  /></td> 
								<td><input class="form-control" type="text"  name="quotation_entry_product_detail_tot_length[]" id="quotation_entry_product_detail_tot_length<?=$row_cnt; ?>" readonly value="<?=round($get_product_detail['quotation_entry_product_detail_tot_length'])?>"  />
								 <input  type="hidden"  name="quotation_entry_product_detail_inv_tot_length[]" id="quotation_entry_product_detail_inv_tot_length<?=$row_cnt; ?>"   value="<?=round($get_product_detail['quotation_entry_product_detail_inv_tot_length'])?>" /></td>
								 <td><input class="form-control" type="text"  name="quotation_entry_product_detail_rate[]" id="quotation_entry_product_detail_rate<?=$row_cnt; ?>"   onBlur="discountPerFind(<?=$row_cnt; ?>)" value="<?=round($get_product_detail['quotation_entry_product_detail_rate'])?>" /></td>
					
								 <td><input class="form-control" type="text"  name="quotation_entry_product_detail_total[]" id="quotation_entry_product_detail_total<?=$row_cnt; ?>"   value="<?=round($get_product_detail['quotation_entry_product_detail_total'])?>" /></td>
							...
							<tr>
								<td><input type="hidden"  name="quotation_entry_product_mother_child_type[]" id="quotation_entry_product_mother_child_type<?=$row_cnt; ?>" value="<?=$get_product_detail['quotation_entry_product_mother_child_type']?>" /><?=$product_brand_name?></td><td><?=$product_name?><input type="hidden"  name="quotation_entry_product_detail_product_id[]" id="quotation_entry_product_detail_product_id" value="<?=$get_product_detail['quotation_entry_product_detail_product_id']?>" />
								...
								<input type="hidden"  name="quotation_entry_product_detail_qty[]" id="quotation_entry_product_detail_qty<?=$row_cnt; ?>" value="<?=round($get_product_detail['quotation_entry_product_detail_qty'])?>" /></td>
								<td><input class="form-control" type="text"  name="quotation_entry_product_detail_s_weight_met[]" id="quotation_entry_product_detail_s_weight_met<?=$row_cnt; ?>" onBlur="RawdiscountPerFind(<?=$row_cnt; ?>)" value="<?=round($get_product_detail['quotation_entry_product_detail_s_weight_met'])?>" /></td>
								<td><input class="form-control" type="text"  name="quotation_entry_product_detail_rate[]" id="quotation_entry_product_detail_rate<?=$row_cnt; ?>" onBlur="RawdiscountPerFind(<?=$row_cnt; ?>)" value="<?=round($get_product_detail['quotation_entry_product_detail_rate'])?>" /></td>
								<td><input class="form-control" type="text"  name="quotation_entry_product_detail_total[]" id="quotation_entry_product_detail_total<?=$row_cnt; ?>"  value="<?=round($get_product_detail['quotation_entry_product_detail_total'])?>"/><input class="form-control" type="hidden"  name="quotation_entry_product_detail_sl_feet_mm[]" id="quotation_entry_product_detail_sl_feet_mm<?=$row_cnt; ?>" value="<?=round($get_product_detail['quotation_entry_product_detail_sl_feet_mm'])?>" /><input class="form-control" type="hidden"  name="quotation_entry_product_detail_sl_feet_met[]" id="quotation_entry_product_detail_sl_feet_met<?=$row_cnt; ?>"value="<?=round($get_product_detail['quotation_entry_product_detail_sl_feet_met'])?>"  /> <input class="form-control" type="hidden"  name="quotation_entry_product_detail_sl_feet[]" id="quotation_entry_product_detail_sl_feet<?=$row_cnt; ?>" value="<?=round($get_product_detail['quotation_entry_product_detail_sl_feet'])?>" /> <input class="form-control" type="hidden"  name="quotation_entry_product_detail_sl_feet_in[]" id="quotation_entry_product_detail_sl_feet_in<?=$row_cnt; ?>" value="<?=round($get_product_detail['quotation_entry_product_detail_sl_feet_in'])?>"/></td>
                              <!--  
								<td><?php if($arr_cnt>1) { ?><a href="index.php?product_detail_id=<?=$get_product_detail['quotation_entry_product_detail_id']?>&quotation_entry_uniq_id=<?php echo $quotation_entry_edit['quotation_entry_uniq_id']?>&product_detail_delete=" title="" class="glyphicon glyphicon-trash " style="color:red"></a><?php } ?></td>	-->
							...
							<tr>
								<td><input type="hidden"  name="quotation_entry_product_mother_child_type[]" id="quotation_entry_product_mother_child_type<?=$row_cnt; ?>" value="<?=$get_product_detail['quotation_entry_product_mother_child_type']?>" /><?=$product_name?><input type="hidden"  name="quotation_entry_product_detail_product_id[]" id="quotation_entry_product_detail_product_id<?=$row_cnt; ?>" value="<?=$get_product_detail['quotation_entry_product_detail_product_id']?>" />
								<input type="hidden"  name="quotation_entry_product_detail_product_type[]" id="quotation_entry_product_detail_product_type<?=$row_cnt; ?>" value="<?=$get_product_detail['quotation_entry_product_detail_product_type']?>" />
								<input type="hidden"  name="quotation_entry_product_detail_entry_type[]" id="quotation_entry_product_detail_entry_type<?=$row_cnt; ?>" value="<?=$get_product_detail['quotation_entry_product_detail_entry_type']?>" />
								<input type="hidden"  name="quotation_entry_product_detail_id[]" id="quotation_entry_product_detail_id<?=$row_cnt; ?>" value="<?=$get_product_detail['quotation_entry_product_detail_id']?>" /></td>
								...
								<td><input class="form-control" type="text"  name="quotation_entry_product_detail_qty[]" id="quotation_entry_product_detail_qty<?=$row_cnt; ?>"  onBlur="AccdiscountPerFind(<?=$row_cnt; ?>)"  value="<?=round($get_product_detail['quotation_entry_product_detail_qty'])?>"/></td>
								<td><input class="form-control" type="text"  name="quotation_entry_product_detail_rate[]" id="quotation_entry_product_detail_rate<?=$row_cnt; ?>" onBlur="AccdiscountPerFind(<?=$row_cnt; ?>)"   value="<?=round($get_product_detail['quotation_entry_product_detail_rate'])?>"/></td>
								<td><input class="form-control" type="text"  name="quotation_entry_product_detail_total[]" id="quotation_entry_product_detail_total<?=$row_cnt; ?>"   value="<?=round($get_product_detail['quotation_entry_product_detail_total']);?>"/></td>
								<td><?php if($arr_cnt>1) { ?><a href="index.php?product_detail_id=<?=$get_product_detail['quotation_entry_product_detail_id']?>&quotation_entry_uniq_id=<?php echo $quotation_entry_edit['quotation_entry_uniq_id']?>&product_detail_delete=" title="" class="glyphicon glyphicon-trash " style="color:red"></a><?php } ?></td>	
								...
								<table class="table table-striped table-bordered table-hover" style=" width:100%" >
									...
									<tr>
										...
										<td style="width:20%"><input type="text" class="form-control" name="quotation_entry_gross_amount" id="quotation_entry_gross_amount" value="<?=round($quotation_entry_edit['quotation_entry_gross_amount'])?>" ></td>
									...
									<tr>
										...
										<td><input type="text" class="form-control" name="quotation_entry_transport_amount" id="quotation_entry_transport_amount" onBlur="totalAmount()"  value="<?=round($quotation_entry_edit['quotation_entry_transport_amount'])?>"/></td>
									...
									<tr>
										...
										<td><input type="text" class="form-control" name="quotation_entry_dis_amount" id="quotation_entry_dis_amount" value="<?=round($quotation_entry_edit['quotation_entry_dis_amount'])?>" ></td>
									...
									<tr>
										...
										<td><input type="text" class="form-control" name="quotation_entry_tax_amount" id="quotation_entry_tax_amount" value="<?=round($quotation_entry_edit['quotation_entry_tax_amount'])?>" /></td>
									...
									<tr>
										...
										<td><input type="text" class="form-control" name="quotation_entry_advance_amount" id="quotation_entry_advance_amount" onBlur="totalAmount()"  value="<?=round($quotation_entry_edit['quotation_entry_advance_amount'])?>"/></td>
									...
									<tr>
										...
										<td><input type="text" class="form-control" name="quotation_entry_net_amount" id="quotation_entry_net_amount"   value="<?=round($quotation_entry_edit['quotation_entry_net_amount'])?>"/></td>
							...
							<?php if(isset($_REQUEST['search'])){?>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<?php
										...
										$edit_status =editStatus('invoice_entry_product_details','invoice_entry_product_detail_quotation_detail_id',$get_quotation['quotation_entry_id'],'invoice_entry_product_detail_deleted_status');
									...
									?>
                                        ...
                                        <tr class="odd gradeX">
											...
											<td><a href="quotation-entry-print.php?id=<?php echo $get_quotation['quotation_entry_uniq_id']?>" title="QUOTATION PRINT" class="glyphicon glyphicon-print pull-left" target="_blank" style="color:blue"></a></td>
                                            <td class="center">
                                        ...
                                        <div class="modal-body">
											...
											<div class="table-responsive">
												...
												<div id="dynamic-content">
													...
													<?php /*?><form method="get" name="product_list_form" id="product_list_form"  >
														<table class="table datatable table-bordered" id="product_detail_popup">
															...
															<tbody >
															<?php
																foreach($product_list as  $record_so_detail){
															?>
															<tr class="odd gradeX">
