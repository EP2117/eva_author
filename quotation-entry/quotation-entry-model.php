...
//echo $quotation_entry_no;
	...
	//echo $select_branch;
		...
		$quotation_entry_no                   				= 'Q'.$res['branch_prefix'].GetAutoNo($_POST['quotation_entry_branch_id']); //echo $res['branch_prefix'];exit;
...
$quotation_entry_product_mother_child_type		  = $_POST['quotation_entry_product_mother_child_type'];
			...
			if($detail_request_fields) {
				...
				$insert_quotation_entry_product_detail 		= sprintf("INSERT INTO quotation_entry_product_details 
																	...
																	VALUES     ('%s', '%d', 
																		 ...
																		 $quotation_entry_product_detail_s_weight_met[$i],$quotation_entry_product_mother_child_type[$i]);
...

	{
	  ...
	  $select_quotation_entry_product_detail 		= "SELECT 
			...
			//echo $select_quotation_entry_product_detail;exit;
		...
		while($record_quotation_entry_product_detail = mysql_fetch_array($result_quotation_entry_product_detail)) {
		 ...
		 $select_quotation_entry_product_detail1 		= "SELECT 
														...
														WHERE 
															...
															AND quotation_entry_product_detail_quotation_entry_id 		= '".$quotation_entry_id."'";
		//echo $select_quotation_entry_product_detail1;exit;
					...
					$quotation_entry_product_detail_uniq_id 	= generateUniqId();
					 ...
					 $insert_quotation_entry_product_detail 		= sprintf("INSERT INTO quotation_entry_product_details 
																				(quotation_entry_product_detail_uniq_id,quotation_entry_product_detail_quotation_entry_id,
																				 ...
																				 quotation_entry_product_detail_s_weight_met,quotation_entry_product_mother_child_type) 
																	VALUES     ('%s', '%d', 
																				'%d', '%d',
																				'%d', '%d',
																				'%d', '%d', 
