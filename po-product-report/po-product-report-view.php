...
<head>
    ...
    <title>Purchase Order Report (Product Wise)</title>
<?php 
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Purchase Order Report (Product Wise)</h1>
								...
								<table class="table table-striped table-bordered table-hover" id="product_detail_rls" >
                                    <thead  >
										 ...
										 <th rowspan="2" class="text-center" style="vertical-align:middle;">#</th>
											...
											<th rowspan="2" style="vertical-align:middle;" nowrap="nowrap" class="text-center"> PO No.</th>
                                    ...
                                    <tbody >
										...
										foreach($invoice_list as $get_val){
											...
											//Added by AuthorsMM
											$ton_total = $ton_total + $get_val['pRp_ton'];
											$kg_total  = $kg_total + $get_val['pRp_kg'];
											$qty_total = $qty_total + $get_val['pRp_qty'];
											$currency_total = $currency_total + $get_val['pRp_rate_by_currency'];
											$mmk_total = $mmk_total + $get_val['pRp_unitprice'];
										?>
										<tr>
										<td class="text-right"><?php echo $sno++;?></td>	
											<td><?php echo $get_val['purchase_no'];?></td>
											<td><?php echo $get_val['pR_purchase_date'];?></td>
											<td><?php echo $get_val['supplier_name'];?></td>
											<td><?php echo $get_val['product_code'];?></td>
											<!-- <td><?php echo $get_val['product_name'];?></td> -->
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['pRp_ton']);?></td>
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['pRp_kg']);?></td>
											<td class="text-right"><?php echo $get_val['pRp_qty'];?></td>
											<td class="text-right"><?php echo number_format($get_val['pRp_rate']);?></td>
											<td class="text-right"><?php echo number_format($get_val['pRp_rate_by_currency']);?></td>
											<td class="text-right"><?php echo number_format($get_val['pRp_unitprice']);?></td>
										</tr>
										<?php 
										}?>
										...
										<tr>
											...
											<td class="text-right"><?php echo $qty_total; ?></td>
											<td></td>
