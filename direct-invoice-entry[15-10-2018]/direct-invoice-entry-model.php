...
$invoice_entry_product_detail_id 			  	  = $_POST['invoice_entry_product_detail_id'];
		...
		update_transaction($invoice_entry_id, $invoice_entry_no, $invoice_entry_date, 'Invoice', $acc_dr_id, $acc_cr_id, 'D', $invoice_entry_net_amount, $invoice_entry_remarks, $invoice_entry_branch_id,$acc_amount);	
		update_transaction($invoice_entry_id, $invoice_entry_no, $invoice_entry_date, 'Invoice', $acc_cr_id, $acc_dr_id, 'C', $invoice_entry_net_amount, $invoice_entry_remarks, $invoice_entry_branch_id,$acc_amount);			
