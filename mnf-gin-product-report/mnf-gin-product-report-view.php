...
<head>
    ...
    <title> Good Issue Note Report (Product Wise)</title>
<?php 
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line"> Good Issue Note Report (Product Wise)</h1>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           Good Issue Note Report (Product Wise)
                        </div>
								...
								<table class="table table-striped table-bordered table-hover" id="product_detail_rls" >
                                    ...
                                    <tbody >
										...
										<td><?php echo $sno++;?></td>	
											...
											<td><?php echo $arr_thick[$get_val['gin_entry_product_detail_product_thick']];?></td>
											<td><?php echo $get_val['gin_entry_product_detail_s_width_inches'];?></td>
											<td><?php echo $get_val['gin_entry_product_detail_s_width_mm'];?></td>
											<td><?php echo $get_val['gin_entry_product_detail_sl_feet'];?></td>
											<td><?php echo $get_val['gin_entry_product_detail_sl_feet_mm'];?></td>
											<td><?php echo $get_val['gin_entry_product_detail_qty'];?></td>
										</tr>
										<?php 
										...
										<td><?php echo $sno++;?></td>	
											...
											<td><?php echo $get_val['gin_entry_product_detail_s_width_inches'];?></td>
											<td><?php echo $get_val['gin_entry_product_detail_s_width_mm'];?></td>
											<td><?php echo number_format($get_val['gin_entry_product_detail_s_weight_inches'],2,'.','');?></td>
											<td><?php echo $get_val['gin_entry_product_detail_s_weight_mm'];?></td>
											<td><?php echo $get_val['gin_entry_product_detail_qty'];?></td>
										</tr>
										<?php 
