...
if($invoice_entry_prd_edit){?>
 ...
 ?>	
			...
			<tr>
				...
				<td class="report-border-right report-border-bottom" style='text-align:center;font-weight:bold;font-size:11px;width:20%;' > LENGTH </td>
 ...
 <?php }?>
			<tr>
				...
				<?php
					if($getDetail['delivery_customer_product_detail_sale_by']=="FEET") {
				?>
					<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					<?=round($getDetail['delivery_customer_product_detail_sale_feet'])."'"?> </td>
					<td class="report-border-right report-border-bottom"></td>
				<?php
					}
					else {
				?>
