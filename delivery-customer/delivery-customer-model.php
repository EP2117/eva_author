...
$delivery_customer_product_detail_s_weight_inches   			= isset($_POST['delivery_customer_product_detail_s_weight_inches'])?$_POST['delivery_customer_product_detail_s_weight_inches']:'';
		...
		$delivery_customer_product_is_opp					= isset($_POST['delivery_customer_product_is_opp'])?$_POST['delivery_customer_product_is_opp']:'0';
		$delivery_customer_product_detail_sale_by			= isset($_POST['delivery_customer_product_detail_sale_by'])?$_POST['delivery_customer_product_detail_sale_by']:'';
		$delivery_customer_product_opp_feet_per_qty		= isset($_POST['delivery_customer_product_opp_feet_per_qty'])?$_POST['delivery_customer_product_opp_feet_per_qty']:'0';
		...
		for($i = 0; $i < count($delivery_customer_product_detail_product_id); $i++) { 
			...
			if($delivery_customer_product_detail_sale_by[$i] == "QTY") {
				$delivery_customer_product_detail_qty_val 	= $delivery_customer_product_detail_qty[$i];
				$delivery_customer_product_detail_sale_feet = $delivery_customer_product_detail_qty[$i] * $delivery_customer_product_opp_feet_per_qty[$i];
			}else if($delivery_customer_product_detail_sale_by[$i] == "FEET"){
				$delivery_customer_product_detail_qty_val = $delivery_customer_product_detail_qty[$i]/$delivery_customer_product_opp_feet_per_qty[$i];	
				$delivery_customer_product_detail_sale_feet = $delivery_customer_product_detail_qty[$i];
			}else{
				$delivery_customer_product_detail_qty_val 	= $delivery_customer_product_detail_qty[$i];
			...
			if($detail_request_fields) {
				...
				$insert_delivery_customer_product_detail 		= sprintf("INSERT INTO delivery_customer_product_details 
																	...
																	VALUES     ('%s', '%d', 
																		 ...
																		 $delivery_customer_product_detail_qty_val,
																		 ...
																		 $delivery_customer_product_detail_sale_by[$i],
																		 $delivery_customer_product_detail_sale_feet,
				...
				if($delivery_customer_product_detail_entry_type[$i]==4){
							...
							$product_detail_qty									= 	(-1*$delivery_customer_product_detail_qty_val);
							
							$sale_feet 											=   (-1*$delivery_customer_product_detail_sale_feet);
							...
							else if($delivery_customer_product_detail_entry_type[$i] == 2) {
								$prd_type = 2;
							}
							else if($delivery_customer_product_detail_entry_type[$i] == 4) {
								$prd_type = 1;
							} else {
								$prd_type = 1;
							}
							if($delivery_customer_branch_id ==4){
								...
								if($delivery_customer_product_is_opp[$i] == 1) {
									stockLedger_opp($delivery_customer_product_opp_feet_per_qty[$i],$child_type,'out',$delivery_customer_id,$detail_id,$produt_id,$length_feet,$length_meter,$ton_qty,$kg_qty,$product_detail_qty, $delivery_customer_branch_id,  $product_con_entry_godown_id, $delivery_customer_date, $delivery_customer_no,$stock_ledger_entry_type, $prd_type,$width_inches,$width_mm,$product_colour_id,$product_thick,$sale_feet);
...

	{
		...
		$count_delivery_customer 					= mysql_num_rows($result_delivery_customer_product_detail) or die(mysql_error());
		...
		$select_delivery_customer_product_detail1 	= "	SELECT 
															...
															delivery_customer_product_detail_entry_type, product_is_opp,
															delivery_customer_product_detail_sale_by, delivery_customer_product_detail_sale_feet,
															delivery_customer_product_detail_color_id
				...
				if(isset($delivery_customer_product_detail_id[$i]) && (!empty($delivery_customer_product_detail_id[$i]))) {
					 $update_delivery_customer_product_detail = sprintf("UPDATE 
																		...
																		SET  
																			...
																			delivery_customer_product_detail_sale_by 				= '%s',
																			delivery_customer_product_detail_sale_feet 				= '%f'
																		WHERE 
