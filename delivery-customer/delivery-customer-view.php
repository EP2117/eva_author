								 ...
								 <table class="table table-striped table-bordered table-hover" id="product_detail_rls"  style="width:100%;display:none" ><!--display:none-->
									...
									<?php 
										...
										<tr>	
											...
											<input type="hidden"  name="delivery_customer_product_is_opp[]" id="delivery_customer_product_is_opp" value="0" />
											<input type="hidden"  name="delivery_customer_product_opp_feet_per_qty[]" id="delivery_customer_product_opp_feet_per_qty" value="0" />
											<input type="hidden"  name="delivery_customer_product_detail_sale_by[]" id="delivery_customer_product_detail_sale_by" value="" />
...
<input type="hidden"  name="delivery_customer_product_detail_mother_child_type[]" id="delivery_customer_product_detail_mother_child_type" value="<?=$get_product_detail['delivery_customer_product_detail_mother_child_type']?>" />
<input type="hidden"  name="delivery_customer_product_detail_entry_type[]" id="delivery_customer_product_detail_entry_type<?=$row_cnt?>" value="<?=$get_product_detail['delivery_customer_product_detail_entry_type']?>" />
											...
											<input type="hidden"  name="delivery_customer_product_detail_product_brand_id[]" id="delivery_customer_product_detail_product_brand_id<?=$row_cnt?>" value="<?=$get_product_detail['product_brand_id']?>" />
											</td>
											<td>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="product_detail_rws"  style="width:100%;display:none" ><!--display:none-->
									...
									<?php 							
										...
										<tr>	
                                            ...
                                            <input type="hidden"  name="delivery_customer_product_detail_mother_child_type[]" id="delivery_customer_product_detail_mother_child_type" value="<?=$get_product_detail['delivery_customer_product_detail_mother_child_type']?>" /></td>
											 ...
											 <input type="hidden"  name="delivery_customer_product_detail_entry_type[]" id="delivery_customer_product_detail_entry_type" value="<?=$get_product_detail['delivery_customer_product_detail_entry_type']?>" /></td>
												...
												<td><input class="form-control" type="text"  name="delivery_customer_product_detail_s_weight_mm[]" id="delivery_customer_product_detail_s_weight_mm<?=$row_cnt?>"  onblur="GetWeightClc(2,<?=$row_cnt?>)"  value="<?=$get_product_detail['delivery_customer_product_detail_s_weight_mm']?>"   />
												<input class="form-control" type="hidden"  name="delivery_customer_product_detail_sl_feet_mm[]" id="delivery_customer_product_detail_sl_feet_mm<?=$row_cnt?>"   value="<?=$get_product_detail['delivery_customer_product_detail_sl_feet_mm']?>"  /><input class="form-control" type="hidden"  name="delivery_customer_product_detail_sl_feet_met[]" id="delivery_customer_product_detail_sl_feet_met<?=$row_cnt?>" value="<?=$get_product_detail['delivery_customer_product_detail_sl_feet_met']?>"  /> <input class="form-control" type="hidden"  name="delivery_customer_product_detail_sl_feet[]" id="delivery_customer_product_detail_sl_feet<?=$row_cnt?>"  value="<?=$get_product_detail['delivery_customer_product_detail_sl_feet']?>" /> <input class="form-control" type="hidden"  name="delivery_customer_product_detail_sl_feet_in[]" id="delivery_customer_product_detail_sl_feet_in<?=$row_cnt?>" value="<?=$get_product_detail['delivery_customer_product_detail_sl_feet_in']?>" /></td>
																					<td><?php if($arr_cnt>1) { ?><a href="index.php?product_detail_id=<?=$get_product_detail['delivery_customer_product_detail_id']?>&delivery_customer_uniq_id=<?php echo $delivery_customer_edit['delivery_customer_uniq_id']?>&product_detail_delete=" title="" class="glyphicon glyphicon-trash " style="color:red"></a><?php } ?></td>
											</tr>
											...
											<td>
												<?php
													if($get_product_detail['product_is_opp'] == 1) {
														$result_opp = mysql_query("Select stock_ledger_product_feet_per_quantity From stock_ledger Where stock_ledger_type = 'in' AND stock_ledger_product_id = ".$get_product_detail['delivery_customer_product_detail_product_id']." LIMIT 1");
														$opp_arr = mysql_fetch_assoc($result_opp);
														$feet_per_qty = $opp_arr['stock_ledger_product_feet_per_quantity'];
												?>
												<input type="hidden" name="delivery_customer_product_opp_feet_per_qty[]" id="delivery_customer_product_opp_feet_per_qty<?=$row_cnt?>" value="<?php echo $feet_per_qty; ?>" >
												<input type="hidden" name="delivery_customer_product_is_opp[]" id="delivery_customer_product_is_opp<?=$row_cnt?>" value="1" >
												<?php
													} else {
												?>
												<input type="hidden" name="delivery_customer_product_opp_feet_per_qty[]" id="delivery_customer_product_opp_feet_per_qty<?=$row_cnt?>" value="0" >
												<input type="hidden" name="delivery_customer_product_is_opp[]" id="delivery_customer_product_is_opp<?=$row_cnt?>" value="0" >
												<?php
													}
												?>
												
												<?php
													if($get_product_detail['delivery_customer_product_detail_sale_by'] == "FEET") {
												?>
													<input class="form-control" type="text" style="width:20%;display:inline-block;" name="delivery_customer_product_detail_sale_by[]" id="delivery_customer_product_detail_sale_by<?=$row_cnt?>" value="FEET" readonly />&nbsp;&nbsp;&nbsp;
													<input class="form-control" type="text" style="width:60%;display:inline-block;" name="delivery_customer_product_detail_qty[]" id="delivery_customer_product_detail_qty<?=$row_cnt?>" value="<?=$get_product_detail['delivery_customer_product_detail_sale_feet']?>" />
												<?php
													}
													else {
												?>
													<input class="form-control" type="text" style="width:20%;display:inline-block;" name="delivery_customer_product_detail_sale_by[]" id="delivery_customer_product_detail_sale_by<?=$row_cnt?>" value="QTY" readonly />&nbsp;&nbsp;&nbsp;
													<input class="form-control" type="text" style="width:60%;display:inline-block;" name="delivery_customer_product_detail_qty[]" id="delivery_customer_product_detail_qty<?=$row_cnt?>" value="<?=$get_product_detail['delivery_customer_product_detail_qty']?>" />
												<?php
													}
												?>
													
													
												<!--<input class="form-control" type="text"  name="delivery_customer_product_detail_qty[]" id="delivery_customer_product_detail_qty<?=$row_cnt?>" value="<?=$get_product_detail['delivery_customer_product_detail_qty']?>"  /> -->
											</td>
