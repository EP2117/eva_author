    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Outstanding Report</h1>
							...
							<form action="index.php" method="post" id="invoice_list_form" name="invoice_list_form" >
								...
								<div class="col-lg-4">
									...
									<div class="form-group" >
										...
										<input type="text" name="search_entry_no" id="search_entry_no" class="form-control " style="width:100%"  value="<?=searchValue('search_entry_no')?>" /> 
								...
								<table class="table table-striped table-bordered table-hover" id="product_detail_rls" >
                                    <thead  >
										 ...
										 <th >SNO</th>
											...
											<th style="vertical-align:middle;" nowrap="nowrap">INVOICE NO.</th>
											<th style="vertical-align:middle;"> DATE</th>
											<th style="vertical-align:middle;"> CUSTOMER NAME</th>
											<th style="vertical-align:middle;"> INVOICE AMOUNT</th>
                                            <th style="vertical-align:middle;"> RECEIVED AMOUNT</th>
                                    ...
                                    <tbody >
										...
										<td><?php echo $sno++;?></td>	
											...
											<td style="text-align:right"><?php echo number_format($get_val['invoice_entry_net_amount'],2,'.','');?></td>
											<td style="text-align:right"><?php echo number_format($get_val['received_amt'],2,'.','');?></td>
											<td style="text-align:right"><?php echo number_format($get_val['invoice_entry_net_amount']-$get_val['received_amt'],2,'.','');?></td>
										</tr>
										<?php 
										
										
									
										$grandqty=$grandqty+$get_val['invoice_entry_net_amount'];
										$grandrec=$grandrec+$get_val['received_amt'];
										$grandbal=$grandbal+($get_val['invoice_entry_net_amount']-$get_val['received_amt']);
										}?>
										
										<tr>
										<td colspan="3" >&nbsp; </td>
										<td > Grand Total</td>
										<td style="text-align:right"><?php echo number_format($grandqty,2,'.','');?>
										</td>
										<td style="text-align:right"><?php echo number_format($grandrec,2,'.','');?>
										</td>
										<td style="text-align:right"><?php echo number_format($grandbal,2,'.','');?>
										</td>
										</tr>
									</tbody>
								</table>
