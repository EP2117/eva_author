								...
								<div class="panel-body">
									...
									<div class="col-lg-6">
										...
										<div class="form-group">
											...
											<select name="production_entry_godown_id" id="production_entry_godown_id" class="form-control select2" style="width:100%" required>
								...
								<div class="panel-body">
									...
									<div class="col-lg-6">
										...
										<div class="form-group">
											...
											<select name="production_entry_godown_id" id="production_entry_godown_id" class="form-control select2" onChange="GetcustomerDetail()" style="width:100%">
												<option value=""> - Select - </option>
												<?php
												foreach($godown_list as $get_godown){
...
<input type="hidden"  name="production_entry_product_detail_product_type[]" id="production_entry_product_detail_product_type<?=$row_cnt?>" value="<?=$get_product_detail['production_entry_product_detail_product_type']?>" />
											...
											<td>
											<?=$product_colour_name?>
											<input type="hidden"  name="production_entry_product_detail_product_colour_id[]" id="production_entry_product_detail_product_colour_id<?=$row_cnt?>" value="<?=$get_product_detail['production_entry_product_detail_product_colour_id']?>"   />
											</td>
...
<input type="hidden"  name="production_entry_product_detail_product_type[]" id="production_entry_product_detail_product_type<?=$row_cnt?>" value="<?=$get_product_detail['production_entry_product_detail_product_type']?>" />
											...
											<td>
											<?=$product_colour_name?>
												<input type="hidden"  name="production_entry_product_detail_product_colour_id[]" id="production_entry_product_detail_product_colour_id<?=$row_cnt?>" value="<?=$arr_thick[$get_product_detail['production_entry_product_detail_product_colour_id']]?>"   />
...
<input type="hidden"  name="production_entry_raw_product_detail_osf_ton[]" id="production_entry_raw_product_detail_osf_ton<?=$row_cnt?>" value="<?=$get_product_detail['product_con_entry_osf_uom_ton']?>" />
											...
											<?=$product_name?>
											<input type="hidden"  name="grn_entry_raw_product_detail_product_id[]" id="grn_entry_raw_product_detail_product_id<?=$row_cnt?>" value="<?=$get_product_detail['production_entry_raw_product_detail_product_id']?>"  />
											<input type="hidden"  name="grn_entry_raw_product_detail_id[]" id="grn_entry_raw_product_detail_id<?=$row_cnt?>" value="<?=$get_product_detail['production_entry_raw_product_detail_grn_detail_id']?>" />
						...
						<div class="panel panel-info">
							...
							<div class="panel-body">
								...
								<div class="col-lg-6">
										...
										<input type="hidden"  name="production_entry_type_id" id="production_entry_type_id" value="<?=$production_entry_edit['production_entry_type_id']?>" />	
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<?php
										...
										$edit_status = $edit_status = editStatus('prn_entry_product_details', 'prn_entry_product_detail_production_entry_id',$get_quotation['production_entry_id'], 'prn_entry_product_detail_deleted_status');
				...
				$delete_status = $edit_status;			
									...
									?>
                                        ...
                                        <tr class="odd gradeX">
											...
											<td><a href="production-print.php?id=<?php echo $get_quotation['production_entry_uniq_id']?>" title="INVOICE PRINT" class="glyphicon glyphicon-print pull-left" target="_blank" style="color:blue"></a></td>
