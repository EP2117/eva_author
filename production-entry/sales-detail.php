...
?>
		...
		?>
					...
					<tr class="odd gradeX">
						...
						<input type="hidden" name="grn_entry_no" id="grn_entry_no<?php echo $record_grn_entry['grn_entry_id'];?>" value="<?php echo $record_grn_entry['production_order_no']; ?>" >
						...
						<input type="hidden" name="grn_entry_type" id="grn_entry_type<?php echo $record_grn_entry['grn_entry_id'];?>" value="<?=($record_grn_entry['grn_entry_type_id']>0)?$arrQuotationType[$record_grn_entry['grn_entry_type_id']]:""?>" >
						...
						<input type="hidden" name="production_order_no" id="production_order_no<?php echo $record_grn_entry['grn_entry_id'];?>" value="<?=$record_grn_entry['production_order_no']?>" >
						
					<input type="hidden" name="customer_name" id="customer_name<?php echo $record_grn_entry['grn_entry_id'];?>" value="<?=$record_grn_entry['customer_name']?>" >
						...
						<td><?=($record_grn_entry['grn_entry_type_id']>0)?$arrQuotationType[$record_grn_entry['grn_entry_type_id']]:""?></td>
						
						<td><?=$record_grn_entry['production_order_no']?></td>
