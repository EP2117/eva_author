									...
									<div class="panel-body">
										...
										<div class="col-lg-6">
											...
											<div class="form-group">
												...
												<input type="text" class="form-control"  name="supplier_name" id="supplier_name" readonly value="<?php echo empty($editResult['supplier_name'])?"":$editResult['supplier_name']; ?>">														
											</div>			
											...
											<?php 
											 ...
											 <tr id="remove_req_<?php echo $i; ?>">
												<td><?php echo $editdebitproduct[$i]['product_name']; ?>
													<input type="hidden" name="dn_entry_product_detail_id_<?php echo $i; ?>" value="<?php echo $editdebitproduct[$i]['grnProdId']; ?>">																
												...
												<td>																
													<input type="text" class="form-control" name="po_qty_<?php echo $i; ?>" id="po_qty_<?php echo $i; ?>"  onkeypress="return o_obj.Alpha_Numeric(this,event);" value="<?php echo $editdebitproduct[$i]['dn_entry_product_detail_qty']; ?>" readonly>
												</td>
												...
												<td>																
													<input type="text" class="form-control" name="qty_<?php echo $i; ?>" id="qty<?php echo $i; ?>"  onkeypress="return o_obj.Alpha_Numeric(this,event);" value="<?php echo $editdebitproduct[$i]['dn_entry_product_detail_qty']; ?>" onChange="return product_count(this.value,this,<?php echo $i; ?>);">
												</td>
												<td>																
													<input type="text" class="form-control" name="tot_amount_cur_<?php echo $i; ?>" id="tot_amount_cur_<?php echo $i; ?>"  onkeypress="return o_obj.Alpha_Numeric(this,event);" value="<?php echo $editdebitproduct[$i]['dn_entry_product_detail_tot_amount_cur']; ?>" onChange="return product_count(this.value,this,<?php echo $i; ?>);">
												</td>
												<td>																
													<input type="text" class="form-control" name="tot_amount_<?php echo $i; ?>" id="tot_amount_<?php echo $i; ?>"  onkeypress="return o_obj.Alpha_Numeric(this,event);" value="<?php echo $editdebitproduct[$i]['dn_entry_product_detail_tot_amount']; ?>" onChange="return product_count(this.value,this,<?php echo $i; ?>);">
												</td>
								...
								<div   class="panel panel-info" id="child_product_detail_panel" <?php if($entryoneid==1){?> style="display:block" <?php }else{?> style="display:none" <?php }?> >
									...
									<div class="panel-body" >
										...
										<table id="child_receipt_table" class="table table-striped table-bordered table-hover">
												...
												<thead>
													<tr>
													<th rowspan="2" style="width:10%;vertical-align:middle;" nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;Code&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
													<th rowspan="2"  style="vertical-align:middle;" nowrap="nowrap">Product Name</th>
													<th rowspan="2" nowrap="nowrap"  style="vertical-align:middle;">&nbsp;&nbsp;&nbsp;&nbsp; Color &nbsp;&nbsp;&nbsp;&nbsp;</th>
													<th rowspan="2"  nowrap="nowrap" style="vertical-align:middle;">&nbsp;&nbsp;&nbsp;&nbsp; Thick &nbsp;&nbsp;&nbsp;&nbsp;</th>
													<th colspan="2">Width</th>
													<th colspan="2">Length</th>
													<th rowspan="2" nowrap="nowrap" style="vertical-align:middle;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; UOM &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
													<th colspan="2" nowrap="nowrap" style="vertical-align:middle;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; QTY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
													<th rowspan="2" nowrap="nowrap" style="vertical-align:middle;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Rate &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
													<th rowspan="2" nowrap="nowrap" style="vertical-align:middle;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Frg Rate &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
													<th colspan="2">Debit Width</th>
													<th colspan="3">Debit Note Length</th>
													<th colspan="2" nowrap="nowrap" style="vertical-align:middle;">Debit Weight</th>
													<th rowspan="2" nowrap="nowrap" style="vertical-align:middle;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Amount By Cur &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
													<th rowspan="2" nowrap="nowrap" style="vertical-align:middle;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Amount By MMK &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
												</tr>
												<tr>
													<th nowrap="nowrap" style="vertical-align:middle;">&nbsp;&nbsp;&nbsp;&nbsp; Inches &nbsp;&nbsp;&nbsp;&nbsp;</th>
													<th nowrap="nowrap" style="vertical-align:middle;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; MM &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
													<th nowrap="nowrap" style="vertical-align:middle;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Feet &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
													<th nowrap="nowrap" style="vertical-align:middle;">&nbsp;&nbsp;&nbsp;&nbsp; METER &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
													<th nowrap="nowrap" style="vertical-align:middle;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ton &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
													<th nowrap="nowrap" style="vertical-align:middle;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; KG &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
													<th nowrap="nowrap" style="vertical-align:middle;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Inches &nbsp;&nbsp;&nbsp;&nbsp;</th>
													<th nowrap="nowrap" style="vertical-align:middle;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; MM &nbsp;&nbsp;&nbsp;</th>
													<th nowrap="nowrap" style="vertical-align:middle;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Feet &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
													<th nowrap="nowrap" style="vertical-align:middle;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Feet.In &nbsp;&nbsp;&nbsp;&nbsp;</th>
													<th nowrap="nowrap" style="vertical-align:middle;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; METER &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
													<th nowrap="nowrap" style="vertical-align:middle;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; KG &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
													<th nowrap="nowrap" style="vertical-align:middle;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ton &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
												...
												<?php $count_val = !empty($editdebitproductChild) ? count($editdebitproductChild) :'';
												 ...
												 ?>
														...
														<tr>
															...
															<td style="width:5%"><input type="text" name="dne_child_detail_width_inches[]" id="dne_child_detail_width_inches_<?php echo $i; ?>" value="<?php echo $editdebitproductChild[$i]['dne_child_detail_width_inches']; ?>" class="form-control" onBlur="GetWcalc(2,'<?php echo $i; ?>');" /></td>
															
															<td style="width:5%"><input type="text" name="dne_child_detail_width_mm[]" id="dne_child_detail_width_mm_<?php echo $i; ?>" value="<?php echo $editdebitproductChild[$i]['dne_child_detail_width_mm']; ?>" class="form-control" onBlur="GetWcalc(3,'<?php echo $i; ?>');" /></td>
															
															<td style="width:5%"><input type="text" name="dne_child_detail_length_feet[]" id="dne_child_detail_length_feet_<?php echo $i; ?>" value="<?php echo $editdebitproductChild[$i]['dne_child_detail_length_feet']; ?>" class="form-control" onBlur="GetCLcalc(1,'<?php echo $i; ?>');" /></td>
															
															<td style="width:5%"><input type="text" name="dne_child_detail_length_mm[]" id="dne_child_detail_length_mm_<?php echo $i; ?>" value="<?php echo $editdebitproductChild[$i]['dne_child_detail_length_mm']; ?>"  class="form-control" onBlur="GetCLcalc(3,'<?php echo $i; ?>')" /></td> 
															...
															<td style="width:5%"><input type="text" name="dne_child_detail_ton_qty[]" id="dne_child_detail_ton_qty_<?php echo $i; ?>" class="form-control" value="<?php echo $editdebitproductChild[$i]['dne_child_detail_ton_qty']; ?>"  /></td> 
															
															<td style="width:5%"><input type="text" name="dne_child_detail_kg_qty[]" id="dne_child_detail_kg_qty_<?php echo $i; ?>" class="form-control" value="<?php echo $editdebitproductChild[$i]['dne_child_detail_kg_qty']; ?>"  /></td>
															
															<td style="width:5%"><input type="text" name="dne_child_detail_rate[]" id="dne_child_detail_rate_<?php echo $i; ?>" class="form-control" value="<?php echo $editdebitproductChild[$i]['dne_child_detail_rate']; ?>" /></td> 
															
															<td style="width:5%"><input type="text" name="dne_child_detail_frg_rate[]" id="dne_child_detail_frg_rate_<?php echo $i; ?>" class="form-control" value="<?php echo $editdebitproductChild[$i]['dne_child_detail_frg_rate']; ?>" /></td>
															
															<td style="width:5%"><input type="text" name="dne_child_detail_dw_inches[]" id="dne_child_detail_dw_inches_<?php echo $i; ?>" class="form-control" onKeyUp="GetLcalD(2,'<?php echo $i; ?>')" value="<?php echo $editdebitproductChild[$i]['dne_child_detail_dw_inches']; ?>"  /></td>
															
															<td style="width:5%"><input type="text" name="dne_child_detail_dw_mm[]" id="dne_child_detail_dw_mm_<?php echo $i; ?>" class="form-control" onBlur="GetLcalD(3,'<?php echo $i; ?>')" value="<?php echo $editdebitproductChild[$i]['dne_child_detail_dw_mm']; ?>"  /></td>  
															
															<td style="width:5%"><input type="text" name="dne_child_detail_dnl_feet[]" id="dne_child_detail_dnl_feet_<?php echo $i; ?>" class="form-control"  onBlur="GetDFeet(1,'<?php echo $i; ?>')" value="<?php echo $editdebitproductChild[$i]['dne_child_detail_dnl_feet']; ?>" /></td>
															
															<td style="width:5%"><input type="text" name="dne_child_detail_dnl_feet_ing[]" id="dne_child_detail_dnl_feet_ing_<?php echo $i; ?>" class="form-control"  onBlur="GetDFeet(2,'+i+')" value="<?php echo $editdebitproductChild[$i]['dne_child_detail_dnl_feet_ing']; ?>" /></td>
															
															<td style="width:5%"><input type="text" name="dne_child_detail_dnl_m[]" id="dne_child_detail_dnl_m_<?php echo $i; ?>" class="form-control"   onBlur="GetDFeet(3,'<?php echo $i; ?>')" value="<?php echo $editdebitproductChild[$i]['dne_child_detail_dnl_m']; ?>" /></td>
															
															<td style="width:5%"><input type="text" name="dne_child_detail_dw_kg[]" id="dne_child_detail_dw_kg_<?php echo $i; ?>" class="form-control" value="<?php echo $editdebitproductChild[$i]['dne_child_detail_dw_kg']; ?>"  /></td>
															
															<td style="width:5%"><input type="text" name="dne_child_detail_dnl_dw_ton[]" id="dne_child_detail_dnl_dw_ton_<?php echo $i; ?>" class="form-control" value="<?php echo $editdebitproductChild[$i]['dne_child_detail_dnl_dw_ton']; ?>"  /></td>
															<td style="width:5%"><input type="text" name="dne_child_detail_amount_cur[]" id="dne_child_detail_amount_cur_<?php echo $i; ?>" class="form-control" value="<?php echo $editdebitproductChild[$i]['dne_child_detail_amount_cur']; ?>"  /></td>
															<td style="width:5%"><input type="text" name="dne_child_detail_amount[]" id="dne_child_detail_amount_<?php echo $i; ?>" class="form-control" value="<?php echo $editdebitproductChild[$i]['dne_child_detail_amount']; ?>"  /></td>
