...
function AddproductDetail(){
	...
	for (var i = 0; i < x.length; i++) {
		if (x[i].checked ==true) {
			...
			apnd += '<tr>';
			apnd += '<td><input type="hidden" name="dn_entry_product_detail_id_'+i+'" value=""><input type="hidden" name="productid_'+i+'"  value='+product_id+'>'+product_name+ ' </td>';
			...
			apnd += '<td><input type="text" class="form-control" name="f_rate_'+i+'" id="f_rate_'+i+'" value="'+pR_rate+'"  readonly></td>';
...
function AddCproductDetail(){
	...
	for (var k = 0; k < document.getElementById('child_product_list_form').elements.length; k++) {

		if (document.getElementById('child_product_list_form').elements[k].checked ==true) {

			var ord_id 	=  document.getElementById('child_product_list_form').elements[k].value;
			var product_id 				= document.getElementById('product_id'+ord_id).value;
			var product_name 			= document.getElementById('product_name'+ord_id).value;
			var product_code 			= document.getElementById('product_code'+ord_id).value;
			var product_uom 			= document.getElementById('product_uom'+ord_id).value;
			...
			//var product_val				= product_id+'-'+product_name;
				...
				apnd += '<td  style="width:5%"><input type="text" name="dne_child_detail_width_inches[]" id="dne_child_detail_width_inches_'+i+'" value="'+product_width_inches+'" class="form-control" onblur="GetWcalc(2,'+i+');" /></td>'; 
				apnd += '<td  style="width:5%"><input type="text" name="dne_child_detail_width_mm[]" id="dne_child_detail_width_mm_'+i+'" value="'+product_width_mm+'" class="form-control" onBlur="GetWcalc(3,'+i+');" /></td>';
				apnd += '<td style="width:5%"><input type="text" name="dne_child_detail_length_feet[]" id="dne_child_detail_length_feet_'+i+'" value="'+product_length_feet+'" class="form-control" onBlur="GetCLcalc(1,'+i+');" /></td>';
				apnd += '<td style="width:5%"><input type="text" name="dne_child_detail_length_mm[]" id="dne_child_detail_length_mm_'+i+'" value="'+product_length_mm+'"  class="form-control" onBlur="GetCLcalc(3,'+i+')" /></td>'; 
				apnd += '<td style="width:5%"><input type="hidden" name="dne_child_detail_uom_id[]" id="dne_child_detail_uom_id_'+i+'" value="'+product_uom_id+'" class="form-control"  />'+product_uom+'</td>';
				apnd += '<td style="width:5%"><input type="text" name="dne_child_detail_ton_qty[]" id="dne_child_detail_ton_qty_'+i+'" class="form-control" value="'+product_ton_qty+'"  /></td>';  
				apnd += '<td style="width:5%"><input type="text" name="dne_child_detail_kg_qty[]" id="dne_child_detail_kg_qty_'+i+'" class="form-control" value="'+product_kg_qty+'"  /></td>';
				apnd += '<td style="width:5%"><input type="text" name="dne_child_detail_rate[]" id="dne_child_detail_rate_'+i+'" class="form-control" value="'+product_rate+'"  /></td>';  
				apnd += '<td style="width:5%"><input type="text" name="dne_child_detail_frg_rate[]" id="dne_child_detail_frg_rate_'+i+'" class="form-control" value="'+product_frgn_rate+'"  /></td>';
				apnd += '<td style="width:5%"><input type="text" name="dne_child_detail_dw_inches[]" id="dne_child_detail_dw_inches_'+i+'" class="form-control" onkeyup="GetLcalD(2,'+i+')"   /></td>';
				apnd += '<td style="width:5%"><input type="text" name="dne_child_detail_dw_mm[]" id="dne_child_detail_dw_mm_'+i+'" class="form-control" onBlur="GetLcalD(3,'+i+')"   /></td>';  
				apnd += '<td style="width:5%"><input type="text" name="dne_child_detail_dnl_feet[]" id="dne_child_detail_dnl_feet_'+i+'" class="form-control" value="" onBlur="GetDFeet(1,'+i+')" /></td>';
				apnd += '<td style="width:5%"><input type="text" name="dne_child_detail_dnl_feet_ing[]" id="dne_child_detail_dnl_feet_ing_'+i+'" class="form-control" value="" onBlur="GetDFeet(1,'+i+')" /></td>';
				apnd += '<td i="width:5%"><input type="text" name="dne_child_detail_dnl_m[]" id="dne_child_detail_dnl_m_'+i+'" class="form-control" value=""  /></td>';
				apnd += '<td style="width:5%"><input type="text" name="dne_child_detail_dw_kg[]" id="dne_child_detail_dw_kg_'+i+'" class="form-control" value=""  onblur="GetWeightClc(2,'+i+')"/></td>';
				apnd += '<td style="width:5%"><input type="text" name="dne_child_detail_dnl_dw_ton[]" id="dne_child_detail_dnl_dw_ton_'+i+'" class="form-control" value="" onblur="GetWeightClc(1,'+i+')" /></td>';
				apnd += '<td style="width:5%"><input type="text" name="dne_child_detail_amount_cur[]" id="dne_child_detail_amount_cur_'+i+'" class="form-control" value=""   /></td>';
				apnd += '<td style="width:5%"><input type="text" name="dne_child_detail_amount[]" id="dne_child_detail_amount_'+i+'" class="form-control" value=""  /></td></tr>';
			var i	= i+1;
		}
	}
