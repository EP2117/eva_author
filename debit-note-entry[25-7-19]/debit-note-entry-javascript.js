	...
	for (var k = 0; k < x.length; k++) {
		if (x[k].checked ==true) {
			...
			//var product_val				= product_id+'-'+product_name;
				...
				apnd += '<td style="width:5%"><input type="text" name="dne_child_detail_dw_inches[]" id="dne_child_detail_dw_inches_'+i+'" class="form-control" onBlur="GetLcalD(2,'+i+'),GetWeightClc(1,'+i+')"   /></td>';
				apnd += '<td style="width:5%"><input type="text" name="dne_child_detail_dw_mm[]" id="dne_child_detail_dw_mm_'+i+'" class="form-control" onBlur="GetLcalD(3,'+i+'),GetWeightClc(1,'+i+')"   /></td>';  
				apnd += '<td style="width:5%"><input type="text" name="dne_child_detail_dnl_feet[]" id="dne_child_detail_dnl_feet_'+i+'" class="form-control" value="" onBlur="GetDFeet(1,'+i+'),GetWeightClc(1,'+i+')" /></td>';
				apnd += '<td style="width:5%"><input type="text" name="dne_child_detail_dnl_feet_ing[]" id="dne_child_detail_dnl_feet_ing_'+i+'" class="form-control" value="" onBlur="GetDFeet(1,'+i+'),GetWeightClc(1,'+i+')" /></td>';
				apnd += '<td i="width:5%"><input type="text" name="dne_child_detail_dnl_m[]" id="dne_child_detail_dnl_m_'+i+'" class="form-control" value=""  /></td>';
				apnd += '<td style="width:5%"><input type="text" name="dne_child_detail_dw_kg[]" id="dne_child_detail_dw_kg_'+i+'" class="form-control" value="" readonly=""/></td>';
				apnd += '<td style="width:5%"><input type="text" name="dne_child_detail_dnl_dw_ton[]" id="dne_child_detail_dnl_dw_ton_'+i+'" class="form-control" value="" readonly="" /></td>';
