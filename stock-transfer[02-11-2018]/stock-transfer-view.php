								...
								<div class="panel-body">
									...
									<div class="col-lg-6">
										...
										<div class="form-group">
											...
											<select name="stock_transfer_branch_id" id="stock_transfer_branch_id" class="form-control select2" style="width:100%">
										...
										<div class="form-group">
											...
											<select name="stock_transfer_production_section_id" id="stock_transfer_production_section_id" class="form-control select2" style="width:100%">
												...
												<?php
													...
													foreach($prd_sec_list	as	$get_prd_sec){
														...
														$selected	= ($get_prd_sec['production_section_id']==$stock_transfer_edit['stock_transfer_production_section_id'])?'selected="selected"':'';
										...
										<div class="form-group">
											...
											<select name="stock_transfer_from_godown_id" id="stock_transfer_from_godown_id" class="form-control select2" onChange="GetcustomerDetail()">
									...
									<div class="col-lg-6">
										...
										<div class="form-group">
											...
											<label>Date</label>
											 ...
											 <div class="input-group date">
											  ...
											  <input type="text" class="form-control" name="stock_transfer_date" id="stock_transfer_date" value="<?=dateGeneralFormatN($stock_transfer_edit['stock_transfer_date'])?>">
										...
										<div class="form-group">
											...
											<select name="stock_transfer_type" id="stock_transfer_type" class="form-control select2" style="width:100%" >

												  <option value="1" <?php if($stock_transfer_edit['stock_transfer_type']==1){ ?> selected="selected" <?php } ?>>Sales Production </option>

												  <option value="2" <?php if($stock_transfer_edit['stock_transfer_type']==2){ ?> selected="selected" <?php } ?>>Normal Production </option>
										...
										<div class="form-group">
											...
											<select name="stock_transfer_to_godown_id" id="stock_transfer_to_godown_id" class="form-control select2" onChange="GetcustomerDetail()">
							...
							<div class="panel-body">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="so_detail"  style=" width:100%" >
                                    ...
                                    <tbody id="so_detail_display">
										...
										<input type="hidden"  name="stock_transfer_invoice_entry_id" id="stock_transfer_invoice_entry_id" value="<?=$stock_transfer_edit['stock_transfer_invoice_entry_id']?>"  class="dc_id"  />
