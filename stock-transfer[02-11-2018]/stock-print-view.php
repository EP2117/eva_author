...
<body >
   ...
   <tr>
	...
	<tr>
 	 <td width="100%" colspan="4" class="report-border-bottom" style='text-align:center;font-weight:bold;font-size:16px;padding:10px;' > STOCK TRANSFER </td>
	</tr>
   <tr>
	  <td width="50%" colspan="2" class="report-border-right report-border-bottom" style='text-align:left;font-weight:bold;font-size:13px;' >STOCK TRANSFER NO : &nbsp;<?=$invoice_entry_edit['stock_transfer_no']?></td>
	 <td width="50%" colspan="2" class="report-border-right report-border-bottom" style='text-align:right;font-weight:bold;font-size:13px;' > STOCK TRANSFER DATE : <?=dateGeneralFormatN($invoice_entry_edit['stock_transfer_date'])?></td>
	</tr>
...
<?php
	...
	if($invoice_entry_edit['stock_transfer_type_id']==1){
 ...
 <?php }?>
			<tr>
				...
				<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					<?=$arr_thick[$getDetail['stock_transfer_product_detail_product_thick']]?> </td>
				<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					<?=number_format($getDetail['stock_transfer_product_detail_sl_feet'],2,'.','')?> </td>
					<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					<?=number_format($getDetail['stock_transfer_product_detail_sl_feet_in'],3,'.','')?> </td>
					<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					<?=number_format($getDetail['stock_transfer_product_detail_sl_feet_mm'],3,'.','')?> </td>
					<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					<?=number_format($getDetail['stock_transfer_product_detail_sl_feet_met'],3,'.','')?> </td>
				<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					<?=number_format($getDetail['stock_transfer_product_detail_qty'],3,'.','')?> </td>
				<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
				<?=number_format($getDetail['stock_transfer_product_detail_tot_length'],2,'.','')?> </td>
...
if($invoice_entry_prd_edit){?>
	...
	if($invoice_entry_edit['stock_transfer_type_id']==2){
 ...
 <?php }?>
			<tr>
				...
				<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					<?=$arr_thick[$getDetail['stock_transfer_product_detail_product_thick']]?> </td>
				<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					<?=number_format($getDetail['stock_transfer_product_detail_width_inches'],2,'.','')?> </td>
					<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					<?=number_format($getDetail['stock_transfer_product_detail_width_mm'],3,'.','')?> </td>
					<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					<?=number_format($getDetail['stock_transfer_product_detail_weight_tone'],3,'.','')?> </td>
					<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					<?=number_format($getDetail['stock_transfer_product_detail_weight_kg'],3,'.','')?> </td>
...
if($invoice_entry_prd_edit){?>
	...
	if($invoice_entry_edit['stock_transfer_type_id']==4){
 ...
 <?php }?>
			<tr>
				...
				<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					<?=$getDetail['stock_transfer_product_detail_qty']?> </td>
