                                ...
                                <table class="table table-striped table-bordered table-hover" id="product_detail"  style="width:190%" >
									...
									<thead style="display:none" class="as">
                                         ...
                                         <tr>
                                            ...
                                            <th style="vertical-align:middle; width:15%">UOM</th>

											<th style="vertical-align:middle; width:15%">QTY</th>
											<th style="vertical-align:middle; width:20%">Feet/QTY</th>
											<th style="vertical-align:middle; width:20%">Total Feet</th>
                                   ...
                                   <!-- </thead>
									...
									<?php }else{?>
										...
										<!--	<th style="vertical-align:middle; ">BRAND</th>-->
											...
											<th style="vertical-align:middle;">Feet/QTY</th>
											<th style="vertical-align:middle;">Total Feet</th>
...
<input type="hidden"  name="stock_transfer_product_detail_product_type[]" id="stock_transfer_product_detail_product_type<?=$row_cnt?>" value="<?=$get_product_detail['stock_transfer_product_detail_product_type']?>" />
											...
											<input class="form-control" type="text"  name="stock_transfer_product_detail_product_thick[]" id="stock_transfer_product_detail_product_thick<?=$row_cnt?>" value="<?=$arr_thick[$get_product_detail['stock_transfer_product_detail_product_thick']]?>" readonly   />

											</td>

											<td>

											<input class="form-control" type="text"  name="stock_transfer_product_detail_width_inches[]" id="stock_transfer_product_detail_width_inches<?=$row_cnt?>" value="<?=$get_product_detail['stock_transfer_product_detail_width_inches']?>" onKeyUp="GetWcalc(2,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" readonly  />

											</td>

											<td>

											<input class="form-control" type="text"  name="stock_transfer_product_detail_width_mm[]" id="stock_transfer_product_detail_width_mm<?=$row_cnt?>" value="<?=$get_product_detail['stock_transfer_product_detail_width_mm']?>" onKeyUp="GetWcalc(3,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" readonly />

											</td>

											<td>

											<input class="form-control" type="text"  name="stock_transfer_product_detail_length_feet[]" id="stock_transfer_product_detail_length_feet<?=$row_cnt?>" value="<?=$get_product_detail['stock_transfer_product_detail_length_feet']?>" onKeyUp="GetWcalS(2,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" readonly />
											</td>

											<td>

											<input class="form-control" type="text"  name="stock_transfer_product_detail_length_meter[]" id="stock_transfer_product_detail_length_meter<?=$row_cnt?>" value="<?=$get_product_detail['stock_transfer_product_detail_length_meter']?>" onKeyUp="GetWcalS(3,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" readonly />
											...
											<input class="form-control" type="text"  name="stock_transfer_product_detail_tot_length[]" id="stock_transfer_product_detail_tot_length<?=$row_cnt?>" value="<?=$get_product_detail['stock_transfer_product_detail_tot_length']?>" onKeyUp="GetLcalFeet(2,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" readonly />
...
<input type="hidden"  name="stock_transfer_product_detail_product_type[]" id="stock_transfer_product_detail_product_type<?=$row_cnt?>" value="<?=$get_product_detail['stock_transfer_product_detail_product_type']?>" />
											...
											<input class="form-control" type="text"  name="stock_transfer_product_detail_width_inches[]" id="stock_transfer_product_detail_width_inches<?=$row_cnt?>" value="<?=$get_product_detail['stock_transfer_product_detail_width_inches']?>" onKeyUp="GetWcalc(2,<?=$row_cnt?>)"  readonly />

											</td>

											<td>

											<input class="form-control" type="text"  name="stock_transfer_product_detail_width_mm[]" id="stock_transfer_product_detail_width_mm<?=$row_cnt?>" value="<?=$get_product_detail['stock_transfer_product_detail_width_mm']?>" onKeyUp="GetWcalc(3,<?=$row_cnt?>)"  readonly />

											</td>
											<td>

											<input class="form-control" type="text"  name="stock_transfer_product_detail_weight_tone[]" id="stock_transfer_product_detail_weight_tone<?=$row_cnt?>" value="<?=$get_product_detail['stock_transfer_product_detail_weight_tone']?>"  readonly />

											</td>
											<td>

											<input class="form-control" type="text"  name="stock_transfer_product_detail_weight_kg[]" id="stock_transfer_product_detail_weight_kg<?=$row_cnt?>" value="<?=$get_product_detail['stock_transfer_product_detail_weight_kg']?>"  readonly />
