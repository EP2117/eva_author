...
function AddproductDetail(){
	for (var i = 0; i < document.getElementById('product_list_form').elements.length; i++) {
		...
		if (document.getElementById('product_list_form').elements[i].checked ==true) {
			...
			var apnd = ''; 
			if(t_id==1){ 
			apnd	+= '<tr><td><input type="hidden"  name="stock_transfer_product_detail_mother_chile_type[]" id="stock_transfer_product_detail_mother_chile_type" value="'+product_mother_child_type+'" />'+product_brand_name+'</td><td>'+product_name+'<input type="hidden"  name="stock_transfer_product_detail_product_id[]" id="stock_transfer_product_detail_product_id" value="'+product_id+'" /><input type="hidden"  name="stock_transfer_product_detail_product_type[]" id="stock_transfer_product_detail_product_type" value="'+product_type+'" /><input type="hidden"  name="stock_transfer_product_detail_po_detail_id[]" id="stock_transfer_product_detail_po_detail_id" value="'+detail_id+'" /><input type="hidden"  name="stock_transfer_product_detail_osf_uom_ton[]" id="stock_transfer_product_detail_osf_uom_ton" value="'+osf_uom_ton+'" /></td>';
			...
			apnd	+= '<tr><td style="width:5%" ><input type="hidden"  name="stock_transfer_product_detail_mother_chile_type[]" id="stock_transfer_product_detail_mother_chile_type" value="'+product_mother_child_type+'" />'+product_brand_name+'</td><td style="width:5%" >'+product_name+'<input type="hidden"  name="stock_transfer_product_detail_product_id[]" id="stock_transfer_product_detail_product_id" value="'+product_id+'" /> <input type="hidden"  name="stock_transfer_product_detail_product_type[]" id="stock_transfer_product_detail_product_type" value="'+product_type+'" /><input type="hidden"  name="stock_transfer_product_detail_po_detail_id[]" id="stock_transfer_product_detail_po_detail_id" value="'+detail_id+'" /><input type="hidden"  name="stock_transfer_product_detail_osf_uom_ton[]" id="stock_transfer_product_detail_osf_uom_ton" value="'+osf_uom_ton+'" /></td>';
			...
			apnd	+= '<td><input class="form-control" type="hidden"  name="stock_transfer_product_detail_length_feet[]" id="stock_transfer_product_detail_length_feet'+row_cnt+'"  onBlur="GetWcalc(2,'+row_cnt+')" value="'+product_length_feet+'" readonly /><input class="form-control" type="hidden"  name="stock_transfer_product_detail_length_meter[]" id="stock_transfer_product_detail_length_meter'+row_cnt+'"   value="'+product_length_mm+'"  readonly/>';
			
			apnd	+= '<input class="form-control" type="text"  name="stock_transfer_product_detail_qty[]" id="stock_transfer_product_detail_qty'+row_cnt+'" onBlur="GetTotalLength('+row_cnt+')"   /></td></tr>';
			
			
			}else{ 
			
			apnd	+= '<tr><td><input type="hidden"  name="stock_transfer_product_detail_mother_chile_type[]" id="stock_transfer_product_detail_mother_chile_type" value="'+product_mother_child_type+'" />'+product_code+'</td><td style="width:30%">'+product_name+'<input type="hidden"  name="stock_transfer_product_detail_product_id[]" id="stock_transfer_product_detail_product_id" value="'+product_id+'" /><input type="hidden"  name="stock_transfer_product_detail_product_type[]" id="stock_transfer_product_detail_product_type"  value="'+product_type+'" /><input type="hidden"  name="stock_transfer_product_detail_po_detail_id[]" id="stock_transfer_product_detail_po_detail_id" value="'+detail_id+'" /></td>';
