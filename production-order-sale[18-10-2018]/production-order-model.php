<?php
	function GetAutoNo(){
		$select_invoice_no = "SELECT MAX(production_order_no) AS maxval FROM production_order 
...
$production_order_product_detail_product_colour_id	= $_POST['production_order_product_detail_product_colour_id'];
$production_order_product_detail_inv_tot_length		= $_POST['production_order_product_detail_inv_tot_length'];
		...
		// echo $production_order_product_detail_qty[$i]; exit;
			...
			if($detail_request_fields) {
				$production_order_product_detail_uniq_id 	= generateUniqId();
				 $insert_production_order_product_detail 		= sprintf("INSERT INTO production_order_product_details 
																				(production_order_product_detail_uniq_id,production_order_product_detail_production_order_id,
																				 ...
																				 production_order_product_detail_added_ip,production_order_product_detail_invoice_detail_id,
																				 production_order_product_detail_invoice_entry_id,production_order_product_detail_product_color_id,
																	...
																	VALUES     ('%s', '%d', 
																		 ...
																		 $production_order_invoice_entry_id,$production_order_product_detail_product_colour_id[$i],
																		 $production_order_type_id);
				...
				if($_SESSION[SESS.'_session_user_branch_type']==2){
					...
					reduceRawMaterial($produt_id,$product_thick,$product_colour_id,$width_inches,$tot_length,$production_order_no,$production_order_date,$production_order_id,$detail_id,$production_order_branch_id,$entry_type,$production_order_type_id,$ton_qty,$kg_qty);	
					}
				}
...

	{
		...
		$production_order_id 	= getId('production_order', 'production_order_id', 'production_order_uniq_id', dataValidation($_GET['id'])); 
		 ...
		 $select_production_order_product_detail 	= "	SELECT 
														...
														ON 
															c_clr.product_colour_id 					= production_order_product_detail_product_color_id
														WHERE 
