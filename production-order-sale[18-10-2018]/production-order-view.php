								...
								<div class="panel-body">
									<div class="col-lg-12">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="production_order_no" id="production_order_no" value="" style="width:460px;" readonly="" required>
										</div>
									</div>
									<div class="col-lg-6">
...
<input type="hidden"  name="production_order_product_detail_product_type[]" id="production_order_product_detail_product_type<?=$row_cnt?>" value="<?=$get_product_detail['production_order_product_detail_product_type']?>" />
											...
											<input class="form-control" type="text"  name="production_order_product_detail_qty[]" id="production_order_product_detail_qty<?=$row_cnt?>"  value="<?=$get_product_detail['production_order_product_detail_qty']?>" onBlur="GetTotalLength(<?=$row_cnt?>)" />
...
<input type="hidden"  name="production_order_product_detail_product_type[]" id="production_order_product_detail_product_type<?=$row_cnt?>" value="<?=$get_product_detail['production_order_product_detail_product_type']?>" />
											...
											<input class="form-control" type="text"  name="production_order_product_detail_product_thick[]" id="production_order_product_detail_product_thick<?=$row_cnt?>" value="<?=$get_product_detail['production_order_product_detail_product_thick']?>"   />
											...
											<input class="form-control" type="text"  name="production_order_product_detail_s_weight_inches[]" id="production_order_product_detail_s_weight_inches<?=$row_cnt?>" value="<?=$get_product_detail['production_order_product_detail_s_weight_inches']?>" onKeyUp="GetWcalS(2,<?=$row_cnt?>)"  />
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									?>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?=$get_quotation['branch_prefix'].$get_quotation['production_order_no']?></td>
