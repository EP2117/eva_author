								...
								<table class="table table-striped table-bordered table-hover" id="product_detail_rls" >
                                    <thead  >
										<?php if($_REQUEST['search_product_type']==1){ ?>		
                                         <tr>
											 <th rowspan="2" >#</th>
											<th rowspan="2" style="vertical-align:middle;" nowrap="nowrap"> PRN No. </th>
											<th rowspan="2" style="vertical-align:middle;"> Date</th>
											<th rowspan="2" style="vertical-align:middle;" nowrap="nowrap"> Production No. </th>
											<th rowspan="2" style="vertical-align:middle;"> Date</th>
										...
										<?php }elseif($_REQUEST['search_product_type']==4){ ?> 
										 <tr>
											 <th rowspan="2" >#</th>
											<th style="vertical-align:middle;" nowrap="nowrap"> GRN No. </th>
                                    ...
                                    <tbody >
										...
										<tr>
										<td><?php echo $sno++;?></td>	
											<td><?php echo $get_val['prn_entry_no'];?></td>
											<td><?php echo dateGeneralFormatN($get_val['prn_entry_date']);?></td>
											...
											<td><?php echo $arr_thick[$get_val['prn_entry_product_detail_product_thick']];?></td>
											<td><?php echo $get_val['prn_entry_product_detail_s_width_inches'];?></td>
											<td><?php echo $get_val['prn_entry_product_detail_s_width_mm'];?></td>
											<td><?php echo $get_val['prn_entry_product_detail_sl_feet'];?></td>
											<td><?php echo $get_val['prn_entry_product_detail_sl_feet_mm'];?></td>
											<td><?php echo $get_val['prn_entry_product_detail_qty'];?></td>
										</tr>
										<?php 
										...
										<td><?php echo $sno++;?></td>	
											...
											<td><?php echo $get_val['prn_entry_product_detail_s_width_inches'];?></td>
											<td><?php echo $get_val['prn_entry_product_detail_s_width_mm'];?></td>
											<td><?php echo number_format($get_val['prn_entry_product_detail_s_weight_inches'],2,'.','');?></td>
											<td><?php echo $get_val['prn_entry_product_detail_s_weight_mm'];?></td>
											<td><?php echo $get_val['prn_entry_product_detail_qty'];?></td>
										</tr>
										<?php 
