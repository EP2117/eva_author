<?php
	...
	function insertQuotation(){
		...
		$production_entry_product_detail_mother_child_type   		= $_POST['production_entry_product_detail_mother_child_type'];
		...
		$production_entry_raw_product_detail_mother_child_type 		= $_POST['production_entry_raw_product_detail_mother_child_type'];
			...
			if($detail_request_fields) {
				...
				$insert_production_entry_product_detail 		= sprintf("INSERT INTO production_entry_product_details 
																				(production_entry_product_detail_uniq_id,production_entry_product_detail_production_entry_id,
																				 ...
																				 production_entry_product_detail_added_ip,production_entry_product_detail_mother_child_type) 
																	VALUES     ('%s', '%d', 
																				'%d', '%d',
																				'%d', '%d', 
																				'%d', '%f', 
																		 ...
																		 $_SESSION[SESS.'_session_user_id'],$ip,$production_entry_product_detail_mother_child_type[$i]);
				...
				if($production_entry_type_id==4){
							...
							$mother_child_type=$production_entry_product_detail_mother_child_type[$i];
							stockLedger($mother_child_type,'in',$production_entry_id,$detail_id,$produt_id,$length_feet,$length_meter,$ton_qty,$kg_qty,$product_detail_qty, $production_entry_branch_id,  $product_con_entry_godown_id, $production_entry_date, $production_entry_no,$stock_ledger_entry_type, '1',$width_inches,$width_mm,$product_colour_id,$product_thick);
				}
				else{		
							$produt_id											=	$production_entry_product_detail_product_id[$i];
							...
							$width_inches										= 	$production_entry_product_detail_s_width_inches[$i];
							$width_mm											= 	$production_entry_product_detail_s_width_mm[$i];
							...
							$stock_ledger_entry_type							= 	"production-entry-fin";
							$product_con_entry_godown_id						= 	"3";
							stockLedger($mother_child_type,'in',$production_entry_id,$detail_id,$produt_id,$length_feet,$length_meter,$ton_qty,$kg_qty,$product_detail_qty, $production_entry_branch_id,  $product_con_entry_godown_id, $production_entry_date, $production_entry_no,$stock_ledger_entry_type, '3',$width_inches,$width_mm,$product_colour_id,$product_thick);
				}
			...
			if($detail_request_fields) {
				...
				$insert_production_entry_raw_product_detail 		= sprintf("INSERT INTO production_entry_raw_product_details 
																				(production_entry_raw_product_detail_uniq_id,
																				 ...
																				 production_entry_raw_product_detail_width_inches,
																				 production_entry_raw_product_detail_width_mm,
																				 ...
																				 production_entry_raw_product_detail_mother_child_type) 
																	VALUES     ('%s', '%d', 
																				'%d', '%d',
																				'%d', '%d', 
																				'%d', '%d', 
																		 ...
																		 $production_entry_grn_entry_id,
																		 $production_entry_raw_product_detail_product_colour_id[$i],
															...
															//	echo $insert_production_entry_raw_product_detail;exit;		 
				...
				$detail_id = mysql_insert_id();
							...
							$child_type											= 	$production_entry_raw_product_detail_mother_child_type[$i];
							$product_detail_qty									= 	"-1";
							$stock_ledger_entry_type							= 	"production-entry-raw";
							$product_con_entry_godown_id						= 	"3";
							stockLedger($child_type,'out',$production_entry_id,$detail_id,$produt_id,$length_feet,$length_meter,$ton_qty,$kg_qty,$product_detail_qty, $production_entry_branch_id,  $product_con_entry_godown_id, $production_entry_date, $production_entry_no,$stock_ledger_entry_type, '2',$width_inches,$width_mm,$color_id,$thick);
			}
		}
		// Work Assign details
	...
	function listQuotation(){
		...
		if(!empty($_REQUEST['search_branch_id'])){
			$where	.=" AND production_entry_branch_id = '".$_REQUEST['search_branch_id']."'";
		}
		...
		{
		$where.="AND production_entry_date BETWEEN '".NdateDatabaseFormat($_REQUEST['search_from_date'])."'
		...
		$select_production_entry		=	"SELECT 
											 ...
											 WHERE 
												...
												production_entry_deleted_status 	= 	0	 $where
...

	{
		...
		$select_production_entry_product_detail 	= "	SELECT 
													...
													LEFT JOIN 
														product_colours
													ON 
														product_colour_id 								= production_entry_product_detail_product_colour_id
														
													WHERE 
														production_entry_product_detail_deleted_status		 	= 0 	AND 
														production_entry_product_detail_mother_child_type		 	= '1' 	AND 
		...
		$select_production_entry_product_detail1 	= "	SELECT 
														production_entry_product_detail_id,
														production_entry_product_detail_product_id,
														production_entry_product_detail_width_inches,production_entry_product_detail_width_mm,
														production_entry_product_detail_s_width_inches,production_entry_product_detail_s_width_mm,
													...
													WHERE 
														production_entry_product_detail_deleted_status		 	= 0 		AND 
														production_entry_product_detail_mother_child_type		 	= '2' 	AND 
														production_entry_product_detail_production_entry_id 		= '".$production_entry_id."'";
													//	echo $select_production_entry_product_detail; exit;
		$result_production_entry_product_detail1 	= mysql_query($select_production_entry_product_detail1);
		$count_production_entry1 					= mysql_num_rows($result_production_entry_product_detail1);
		
		while($record_production_entry_product_detail1 = mysql_fetch_array($result_production_entry_product_detail1)) {
			$arr_production_entry_product_detail[] = $record_production_entry_product_detail1;
		}
...

	{
		...
		$select_production_entry_work_detail 	= "	SELECT 
														...
														//echo $select_production_entry_work_detail;exit;	
	...
	function updateQuotation(){
		...
		// echo $production_entry_product_detail_qty[$i]; exit;
			...
			if($detail_request_fields) {
				...
				//echo $update_production_entry_product_detail; exit;
					...
					$detail_id			= $production_entry_product_detail_id[$i];
				...
				if($production_entry_type_id==4){
							...
							$product_detail_qty									= 	$production_entry_product_detail_qty[$i];
							$stock_ledger_entry_type							= 	"production-entry-fin";
							$product_con_entry_godown_id						= 	$production_entry_godown_id;
							$mother_child_type=$production_entry_product_detail_mother_child_type[$i];
							stockLedger($mother_child_type,'in',$production_entry_id,$detail_id,$produt_id,$length_feet,$length_meter,$ton_qty,$kg_qty,$product_detail_qty, $production_entry_branch_id,  $product_con_entry_godown_id, $production_entry_date, $production_entry_no,$stock_ledger_entry_type, '1',$width_inches,$width_mm,$product_colour_id,$product_thick);
				}
				else{		
		...
		for($i = 0; $i < count($production_entry_raw_product_detail_product_id); $i++) { 
		// echo $production_entry_product_detail_qty[$i]; exit;
		//echo $production_entry_product_detail_product_id[$i]; exit;
			$detail_request_fields 							= 	((!empty($production_entry_product_detail_product_id[$i])) &&  	(!empty($production_entry_raw_product_detail_ton[$i])));
			if($detail_request_fields) {
			 ...
			 //echo $update_production_entry_raw_product_detail; exit;
				...
				$production_entry_raw_product_detail_uniq_id 	= generateUniqId();
			 	$insert_production_entry_raw_product_detail 		= sprintf("INSERT INTO production_entry_raw_product_details 
																				(production_entry_raw_product_detail_uniq_id,
																				 ...
																				 production_entry_raw_product_detail_added_ip,production_entry_raw_product_detail_mother_child_type) 
																	VALUES     ('%s', '%d', 
																				'%d', '%d',
																				'%d', '%d', 
																				'%d', '%d', 
																		 ...
																		 $_SESSION[SESS.'_session_user_id'],$ip,$production_entry_raw_product_detail_mother_child_type[$i]);
																		// echo $insert_production_entry_raw_product_detail;exit;
				mysql_query($insert_production_entry_raw_product_detail);
				$detail_id1 = mysql_insert_id();
							...
							$stock_ledger_entry_type							= 	"production-entry-raw";
							$product_con_entry_godown_id						= 	"3";
							stockLedger($child_type,'out',$production_entry_id,$detail_id1,$produt_id,$length_feet,$length_meter,$ton_qty,$kg_qty,$product_detail_qty, $production_entry_branch_id,  $product_con_entry_godown_id, $production_entry_date, $production_entry_no,$stock_ledger_entry_type, '2',$width_inches,$width_mm,$color_id,$thick);
				...
				if(isset($production_entry_dam_product_detail_id[$i]) && (!empty($production_entry_dam_product_detail_id[$i]))) {
					...
					$update_production_entry_dam_product_detail = sprintf("	UPDATE 
																		...
																		WHERE 
																			...
																			//echo $update_production_entry_dam_product_detail;exit;
...

   {
		...
		$production_entry_id 			= getId('production_entry', 'production_entry_id', 'production_entry_uniq_id', dataValidation($_GET['production_entry_uniq_id'])); 
			 ...
			 $update_cs_detail 	= "UPDATE  stock_ledger
									...
									WHERE               
											stock_ledger_entry_type             	= 'production-entry-raw' 										AND
											stock_ledger_entry_id					= '".$production_entry_id."'											AND
	...
	function deleteInventoryrequest(){
		...
		deleteUniqRecords('production_entry', 'production_entry_deleted_by', 'production_entry_deleted_on' , 'production_entry_deleted_ip','production_entry_deleted_status', 'production_entry_id', 'production_entry_uniq_id', '1');
				...
				{ 
					...
					$production_entry_id 			= getId('production_entry', 'production_entry_id', 'production_entry_uniq_id', $deleteCheck); 
					 ...
					 while($record_prn_detal = mysql_fetch_array($result_prn_detal)){
					     $update_cs_detail 	= "UPDATE  stock_ledger
												...
												WHERE               
														...
														stock_ledger_entry_id					= '".$production_entry_id."'											AND
														stock_ledger_entry_detail_id			= '".$record_prn_detal['production_entry_product_detail_id']."'";
							mysql_query($update_cs_detail);
					 }
					 ...
					 while($resultChData = mysql_fetch_array($result_grn_ch_detal)){
					     $update_cs_detail 	= "UPDATE  stock_ledger
												...
												WHERE               
														stock_ledger_entry_type             	= 'production-entry-raw' 										AND
														stock_ledger_entry_id					= '".$production_entry_id."'									AND
														stock_ledger_entry_detail_id			= '".$resultChData['production_entry_raw_product_detail_id']."'";
							mysql_query($update_cs_detail);
					 }
				}
