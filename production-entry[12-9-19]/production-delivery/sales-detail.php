		 ...
		 $select_production_entry		=	"SELECT 
											...
											LEFT JOIN 
												(SELECT 
													...
													SUM(production_entry_product_detail_qty) AS inv_qty 
												FROM 
											...
											ON 
											 ...
											 LEFT JOIN 
												(SELECT pdo_entry_product_detail_production_entry_id, 
												SUM(pdo_entry_product_detail_qty) AS pdo_qty FROM pdo_entry_product_details
												WHERE pdo_entry_product_detail_deleted_status = 0 
												GROUP BY pdo_entry_product_detail_production_entry_id) pdo_table ON
												pdo_entry_product_detail_production_entry_id =	production_entry_id
