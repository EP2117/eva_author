...
<?php
	...
	$gin_type		= $_REQUEST['gin_type'];
	 $select_gin_entry		=	"SELECT 
										...
										ON 
											grn_entry_product_detail_gin_entry_id 						= gin_entry_id																		 										WHERE 
...
?>
		...
		?>
					...
					<tr class="odd gradeX">
						...
						<input type="hidden" name="gin_entry_type" id="gin_entry_type<?php echo $record_gin_entry['gin_entry_id'];?>" value="<?=$arr_producton_type[$record_gin_entry['gin_entry_type']]?>" >
						...
						<td><?=$arrQuotationType[$record_gin_entry['gin_entry_type_id']]?></td>
