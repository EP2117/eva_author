							...
							<div class="panel-body">
								...
								<table class="table table-striped table-bordered table-hover" style=" width:100%" >
									...
									<tr>
										...
										<td class="form-group"><select class='form-control' required name='advance_entry_acc_bank_id' id='advance_entry_acc_bank_id'><option value=''>--Select--</option></select></td>
									</tr>
					...
					<div class="col-md-12">
						...
						<div class="panel panel-info">
							...
							<tr>
								...
								<td><input class="form-control" type="text"  name="advance_entry_product_detail_qty[]" id="advance_entry_product_detail_qty<?=$row_cnt; ?>" onBlur="GetTotalLength(<?=$row_cnt; ?>)"  onBlur="GetTotalLength(3,<?=$row_cnt; ?>),discountPerFind(<?=$row_cnt; ?>);"  value="<?=round($get_product_detail['advance_entry_product_detail_qty'])?>" /></td> 
								...
								<table class="table table-striped table-bordered table-hover" style=" width:100%" >
									...
									<tr>
										...
										<td><select class='form-control' name='advance_entry_acc_bank_id' id='advance_entry_acc_bank_id'>
										    <option value=''>--Select--</option>
										    <?php foreach(bank() as $get_value){?>
												<option value='<?= $get_value['account_sub_id'];?>' <?php if($advance_entry_edit['advance_entry_acc_bank_id']==$advance_entry_edit['account_sub_id']){echo 'selected="selected"';}?>><?= $advance_entry_edit['account_sub_name'];?></option>
											<?php }?>
										    </select></td>
									</tr>
