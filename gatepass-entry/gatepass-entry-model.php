...
$gatepass_entry_product_detail_s_weight_inches   			= isset($_POST['gatepass_entry_product_detail_s_weight_inches'])?$_POST['gatepass_entry_product_detail_s_weight_inches']:'';
		...
		$gatepass_entry_product_detail_sale_by			= isset($_POST['gatepass_entry_product_detail_sale_by'])?$_POST['gatepass_entry_product_detail_sale_by']:'';
		...
		for($i = 0; $i < count($gatepass_entry_product_detail_product_id); $i++) { 
			...
			if($gatepass_entry_product_detail_sale_by[$i] == "QTY") {
				$gatepass_entry_product_detail_qty_val 	= $gatepass_entry_product_detail_qty[$i];
				$gatepass_entry_product_detail_sale_feet_val = '';
			}else if($gatepass_entry_product_detail_sale_by[$i] == "FEET"){
				$gatepass_entry_product_detail_qty_val 	= '';
				$gatepass_entry_product_detail_sale_feet_val = $gatepass_entry_product_detail_qty[$i];
			}else{
				$gatepass_entry_product_detail_qty_val 	= $gatepass_entry_product_detail_qty[$i];
				$gatepass_entry_product_detail_sale_feet_val = '';
			}
			...
			if($detail_request_fields) {
				...
				$insert_gatepass_entry_product_detail 		= sprintf("INSERT INTO gatepass_entry_product_details 
																				(gatepass_entry_product_detail_uniq_id,gatepass_entry_product_detail_gatepass_entry_id,
																				 ...
																				 gatepass_entry_product_detail_sale_by,
																				 gatepass_entry_product_detail_sale_feet) 
																	VALUES     ('%s', '%d', 
																				'%d', 
																				'%d', '%d', 
																				'%f', '%f',
																		 ...
																		 $gatepass_entry_product_detail_qty_val,$gatepass_entry_product_detail_tot_length[$i],
																		 ...
																		 $gatepass_entry_product_detail_sale_by[$i],
																		 $gatepass_entry_product_detail_sale_feet_val);
	...
	function listQuotation(){
		...
		if(!empty($_REQUEST['search_branch_id'])){
			$where	.=" AND gatepass_entry_branch_id = '".$_REQUEST['search_branch_id']."'";
		}
		...
		{
		$where.="AND gatepass_entry_customer_id ='".$_REQUEST['customerid']."'";
		}
		$select_gatepass_entry		=	"SELECT 
											 ...
											 WHERE 
												...
												gatepass_entry_deleted_status 	= 	0  $where
				...
				if(isset($gatepass_entry_product_detail_id[$i]) && (!empty($gatepass_entry_product_detail_id[$i]))) {
					 $update_gatepass_entry_product_detail = sprintf("UPDATE 
																		...
																		SET  
																			...
																			gatepass_entry_product_detail_sale_by 					= '%s',
																			gatepass_entry_product_detail_sale_feet 				= '%f'
																		WHERE 
