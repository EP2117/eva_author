							...
							<div class="panel-body">
								 ...
								 <table class="table table-striped table-bordered table-hover" id="product_detail_rls"  style="width:100%;display:none" > <!--display:none-->
									...
									<?php 
										...
										<tr class="rls" ><!--style="display:none"-->
											...
											<input type="hidden"  name="gatepass_entry_product_detail_sale_by[]" id="gatepass_entry_product_detail_sale_by<?=$row_cnt?>" value="<?=$get_product_detail['gatepass_entry_product_detail_sale_by']?>" />
											
											<input type="hidden"  name="gatepass_entry_product_detail_id[]" id="gatepass_entry_product_detail_id" value="<?=$get_product_detail['gatepass_entry_product_detail_id']?>" /></td> 
											<td><?=$product_name?> 
                                ...
                                <table class="table table-striped table-bordered table-hover" id="product_detail_as"  style="width:100%;display:none" ><!--display:none-->
									...
									<?php 
										...
										<td><input class="form-control" style="display:inline-block;width:20%" type="text"  name="gatepass_entry_product_detail_sale_by[]" id="gatepass_entry_product_detail_sale_by<?=$row_cnt?>" value="<?php echo $get_product_detail['gatepass_entry_product_detail_sale_by'] == 'FEET' ? 'FEET' : 'QTY'; ?>" readonly  />&nbsp;&nbsp;&nbsp;<input class="form-control" type="text"  name="gatepass_entry_product_detail_qty[]" id="gatepass_entry_product_detail_qty<?=$row_cnt?>" value="<?=$get_product_detail['gatepass_entry_product_detail_sale_by'] == 'FEET' ? $get_product_detail['gatepass_entry_product_detail_sale_feet'] : $get_product_detail['gatepass_entry_product_detail_qty'];?>" style="display:inline-block;width:60%" readonly /></td>
