...
<body >
   ...
   <tr>
	...
	<tr>
 	 <td width="100%" colspan="4" class="report-border-bottom" style='text-align:center;font-weight:bold;font-size:16px;padding:10px;' > GATEPASS </td>
	</tr>
   <tr>
	  <td width="50%" colspan="2" class="report-border-right report-border-bottom" style='text-align:left;font-weight:bold;font-size:13px;' >DELIVERY CUSTOMER NO : &nbsp;<?=$invoice_entry_edit['delivery_customer_no']?></td>
	 <td width="50%" colspan="2" class="report-border-right report-border-bottom" style='text-align:right;font-weight:bold;font-size:13px;' > DELIVERY CUSTOMER DATE : <?=dateGeneralFormatN($invoice_entry_edit['delivery_customer_date'])?></td>
	</tr>
	<tr>
...
<?php
	...
	if($getDetail['gatepass_entry_product_detail_entry_type']==1){
 ...
 <?php }?>
			<tr>
				...
				<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					<?=$arr_thick[$getDetail['gatepass_entry_product_detail_product_thick']]?> </td>
				<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					<?=number_format($getDetail['gatepass_entry_product_detail_sl_feet'],2,'.','')?> </td>
					<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					<?=number_format($getDetail['gatepass_entry_product_detail_sl_feet_in'],3,'.','')?> </td>
					<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					<?=number_format($getDetail['gatepass_entry_product_detail_sl_feet_mm'],3,'.','')?> </td>
					<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					<?=number_format($getDetail['gatepass_entry_product_detail_sl_feet_met'],3,'.','')?> </td>
				<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					<?=number_format($getDetail['gatepass_entry_product_detail_qty'],3,'.','')?> </td>
				<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
				<?=number_format($getDetail['gatepass_entry_product_detail_tot_length'],2,'.','')?> </td>
...
if($invoice_entry_prd_edit){?>
	...
	if($getDetail['gatepass_entry_product_detail_entry_type']==2){
 ...
 ?>	
			...
			<tr>
				  <td colspan="4" class="report-border-bottom report-border-right" style='text-align:center;font-weight:bold;font-size:13px;' >&nbsp; </td>
				  <td colspan="2" class="report-border-bottom report-border-right" style='text-align:center;font-weight:bold;font-size:13px;' >WIDTH </td>
 ...
 <?php }?>
			<tr>
				...
				<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					<?=$arr_thick[$getDetail['gatepass_entry_product_detail_product_thick']]?> </td>
				<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					<?=number_format($getDetail['gatepass_entry_product_detail_s_width_inches'],2,'.','')?> </td>
					<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					<?=number_format($getDetail['gatepass_entry_product_detail_s_width_mm'],3,'.','')?> </td>
					<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					<?=number_format($getDetail['gatepass_entry_product_detail_s_weight_inches'],3,'.','')?> </td>
					<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					<?=number_format($getDetail['gatepass_entry_product_detail_s_weight_mm'],3,'.','')?> </td>
...
if($invoice_entry_prd_edit){?>
	...
	if($getDetail['gatepass_entry_product_detail_entry_type']==4){
 ...
 <?php }?>
			<tr>
				...
				<?php
					if($getDetail['gatepass_entry_product_detail_sale_by'] == "FEET") {
						echo round($getDetail['gatepass_entry_product_detail_sale_feet'])."'";
					} 
				?>
				</td>
				<td class="report-border-right report-border-bottom" style='text-align:center;font-size:11px;' > 
					<?php
					  if($getDetail['gatepass_entry_product_detail_qty'] == 0) {
						echo '';
					  } else {
						echo round($getDetail['gatepass_entry_product_detail_qty']);
					  }
					?>
				</td>
