...
function AddproductDetail(){
	...
	for (var i = 0; i < x.length; i++) {
		if (x[i].checked ==true) {
			...
			apnd	+= '<tr><td>'+product_name+'<input type="hidden"  name="gatepass_entry_product_detail_product_is_opp[]" id="gatepass_entry_product_detail_product_is_opp'+row_cnt+'" value="'+product_is_opp+'" /><input type="hidden"  name="gatepass_entry_product_detail_product_id[]" id="gatepass_entry_product_detail_product_id" value="'+product_id+'" /><input type="hidden"  name="gatepass_entry_product_detail_product_type[]" id="gatepass_entry_product_detail_product_type" value="1" /><input type="hidden"  name="gatepass_entry_product_detail_delivery_detail_id[]" id="gatepass_entry_product_detail_delivery_detail_id" value="'+detail_id+'" /><input type="hidden"  name="gatepass_entry_product_detail_entry_type[]" id="gatepass_entry_product_detail_entry_type" value="'+t_id+'" /></td>';
			
			apnd	+= '<td>'+product_uom+'</td>';
			
			if(product_sale_by == "QTY") {
				apnd	+= '<td><input class="form-control" style="display:inline-block;width:20%" type="text"  name="gatepass_entry_product_detail_sale_by[]" id="gatepass_entry_product_detail_sale_by'+row_cnt+'" value="QTY" readonly  />&nbsp;&nbsp;&nbsp;<input class="form-control" style="display:inline-block;width:60%" type="text"  name="gatepass_entry_product_detail_qty[]" id="gatepass_entry_product_detail_qty'+row_cnt+'" value="'+product_qty+'" readonly  /></td></tr>';
			} else {
				apnd	+= '<td><input class="form-control" style="display:inline-block;width:20%" type="text"  name="gatepass_entry_product_detail_sale_by[]" id="gatepass_entry_product_detail_sale_by'+row_cnt+'" value="FEET" readonly  />&nbsp;&nbsp;&nbsp;<input class="form-control" style="display:inline-block;width:60%" type="text"  name="gatepass_entry_product_detail_qty[]" id="gatepass_entry_product_detail_qty'+row_cnt+'" value="'+product_sale_feet+'" readonly  /></td></tr>';
			}
