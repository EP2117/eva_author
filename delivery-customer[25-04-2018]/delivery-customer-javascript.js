	...
	for (var i = 0; i < document.getElementById('so_list_form').elements.length; i++) {
		...
		if (document.getElementById('so_list_form').elements[i].checked ==true) {
			...
			var row_cnt     			= parseFloat(table.rows.length)-1;	
				...
				"<tr><td>"+invoice_entry_no+"</td><td>"+invoice_entry_date+"<input type='hidden'  name='delivery_customer_invoice_entry_id' id='delivery_customer_invoice_entry_id' value='"+invoice_entry_id+"'  class='dc_id'  /><input type='hidden'  name='delivery_customer_type_id' id='delivery_customer_type_id' value=''  class='dc_id'  /></tr>");
...
function AddproductDetail(){
	...
	for (var i = 0; i < x.length; i++) {
		if (x[i].checked ==true) {
			...
			apnd	+= '<tr><td>'+product_brand_name+'</td><td>'+product_name+'<input type="hidden"  name="delivery_customer_product_detail_product_id[]" id="delivery_customer_product_detail_product_id" value="'+product_id+'" /><input type="hidden"  name="delivery_customer_product_detail_product_type[]" id="delivery_customer_product_detail_product_type" value="2" /><input type="hidden"  name="delivery_customer_product_detail_invoice_detail_id[]" id="delivery_customer_product_detail_invoice_detail_id" value="'+detail_id+'" /><input type="hidden"  name="delivery_customer_product_detail_entry_type[]" id="delivery_customer_product_detail_entry_type" value="'+t_id+'" /></td>';
			...
			apnd	+= '<td><input class="form-control" type="text"  name="delivery_customer_product_detail_s_width_inches[]" id="delivery_customer_product_detail_s_width_inches'+row_cnt+'"   onkeyup="GetLcalS(2,'+row_cnt+')" onBlur="GetTotalLength('+row_cnt+')" value="'+product_s_width_inches+'" /></td> <td><input class="form-control" type="text"  name="delivery_customer_product_detail_s_width_mm[]" id="delivery_customer_product_detail_s_width_mm'+row_cnt+'" onkeyup="GetLcalS(3,'+row_cnt+')" onBlur="GetTotalLength('+row_cnt+')" value="'+product_s_width_mm+'" /><input type="hidden"  name="delivery_customer_product_detail_qty[]" id="delivery_customer_product_detail_qty'+row_cnt+'"  value="" /></td>';
			
			apnd	+= '<td><input class="form-control" type="text"  name="delivery_customer_product_detail_s_weight_inches[]" id="delivery_customer_product_detail_s_weight_inches'+row_cnt+'"  onblur="GetWeightClc(1,'+row_cnt+')"   value="'+product_s_weight_inches+'"   /></td> <td><input class="form-control" type="text"  name="delivery_customer_product_detail_s_weight_mm[]" id="delivery_customer_product_detail_s_weight_mm'+row_cnt+'"  onblur="GetWeightClc(2,'+row_cnt+')"  value="'+product_s_weight_mm+'"   /></td>';
			
			$("#product_detail_rws_display").append(apnd);	
			var typ_t	= typ_t+t_id+",";	
			}else{ 
			
			apnd	+= '<tr><td>'+product_name+'<input type="hidden"  name="delivery_customer_product_detail_product_id[]" id="delivery_customer_product_detail_product_id" value="'+product_id+'" /><input type="hidden"  name="delivery_customer_product_detail_product_type[]" id="delivery_customer_product_detail_product_type" value="1" /><input type="hidden"  name="delivery_customer_product_detail_invoice_detail_id[]" id="delivery_customer_product_detail_invoice_detail_id" value="'+detail_id+'" /><input type="hidden"  name="delivery_customer_product_detail_entry_type[]" id="delivery_customer_product_detail_entry_type" value="'+t_id+'" /></td>';
...
function GetLcalFeet(calculation_id,id){
	if(calculation_id==1){
		...
		//var calc_amount 	= document.getElementById('delivery_customer_product_detail_length_meter'+id).value;	
