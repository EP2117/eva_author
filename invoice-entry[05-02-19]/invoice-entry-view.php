							...
							<div class="panel-body">
								...
								<table class="table table-striped table-bordered table-hover" style=" width:100%" >
									...
									<tr>
										<td style="width:50%">&nbsp;</td>
										<td colspan="2">Total</td>
										<td><input type="text" class="form-control" name="invoice_entry_total_amount" id="invoice_entry_total_amount" value="<?=number_format($invoice_entry_edit['invoice_entry_total_amount'])?>"  ></td>
									</tr>
									<tr>
										<td style="width:50%">&nbsp;</td>
										<td colspan="2">Advance</td>
