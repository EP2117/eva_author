...
?>
			...
			<tr class="odd gradeX">
				...
				<input type="hidden" name="product_type" id="product_type<?php echo $record_so_detail['gin_entry_product_detail_id'];?>1" value="<?php echo $record_so_detail['gin_entry_product_detail_product_type']; ?>" />
                ...
                <input type="hidden" name="mother_child_type" id="mother_child_type<?php echo $record_so_detail['gin_entry_product_detail_id'];?>1" value="<?=$record_so_detail1['gin_entry_product_detail_mother_child_type']?>" />
				</td>
...
$select_product 			= "	SELECT  
	...
	?>
    	...
    	<tr class="odd gradeX">
				...
				<input type="hidden" name="product_type" id="product_type<?php echo $record_so_detail1['gin_entry_product_detail_id'];?>2" value="<?php echo $record_so_detail1['gin_entry_product_detail_product_type']; ?>" />
