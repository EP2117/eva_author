   	...
   	if($m_id == '') {
   		...
   		$m_id = '""';
   		  ...
   		  $select_product 			= "	SELECT  
										...
										LEFT JOIN 
											(SELECT 
												pdo_entry_product_detail_production_detail_id	, 
												SUM(pdo_entry_product_detail_qty+pdo_entry_product_detail_s_weight_inches) AS inv_qty 
											FROM 
												pdo_entry_product_details  	
											WHERE 
												pdo_entry_product_detail_deleted_status 				= 0  					
											GROUP BY 
												pdo_entry_product_detail_production_detail_id	) inv_table 
										ON 
											 	pdo_entry_product_detail_production_detail_id 			= production_entry_product_detail_id		
...
?>
			...
			<tr class="odd gradeX">
				<td>
				<input type="checkbox" name="production_entry_product_detail_id[]" id="production_entry_product_detail_id<?php echo $record_so_detail['production_entry_product_detail_id'];?>" value="<?php echo $record_so_detail['production_entry_product_detail_id']; ?>" />
