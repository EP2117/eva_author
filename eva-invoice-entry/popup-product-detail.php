...
?>
			...
			<tr class="odd gradeX">
				...
				<input type="hidden" name="pRp_feet_per_qty" id="pRp_feet_per_qty<?php echo $record_so_detail['purOrdPorductId'];?>1" value="<?php echo $record_so_detail['pRp_feet_per_qty']; ?>" >
