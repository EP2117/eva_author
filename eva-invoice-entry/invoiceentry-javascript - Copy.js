...
function AddproductDetail(){
	...
	for (var i = 1; i <= x.length; i++) {
		if (x[i-1].checked ==true) {
			var ord_id 					=  x[i-1].value;
			...
			//var i=k-1;
				apnd += '<tr>';
				apnd += '<td><input type="hidden" name="arr_count[]" value="'+i+'"><input type="hidden" name="pid_'+i+'" value=""> <input type="hidden" name="pid_'+i+'" class="sd_id" value=""><input type="hidden" name="productid'+i+'" id="productid_'+i+'"  value='+product_id+' class="pd_id">'+product_name+'-'+product_code+'</td>';
				apnd += '<td>'+product_uom+'</td>';
				apnd += '<td>'+brand_name+'</td>';
				apnd += '<td><input type="text" class="form-control" name="po_qty_'+i+'" id="po_qty_'+i+'" value='+pRp_qty+' readonly></td>';
				apnd += '<td><input type="text" readonly class="form-control" style="text-align:right;" name="rate_'+i+'" id="rate_'+i+'" value='+pRp_rate+'></td>';
				apnd += '<td><input type="text" readonly class="form-control" style="text-align:right;"  name="frgn_rate_'+i+'" id="frgn_rate_'+i+'" value='+pRp_frignrate+' ></td>';				
				apnd += '<td><input type="text" readonly class="form-control" style="text-align:right;" name="prd_ton_'+i+'" id="prd_ton_'+i+'" value='+pRp_ton+'></td>';
				apnd += '<td><input type="text" readonly class="form-control" style="text-align:right;"  name="prd_kg_'+i+'" id="prd_kg_'+i+'" value='+pRp_kg+' ></td>';
				
				apnd += '<td><input type="text"  class="form-control" style="text-align:right;" name="prd_loss_ton_'+i+'" id="prd_loss_ton_'+i+'" onBlur="ton_calculation('+i+',1),GetLossamt('+i+');" ></td>';
				apnd += '<td><input type="text"  class="form-control" style="text-align:right;"  name="prd_loss_kg_'+i+'" id="prd_loss_kg_'+i+'"  onBlur="ton_calculation('+i+',2);" ></td>';
                apnd += '<td><input type="text"  class="form-control" style="text-align:right;" name="prd_total_ton_'+i+'" id="prd_total_ton_'+i+'"  readonly ></td>';
				apnd += '<td><input type="text"  class="form-control" style="text-align:right;"  name="prd_total_kg_'+i+'" id="prd_total_kg_'+i+'"  readonly ></td>';
				apnd += '<td><input type="text"  class="form-control" style="text-align:right;"  name="prd_loss_amount_'+i+'" id="prd_loss_amount_'+i+'"  ></td>';
				
				apnd += '<td><input type="text" class="form-control" style="text-align:right;" name="dispercent_'+i+'" id="dispercent_'+i+'" onkeyup="return discountcalulation('+i+');"></td>';
				apnd += '<td><input type="text" class="form-control" style="text-align:right;" name="disamnt_'+i+'" id="disamnt_'+i+'" onChange="return discountcalulation(this.value,this,'+i+',2);" readonly=""><input type="hidden" class="form-control discount_amt" style="text-align:right;" name="discount_'+i+'" id="discount_'+i+'"></td>';
				apnd += '<td><input type="text" class="form-control" style="text-align:right;" name="disamnt_cur_'+i+'" id="disamnt_cur_'+i+'" onChange="return discountcalulation(this.value,this,'+i+',2);" readonly=""><input type="hidden" class="form-control discount_cur_amt" style="text-align:right;" name="discount_cur_'+i+'" id="discount_cur_'+i+'"></td>';
				apnd += '<td><input type="text" class="form-control unit_amount" style="text-align:right;" name="total_amt_'+i+'" id="total_amt_'+i+'"  readonly value="'+total_amt+'"></td>';
				apnd += '<td><input type="text" class="form-control unit_amnt" style="text-align:right;" name="total_'+i+'" id="total_'+i+'"  readonly value='+pRp_unitprice+'></td>';
				apnd += '<td><input type="'+text+'" class="form-control rec_qty" style="text-align:right;" name="receive_qty_'+i+'" id="receive_qty_'+i+'" onBlur="get_product_con_detail('+i+','+pRp_rate+')"></td>';
