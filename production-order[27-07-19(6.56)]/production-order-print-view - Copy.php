  ...
  <tr>
   ...
   <tr>
	...
	<tr>	 
	 ...
	 <td colspan="2" class="report-border-right report-border-bottom" style='text-align:left;font-weight:bold;font-size:13px;' >PRODUCTION TYPE : <?=$arr_producton_type[$width_cutting_edit['production_order_order_type']]?></td>
	</tr>
				...
				<td class="report-border-right report-border-bottom" style='text-align:center;font-weight:bold;font-size:11px;'> TOTAl </td>
                                    ...
                                    <tbody id="product_detail_display">
										...
										<tr>
											...
											<td> <?=$arr_thick[number_format($product_thick_ness)]?></td>
											<td><?=$get_product_detail['production_order_product_detail_width_inches']?></td> 
											<td><?=$get_product_detail['production_order_product_detail_width_mm']?></td>
											
											<td><?=$get_product_detail['production_order_product_detail_s_width_inches']?></td> 
											<td><?=$get_product_detail['production_order_product_detail_s_width_mm']?></td>
											
											<td><?=$get_product_detail['production_order_product_detail_sl_feet']?></td> 
											<td><?=$get_product_detail['production_order_product_detail_sl_feet_in']?></td>
											<td><?=$get_product_detail['production_order_product_detail_sl_feet_mm']?></td>
											<td><?=$get_product_detail['production_order_product_detail_sl_feet_met']?></td>
											
											<td><?=$get_product_detail['production_order_product_detail_ext_feet']?></td> 
											<td><?=$get_product_detail['production_order_product_detail_ext_feet_in']?></td>
											<td><?=$get_product_detail['production_order_product_detail_ext_feet_mm']?></td>
											<td><?=$get_product_detail['production_order_product_detail_ext_feet_met']?></td>
											
											<td><?=$get_product_detail['production_order_product_detail_qty']?></td> 
											<td><?=$get_product_detail['production_order_product_detail_tot_length']?></td>
 ...
 <table style="width:100%;font-size:11px; padding-bottom:20px;" cellspacing="0"  class="report-outer-table">
			 <tr>
				<td colspan="21" class="report-border-right report-border-bottom" style='text-align:center;font-weight:bold;font-size:13px;' > Child Product Details </td>
				 ...
				 <thead>
              <tr>
				<td colspan="6" class="report-border-right report-border-bottom" style='text-align:center;font-weight:bold;font-size:11px;'></td>
				<td colspan="2" class="report-border-right report-border-bottom" style='text-align:center;font-weight:bold;font-size:11px;'>LENGTH</td>
				<td colspan="2" class="report-border-right report-border-bottom" style='text-align:center;font-weight:bold;font-size:11px;'>SALES WIDTH</td>
				...
				<td class="report-border-right report-border-bottom" style='text-align:right;font-size:11px;'> 
					<?=$arr_thick[$get_product_detail['production_order_product_detail_product_thick']]?> </td>
				<td class="report-border-right report-border-bottom" style='text-align:right;font-size:11px;'> 
					<?=$get_product_detail['production_order_product_detail_width_inches']?> </td>
				<td class="report-border-right report-border-bottom" style='text-align:right;font-size:11px;'> 
					<?=$get_product_detail['production_order_product_detail_width_mm']?> </td>	
				<td class="report-border-right report-border-bottom" style='text-align:right;font-size:11px;'> 
					<?=$get_product_detail['production_order_product_detail_sl_feet']?> </td>
					<td class="report-border-right report-border-bottom" style='text-align:right;font-size:11px;'> 
					<?=$get_product_detail['production_order_product_detail_sl_feet_in']?> </td>
				<td class="report-border-right report-border-bottom" style='text-align:right;font-size:11px;'> 
					<?=$get_product_detail['production_order_product_detail_sl_feet_mm']?> </td>
					<td class="report-border-right report-border-bottom" style='text-align:right;font-size:11px;'> 
					<?=$get_product_detail['production_order_product_detail_sl_feet_met']?> </td>
				<td class="report-border-right report-border-bottom" style='text-align:right;font-size:11px;'> 
					<?=$get_product_detail['production_order_product_detail_ext_feet']?> </td>
				<td class="report-border-right report-border-bottom" style='text-align:right;font-size:11px;'> 
					<?=$get_product_detail['production_order_product_detail_ext_feet_in']?> </td>	
				<td class="report-border-right report-border-bottom" style='text-align:right;font-size:11px;'> 
					<?=$get_product_detail['production_order_product_detail_ext_feet_mm']?> </td>
					<td class="report-border-right report-border-bottom" style='text-align:right;font-size:11px;'> 
					<?=$get_product_detail['production_order_product_detail_ext_feet_met']?> </td>
				<td class="report-border-right report-border-bottom" style='text-align:right;font-size:11px;'> 
					<?=$get_product_detail['production_order_product_detail_qty']?> </td>
					<td class="report-border-right report-border-bottom" style='text-align:right;font-size:11px;'> 
					<?=$get_product_detail['production_order_product_detail_tot_length']?> </td>
			</tr>
	<?php } }?>
									</tbody>
								</table>
	  ...
	  <tr>
		  <td colspan="13" class="report-border-right report-border-bottom" style='text-align:center;font-weight:bold;font-size:13px;' >Width Cutting 
				...
				<td class="report-border-right report-border-bottom" style='text-align:left;font-size:12px;'> 
					<?=$get_product_detail['product_name']?> </td>
				<td class="report-border-right report-border-bottom" style='text-align:left;font-size:12px;'> 
					<?=$get_product_detail['p_uom_name']?></td>
				<td class="report-border-right report-border-bottom" style='text-align:left;font-size:12px;'> 
					<?=$get_product_detail['production_order_product_detail_qty']?> </td>
