   		...
   		$select_product 			= "	SELECT  
										...
										ON 
										 ...
										 WHERE 
											...
											product_id 							NOT IN (".$m_id.") AND product_brand_id = '".$brand_id."'";
...
?>
			...
			<tr class="odd gradeX">
				...
				<input type="checkbox" name="chk_product_id[]" id="chk_product_id<?php echo $record_so_detail['product_id'];?>1" value="<?php echo $record_so_detail['product_id']; ?>1" />
				...
				<input type="hidden" name="product_type" id="product_type<?php echo $record_so_detail['product_id'];?>1" value="3" >
...
?>
			...
			<tr class="odd gradeX">
				...
				<input type="hidden" name="product_type" id="product_type<?php echo $record_so_detail['product_con_entry_child_product_detail_id'];?>2" value="3" >
				<input type="hidden" name="product_type_id" id="product_type_id<?php echo $record_so_detail['product_con_entry_child_product_detail_id'];?>2" value="<?=$t_id?>" >
