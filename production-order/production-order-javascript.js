...
function GetDetail(t_id){
	...
	var brand_id		= document.getElementById('production_order_brand_id').value;
...
if(t_id !='' && t_id !=0 && brand_id!=''){
	...
	$('#error_msg').html('Please Select the Brand'); 
}
...
function AddproductDetail(){
	for (var i = 0; i < document.getElementById('product_list_form').elements.length; i++) {
		...
		if (document.getElementById('product_list_form').elements[i].checked ==true) {
			...
			var product_brand_id 		= document.getElementById('product_brand_id'+ord_id).value;// alert(product_brand_id);
			...
			var apnd					='';
			if(t_id==1){  
			apnd	+= '<tr><td><input type="hidden"  name="production_order_product_detail_mother_child_type[]" id="production_order_product_detail_mother_child_type'+row_cnt+'" value="'+mother_child_type+'" />'+product_brand_name+'</td><td>'+product_name+'<input type="hidden"  name="production_order_product_detail_product_id[]" id="production_order_product_detail_product_id'+row_cnt+'" value="'+product_id+'" /><input type="hidden"  name="production_order_product_detail_product_brand_id[]" id="production_order_product_detail_product_brand_id'+row_cnt+'" value="'+product_brand_id+'" required /><input type="hidden"  name="production_order_product_detail_product_type[]" id="production_order_product_detail_product_type" value="'+product_type+'" /><input type="hidden"  name="production_order_product_detail_entry_type[]" id="production_order_product_detail_entry_type" value="'+t_id+'" />';
			/*
...
var pr_id=$("#production_order_product_detail_product_id"+id).val();
var child_type=$("#production_order_product_detail_mother_child_type"+id).val();
var thick=$("#production_order_product_detail_product_thick"+id).val();
var brand_id=$("#production_order_product_detail_product_brand_id"+id).val();
var width_inches=$("#production_order_product_detail_width_inches"+id).val();
	...
	if(calculation_id==10){
		...
		var calc_amount 	= document.getElementById('production_order_product_detail_s_weight_inches'+id).value;	
	...
	$.get(
		...
		function(data) {
			...
			if(calculation_id==10){
				...
				document.getElementById('production_order_product_detail_s_weight_inches'+id).value 	= data_t[4];
				document.getElementById('production_order_product_detail_s_weight_mm'+id).value 		= data_t[5];
				
			}
			else if(calculation_id==3){
				document.getElementById('production_order_product_detail_sl_feet'+id).value 			= parseFloat(data_t[0]);
			}else if(calculation_id==9){ 
				document.getElementById('production_order_product_detail_sl_feet'+id).value 		= data_t[2];
				document.getElementById('production_order_product_detail_sl_feet_in'+id).value 		= data_t[3];
				document.getElementById('production_order_product_detail_sl_feet_mm'+id).value 		= data_t[4];
				document.getElementById('production_order_product_detail_sl_feet_met'+id).value 	= data_t[5];
			}
