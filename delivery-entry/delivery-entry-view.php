								...
								<div class="panel-body">
									<div class="col-lg-12">
										<div class="form-group">
											...
											<input type="hidden" class="form-control" name="delivery_entry_no" id="delivery_entry_no"  style="width:460px;" readonly="" required>
										</div>
									</div>
									<div class="col-lg-6">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="product_detail_rls"  style="width:100%;display:none" >
                                    ...
                                    <thead>
										...
										<tr>
											...
											<th>FT.IN</th>
											<th>MM</th>
											<th style="border:solid 1px #ddd;">M</th>
										</tr>
							...
							<div class="panel-body">
								...
								<table class="table table-striped table-bordered table-hover" id="product_detail_rls"  style="width:100%;" ><!--display:none-->
                                    ...
                                    <thead>
                                         ...
                                         <tr>
											...
											<th colspan="2"> WIDTH</th>
											<th colspan="2"> SALES WIDTH</th>
											<th rowspan="2" style="border:solid 1px #ddd;" class="text-center">LENGTH</th>
											<th colspan="4"> SALES LENGTH</th>
											<th rowspan="2" style="vertical-align:middle;">QTY</th>
											<th rowspan="2" style="vertical-align:middle;"> Total Length </th>
									...
									<tr>
										...
										<input type="hidden"  name="delivery_entry_product_detail_sale_by[]" id="delivery_entry_product_detail_sale_by<?=$row_cnt?>" value="<?=$get_product_detail['delivery_entry_product_detail_sale_by']?>" />
										...
										<td><input class="form-control" type="text"  name="delivery_entry_product_detail_width_inches[]" onBlur="GetTotalLength(<?=$row_cnt?>),GetWcalc(2,<?=$row_cnt?>);"  id="delivery_entry_product_detail_width_inches<?=$row_cnt?>" value="<?=$get_product_detail['delivery_entry_product_detail_width_inches']?>" readonly /></td> 
										<td><input class="form-control" type="text"  name="delivery_entry_product_detail_width_mm[]" id="delivery_entry_product_detail_width_mm<?=$row_cnt?>"  onBlur="GetWcalc(3,<?=$row_cnt?>),GetTotalLength(<?=$row_cnt?>)" value="<?=$get_product_detail['delivery_entry_product_detail_width_mm']?>" readonly /></td>
										
										<td><input class="form-control" type="text"  name="delivery_entry_product_detail_s_width_inches[]" onBlur="GetWcalS(2,<?=$row_cnt?>),GetTotalLength(<?=$row_cnt?>)"id="delivery_entry_product_detail_s_width_inches<?=$row_cnt?>" value="<?=$get_product_detail['delivery_entry_product_detail_s_width_inches']?>" readonly /></td> 
										<td><input class="form-control" type="text"  name="delivery_entry_product_detail_s_width_mm[]" id="delivery_entry_product_detail_s_width_mm<?=$row_cnt?>" onBlur="GetWcalS(3,<?=$row_cnt?>),GetTotalLength(<?=$row_cnt?>)" value="<?=$get_product_detail['delivery_entry_product_detail_s_width_mm']?>" readonly /></td>
										
										<td><input class="form-control" type="text"  name="delivery_entry_product_detail_sale_length[]" id="delivery_entry_product_detail_sale_length<?=$row_cnt?>" value="<?php echo htmlspecialchars($get_product_detail['delivery_entry_product_detail_sale_length'])?>" readonly /></td>
										
										<td><input class="form-control" type="text"  name="delivery_entry_product_detail_sl_feet[]" id="delivery_entry_product_detail_sl_feet<?=$row_cnt?>" onblur="GetLcalFeet(1,<?=$row_cnt?>)"  onBlur="GetTotalLength(<?=$row_cnt?>)" value="<?=$get_product_detail['delivery_entry_product_detail_sl_feet']?>" readonly /></td> 
										<td><input class="form-control" type="text"  name="delivery_entry_product_detail_sl_feet_in[]" id="delivery_entry_product_detail_sl_feet_in<?=$row_cnt?>" onblur="GetLcalFeet(1,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)"  value="<?=$get_product_detail['delivery_entry_product_detail_sl_feet_in']?>"  readonly /></td>
										<td><input class="form-control" type="text"  name="delivery_entry_product_detail_sl_feet_mm[]" id="delivery_entry_product_detail_sl_feet_mm<?=$row_cnt?>" onblur="GetLcalFeet(3,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" value="<?=$get_product_detail['delivery_entry_product_detail_sl_feet_mm']?>" readonly /></td>
										<td><input class="form-control" type="text"  name="delivery_entry_product_detail_sl_feet_met[]" onblur="GetLcalFeet(3,<?=$row_cnt?>)" id="delivery_entry_product_detail_sl_feet_met<?=$row_cnt?>"  onBlur="GetTotalLength(<?=$row_cnt?>)" value="<?=$get_product_detail['delivery_entry_product_detail_sl_feet_met']?>" readonly />
										...
										<td><input class="form-control" type="text"  name="delivery_entry_product_detail_qty[]" id="delivery_entry_product_detail_qty<?=$row_cnt?>"  value="<?=$get_product_detail['delivery_entry_product_detail_qty']?>" onBlur="GetTotalLength(<?=$row_cnt?>)"  readonly /></td>
										<td><input class="form-control" type="text"  name="delivery_entry_product_detail_tot_length[]" id="delivery_entry_product_detail_tot_length<?=$row_cnt?>"  value="<?=$get_product_detail['delivery_entry_product_detail_tot_length']?>"  readonly/></td>
								...
								<table class="table table-striped table-bordered table-hover" id="product_detail_rws"  style="width:100%;" ><!--display:none-->
									...
									<tr>
										...
										<td><input class="form-control" type="text"  name="delivery_entry_product_detail_width_inches[]" id="delivery_entry_product_detail_width_inches<?=$row_cnt?>"  onBlur="GetWcalc(2,<?=$row_cnt?>)" value="<?=$get_product_detail['delivery_entry_product_detail_width_inches']?>" readonly /></td> 
										<td><input class="form-control" type="text"  name="delivery_entry_product_detail_width_mm[]" id="delivery_entry_product_detail_width_mm<?=$row_cnt?>"   onBlur="GetWcalc(3,<?=$row_cnt?>)" value="<?=$get_product_detail['delivery_entry_product_detail_width_mm']?>" readonly /></td>
										
										
										
										<td><input class="form-control" type="text"  name="delivery_entry_product_detail_s_width_inches[]" id="delivery_entry_product_detail_s_width_inches<?=$row_cnt?>"   onBlur="GetWcalS(2,<?=$row_cnt?>)"  value="<?=$get_product_detail['delivery_entry_product_detail_s_width_inches']?>" readonly /></td> 
										<td><input class="form-control" type="text"  name="delivery_entry_product_detail_s_width_mm[]" id="delivery_entry_product_detail_s_width_mm<?=$row_cnt?>" onBlur="GetWcalS(3,<?=$row_cnt?>)" value="<?=$get_product_detail['delivery_entry_product_detail_s_width_mm']?>" readonly />
										...
										<td><input class="form-control" type="text"  name="delivery_entry_product_detail_s_weight_inches[]" id="delivery_entry_product_detail_s_weight_inches<?=$row_cnt?>"  onblur="GetWeightClc(1,<?=$row_cnt?>)"   value="<?=$get_product_detail['delivery_entry_product_detail_s_weight_inches']?>" readonly /></td> 
										<td><input class="form-control" type="text"  name="delivery_entry_product_detail_s_weight_mm[]" id="delivery_entry_product_detail_s_weight_mm<?=$row_cnt?>"  onblur="GetWeightClc(1,<?=$row_cnt?>)"  value="<?=$get_product_detail['delivery_entry_product_detail_s_weight_mm']?>" readonly /></td>
								...
								<table class="table table-striped table-bordered table-hover" id="product_detail_as"  style="width:100%;" >
									...
									<tr>
										...
										<td><input class="form-control" style="display:inline-block;width:20%" type="text"  name="delivery_entry_product_detail_sale_by[]" id="delivery_entry_product_detail_sale_by<?=$row_cnt?>" value="<?php echo $get_product_detail['delivery_entry_product_detail_sale_by'] == 'FEET' ? 'FEET' : 'QTY'; ?>" readonly  />&nbsp;&nbsp;&nbsp;<input class="form-control" type="text"  name="delivery_entry_product_detail_qty[]" id="delivery_entry_product_detail_qty<?=$row_cnt?>" value="<?=$get_product_detail['delivery_entry_product_detail_sale_by'] == 'FEET' ? $get_product_detail['delivery_entry_product_detail_sale_feet'] : $get_product_detail['delivery_entry_product_detail_qty'];?>" style="display:inline-block;width:60%" readonly /></td>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									?>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?=$get_quotation['delivery_entry_no']?></td>
