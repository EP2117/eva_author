	  ...
	  <tr>
		...
		<?php  $k = 1; foreach($invoice_entry_prd_edit as $getDetail){
			...
			<tr>
				...
				<td class="report-border-right report-border-bottom" style='text-align:right;font-size:11px;'> 
					<?=round($getDetail['invoice_entry_product_detail_qty'])?> </td>
					<td class="report-border-right report-border-bottom" style='text-align:right;font-size:11px;'> 
					<?=number_format($getDetail['invoice_entry_product_detail_tot_length'],2,'.','')?> </td>
				<td class="report-border-right report-border-bottom" style='text-align:right;font-size:11px;'> 
					<?=round($getDetail['invoice_entry_product_detail_rate'])?> </td>
				<td class="report-border-right report-border-bottom" style='text-align:right;font-size:11px;'> 
					<?= round($getDetail['invoice_entry_product_detail_total'])?> </td>
			</tr>
...
<table style="width:100%;font-size:11px;" cellspacing="0"  class="report-outer-table">
	<tr>
		<td colspan="2" class="report-border-right" style='text-align:left;font-weight:bold;font-size:11px;width:60%'>Sales Man : </td>
		...
		<td class="report-border-right report-border-bottom" style='text-align:right;font-weight:bold;font-size:11px;width:15%' > <?=round($invoice_entry_edit['invoice_entry_gross_amount'])?> &nbsp;&nbsp;</td>
	</tr>
	<tr>
		...
		<td class="report-border-right report-border-bottom" style='text-align:right;font-weight:bold;font-size:11px;width:15%' > <?=round($invoice_entry_edit['invoice_entry_transport_amount'])?> &nbsp;&nbsp;</td>
	</tr>
<?php	if($invoice_entry_edit['invoice_entry_tax_status']==1){ ?>
	<tr>
		<td colspan="2" class="report-border-right" style='text-align:left;font-weight:bold;font-size:11px;width:60%'>Previous balance : <?= get_pre_bal($invoice_entry_edit['invoice_entry_customer_id'],$invoice_entry_edit['invoice_entry_id']);?></td>
		<td class="report-border-right report-border-bottom" style='text-align:left;font-weight:bold;font-size:11px;width:25%' > Tax : &nbsp;&nbsp;&nbsp;&nbsp; <?=number_format($invoice_entry_edit['invoice_entry_tax_per'])?> % </td>
		<td class="report-border-right report-border-bottom" style='text-align:right;font-weight:bold;font-size:11px;width:15%' > <?=round($invoice_entry_edit['invoice_entry_tax_amount'])?> &nbsp;&nbsp;</td>
	</tr>
<?php } ?>	
      <tr>
		...
		<td class="report-border-right report-border-bottom" style='text-align:right;font-weight:bold;font-size:11px;width:15%'> <?=round($invoice_entry_edit['invoice_entry_total_amount'])?> &nbsp;&nbsp;</td>
	</tr>
	<tr>
		<td colspan="2" class="report-border-right" style='text-align:left;font-weight:bold;font-size:11px;width:60%'><?php	if($invoice_entry_edit['invoice_entry_tax_status']!=1){ ?> Previous balance : <?php }else{ ?> Delivery date : <?=dateGeneralFormatN($invoice_entry_edit['invoice_entry_validity_date'])?> <?php }?></td>
		...
		<td class="report-border-right report-border-bottom" style='text-align:right;font-weight:bold;font-size:11px;width:15%' > <?=round($invoice_entry_edit['invoice_entry_advance_amount'])?> &nbsp;&nbsp;</td>
	</tr>
	<tr>
		...
		<td class="report-border-right report-border-bottom" style='text-align:right;font-weight:bold;font-size:11px;width:15%'> <?=round($invoice_entry_edit['invoice_entry_dis_amount'])?> &nbsp;&nbsp;</td>
	</tr>
	<tr>
		<td colspan="2" class="report-border-right report-border-bottom" style='text-align:center;font-weight:bold;font-size:11px;width:60%'>  </td>
		<td class="report-border-right report-border-bottom" style='text-align:left;font-weight:bold;font-size:11px;width:25%'> NET </td>
		<td class="report-border-right report-border-bottom" style='text-align:right;font-weight:bold;font-size:11px;width:15%'> <?=round($invoice_entry_edit['invoice_entry_net_amount'])?> &nbsp;&nbsp;</td>
	</tr>
	<tr>
