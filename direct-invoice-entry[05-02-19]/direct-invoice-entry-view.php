...
function placeBank(bank_id){
    ...
    if(bank_id==2){
    	$.get('get_bank.php', {}, function(data) { $('#invoice_entry_acc_bank_id').html( data ); });
    }else{
    	$('invoice_entry_acc_bank_id').val()='';
    }
								...
								<div class="panel-body">
									<div class="col-lg-12">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="invoice_entry_no" id="invoice_entry_no" value="" readonly="" style="width:460px;" >
										</div>
									</div>
									<div class="col-lg-6" >
							...
							<div class="panel-body">
								...
								<table class="table table-striped table-bordered table-hover" style=" width:100%" >
									...
									<tr>
										...
										<td><input type="text" class="form-control" name="invoice_entry_transport_amount" id="invoice_entry_transport_amount" onBlur="totalAmount()" value="0" ></td>
									...
									<tr>
										...
										<td style="width:20%"><input type="text" class="form-control" name="invoice_entry_dis_per" id="invoice_entry_dis_per" onBlur="totalAmount()" value="0"></td>

										<td><input type="text" class="form-control" name="invoice_entry_dis_amount" id="invoice_entry_dis_amount" value="0" onBlur="totalAmount()"  /></td>
									...
									<tr id="tax_details">
										...
										<td style="width:20%"><input type="text" class="form-control" name="invoice_entry_tax_per" id="invoice_entry_tax_per" onBlur="totalAmount()" value="21"  ></td>
									...
									<tr>
										...
										<td><input type="text" class="form-control" name="invoice_entry_advance_amount" id="invoice_entry_advance_amount" onBlur="totalAmount()"  value="0"></td>
									...
									<tr>
										...
										<td><input type="text" class="form-control" name="invoice_entry_net_amount" id="invoice_entry_net_amount"  value="0" ></td>
							...
							<div class="panel-body">
								...
								<table class="table table-striped table-bordered table-hover" id="product_detail_rls"  style="width:100%;display:none"><!--display:none-->
									...
									<?php 
										...
										<input type="hidden"  name="invoice_entry_product_detail_product_brand_id[]" id="invoice_entry_product_detail_product_brand_id" value="<?=$get_product_detail['invoice_entry_product_detail_product_brand_id']?>" />
										...
										<?php }?>
												...
												<input type="hidden"  name="advance_entry_product_detail_product_uom_id[]" id="advance_entry_product_detail_product_uom_id<?=$row_cnt?>" value="<?=$get_product_detail['invoice_entry_product_detail_product_id']?>"   /></td>
										...
										<td><input class="form-control" type="text"  name="invoice_entry_product_detail_width_mm[]" id="invoice_entry_product_detail_width_mm<?=$row_cnt?>"  onBlur="GetTotalLength(<?=$row_cnt?>),GetWcalc(3,<?=$row_cnt?>)" value="<?=$get_product_detail['invoice_entry_product_detail_width_mm']?>"  /></td>
										
										<td><input class="form-control" type="text"  name="invoice_entry_product_detail_s_width_inches[]" id="invoice_entry_product_detail_s_width_inches<?=$row_cnt?>"   onkeyup="GetLcalS(2,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" value="<?=$get_product_detail['invoice_entry_product_detail_s_width_inches']?>"/></td>
										...
										<td><input class="form-control" type="text"  name="invoice_entry_product_detail_qty[]" id="invoice_entry_product_detail_qty<?=$row_cnt?>" onBlur="GetTotalLength(<?=$row_cnt?>)"  onBlur="GetTotalLength(3,<?=$row_cnt?>),discountPerFind(<?=$row_cnt?>);" value="<?=$get_product_detail['invoice_entry_product_detail_qty']?>" /></td> 
								...
								<tr >
									...
									<input type="hidden"  name="invoice_entry_product_detail_id[]" id="invoice_entry_product_detail_id" value="<?=$get_product_detail['invoice_entry_product_detail_id']?>" />
									<input type="hidden"  name="invoice_entry_product_detail_product_id[]" id="invoice_entry_product_detail_product_id" value="<?=$get_product_detail['invoice_entry_product_detail_product_id']?>" />
								<input type="hidden"  name="invoice_entry_product_detail_mas_product_id[]" id="invoice_entry_product_detail_mas_product_id<?=$row_cnt?>" value="<?=$get_product_detail['invoice_entry_product_detail_mas_product_id']?>" /> 
								<input type="hidden"  name="invoice_entry_product_detail_product_brand_id[]" id="invoice_entry_product_detail_product_brand_id" value="<?=$get_product_detail['invoice_entry_product_detail_product_brand_id']?>" />
								<input type="hidden"  name="invoice_entry_product_detail_product_type[]" id="invoice_entry_product_detail_product_type" value="<?=$get_product_detail['invoice_entry_product_detail_product_type']?>" />
								<input type="hidden"  name="invoice_entry_product_detail_entry_type[]" id="invoice_entry_product_detail_entry_type" value="<?=$get_product_detail['invoice_entry_product_detail_entry_type']?>" /></td>
									...
									<?php foreach($arr_thick as $key=>$val){ 
										...
										<td><input class="form-control" type="text"  name="invoice_entry_product_detail_width_inches[]" onBlur="GetWcalc(2,<?=$row_cnt?>)"id="invoice_entry_product_detail_width_inches<?=$row_cnt?>"   value="<?=$get_product_detail['invoice_entry_product_detail_width_inches']?>" /></td> 
								...
								<table class="table table-striped table-bordered table-hover" style=" width:100%" >
									...
									<tr>
										...
										<td style="text-align:right"><input type="text" class="form-control" name="invoice_entry_advance_amount" id="invoice_entry_advance_amount" onBlur="totalAmount()"  value="<?=number_format($invoice_entry_edit['invoice_entry_advance_amount'],0,'.','')?>"/></td>
									...
									<tr>
										...
										<td style="text-align:right;"><input type="text" class="form-control" name="invoice_entry_net_amount" id="invoice_entry_net_amount"   value="<?=number_format($invoice_entry_edit['invoice_entry_net_amount'],0,'.','')?>"/></td>
									...
									<tr>
										...
										<td><select class='form-control' name='invoice_entry_acc_bank_id' id='invoice_entry_acc_bank_id'>
										    ...
										    <?php foreach(bank() as $get_value){?>
												<option value='<?= $get_value['account_sub_id'];?>' <?php if($invoice_entry_edit['invoice_entry_acc_bank_id']==$get_value['account_sub_id']){echo 'selected="selected"';}?>><?= $get_value['account_sub_name'];?></option>
											<?php }?>
										    </select></td>
									</tr>
									<tr>
	                            ...
	                            $status=d_invoice_status($get_invoice['invoice_entry_id']);
									?>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?=$get_invoice['branch_prefix'].$get_invoice['invoice_entry_no']?></td>
											...
											<td><a href="direct-invoice-print.php?id=<?php echo $get_invoice['invoice_entry_uniq_id']?>" title="INVOICE PRINT" class="glyphicon glyphicon-print pull-left" target="_blank" style="color:blue"></a></td>
