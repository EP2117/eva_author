...
?>
<script type="text/javascript" src="<?php echo PROJECT_PATH.'/sales-direct-invoice-date-report/invoice-entry-javascript.js'; ?>"></script>
</head>
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Direct Invoice Report</h1>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-invoice-entry">
                                    <thead>
                                        <tr>
											...
											<th class="text-center">Direct Inv.No.</th>
									...
									?>
										 <tr  class="odd gradeX">
										  ...
										  <td class="text-right"><?php echo number_format($get_value['invoice_entry_total_amount']);?></td>
										</tr>
									<?php
									$qty=$qty+$get_value['invoice_entry_total_amount'];
									 } ?>
										<tr>
