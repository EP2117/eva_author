...
function get_colldis(id){
	...
	total = parseFloat(inv) - (parseFloat(col1) + parseFloat(dis1) ); //alert(dis1);
...
//alert(total_row);
	...
	for(var i=0; i< parseInt(total_row); i++) {
		...
		var total_detail_amt = Number(document.getElementById('collection_entry_detail_amount'+i).value);
		var total_dis_amt =Number( document.getElementById('collection_entry_detail_disc_amount'+i).value);
		...
		sum_val = parseFloat(sum_val)+parseFloat(toal_amount)+parseFloat(total_dis_amt); //alert(sum_val);
