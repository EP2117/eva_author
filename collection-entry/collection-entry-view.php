                                ...
                                <table class="table table-striped table-bordered table-hover" id="so_detail"  style=" width:100%" >
                                    ...
                                    <tbody id="so_detail_display">
										...
										<tr>
											...
											<td><input class="form-control" type="text"  name="collection_entry_detail_invoice_amount[]" id="collection_entry_detail_invoice_amount<?=$row_cnt?>" value="<?=round($get_product_detail['collection_entry_detail_invoice_amount'])?>"  />
...
<input type="hidden"  name="collection_entry_detail_customer_id[]" id="collection_entry_detail_customer_id<?=$row_cnt?>" value="<?=$get_product_detail['invoice_entry_customer_id']?>"  />
											...
											<td><input class="form-control" type="text"  name="collection_entry_detail_paid_amount[]" id="collection_entry_detail_paid_amount<?=$row_cnt?>" value="<?=round($get_product_detail['collection_entry_detail_paid_amount'])?>"   onkeyup="get_coll_amt(<?=$row_cnt?>);get_colldis(<?=$row_cnt?>);" /></td>
											
											<td><input class="form-control" type="text"  name="collection_entry_detail_amount[]" id="collection_entry_detail_amount<?=$row_cnt?>" value="<?=round($get_product_detail['collection_entry_detail_amount'])?>"   onkeyup="get_coll_amt(<?=$row_cnt?>);get_colldis(<?=$row_cnt?>);" /></td>
											
											<td><input class="form-control" type="text"  name="collection_entry_detail_disc_amount[]" id="collection_entry_detail_disc_amount<?=$row_cnt?>" value="<?=round($get_product_detail['collection_entry_detail_disc_amount'])?>"  /></td>
											
											
											<td><input class="form-control" type="text"  name="collection_entry_detail_balance_amount[]" id="collection_entry_detail_balance_amount<?=$row_cnt?>" value="<?=round($get_product_detail['collection_entry_detail_balance_amount'])?>"   /></td>
											...
											<td><?php if($arr_cnt>1) { ?><a href="index.php?product_detail_id=<?=$get_product_detail['collection_entry_detail_id']?>&collection_entry_uniq_id=<?php echo $collection_entry_edit['collection_entry_uniq_id']?>&product_detail_delete=" title="" class="glyphicon glyphicon-trash " style="color:red"></a><?php } ?></td>
								...
								<table class="table table-striped table-bordered table-hover"  style=" width:100%" >
									...
									<tr>
										...
										<input type="text" class="form-control pull-right" name="collection_entry_total_amount" id="collection_entry_total_amount" value="<?=round($collection_entry_edit['collection_entry_total_amount'])?>"   readonly="" >
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									?>
                                        ...
                                        <tr class="odd gradeX">
											...
											<td><?=round($get_so_return['collection_entry_total_amount'])?></td>
