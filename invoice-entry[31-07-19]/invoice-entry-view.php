					...
					<div class="col-md-12">
						...
						<div class="panel panel-info">
							...
							<div class="panel-body">
								...
								<td><input class="form-control" type="text" name="invoice_entry_product_detail_sl_feet_mm[]" id="invoice_entry_product_detail_sl_feet_mm<?=$row_cnt?>" onBlur="GetLcalFeet(3,<?=$row_cnt?>);GetTotalLength(<?=$row_cnt?>);" value="<?=$get_product_detail['invoice_entry_product_detail_sl_feet_mm']?>"  /></td>
								<td><input class="form-control" type="text" name="invoice_entry_product_detail_sl_feet_met[]" id="invoice_entry_product_detail_sl_feet_met<?=$row_cnt?>" onBlur="GetLcalFeet(3,<?=$row_cnt?>);GetTotalLength(<?=$row_cnt?>);" value="<?=$get_product_detail['invoice_entry_product_detail_sl_feet_met']?>"  />
                                ...
                                <td><input class="form-control" type="text"  name="invoice_entry_product_detail_s_weight_met[]" id="invoice_entry_product_detail_s_weight_met<?=$row_cnt?>"  onblur="GetLcalc(4,'+row_cnt+')"  value="<?=$get_product_detail['invoice_entry_product_detail_s_weight_met']?>"  /></td>
                                ...
                                <input class="form-control" type="hidden"  name="invoice_entry_product_detail_sl_feet_mm[]" id="invoice_entry_product_detail_sl_feet_mm<?=$row_cnt?>" value="<?=$get_product_detail['invoice_entry_product_detail_sl_feet_mm']?>"  />
                                <input class="form-control" type="hidden"  name="invoice_entry_product_detail_sl_feet_met[]" id="invoice_entry_product_detail_sl_feet_met<?=$row_cnt?>"  value="<?=$get_product_detail['invoice_entry_product_detail_sl_feet_met']?>" /> 
                                <input class="form-control" type="hidden"  name="invoice_entry_product_detail_sl_feet[]" id="invoice_entry_product_detail_sl_feet<?=$row_cnt?>" value="<?=$get_product_detail['invoice_entry_product_detail_sl_feet']?>"  />
                                <input class="form-control" type="hidden"  name="invoice_entry_product_detail_sl_feet_in[]" id="invoice_entry_product_detail_sl_feet_in<?=$row_cnt?>" value="<?=$get_product_detail['invoice_entry_product_detail_sl_feet_in']?>" />
                                </td>		
								<td><?php if($arr_cnt>1) { ?><a href="index.php?product_detail_id=<?=$get_product_detail['invoice_entry_product_detail_id']?>&invoice_entry_uniq_id=<?php echo $invoice_entry_edit['invoice_entry_uniq_id']?>&product_detail_delete=" title="" class="glyphicon glyphicon-trash " style="color:red"></a><?php } ?></td>
							</tr>
