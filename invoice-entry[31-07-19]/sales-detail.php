...
<?php
	...
	if($entry_type==1){
		$select_quotation_entry		=	"SELECT 
											...
											quotation_entry_net_amount,qta_table.qta_qty,inv_table.inv_qty
									 FROM 
								...
								//	echo $select_quotation_entry;exit;
...
<?php
 ...
 $select_advance_entry		=	"SELECT 
											...
											advance_entry_tax_per,qta_table.qta_qty,inv_table.inv_qty
									 ...
									 ON
										...
										(SELECT 
											advance_entry_product_detail_advance_entry_id, 
											SUM(advance_entry_product_detail_qty+advance_entry_product_detail_s_weight_inches) AS qta_qty 
										FROM 
											advance_entry_product_details  	
										WHERE 
											advance_entry_product_detail_deleted_status 				= 0  					
										GROUP BY 
											advance_entry_product_detail_advance_entry_id) qta_table 
									ON 
										...
										LEFT JOIN 
											...
											WHERE 
												...
												invoice_entry_type											= '2'
												GROUP BY invoice_entry_product_detail_quotation_entry_id) as   inv_table					
										ON 
											inv_table.invoice_entry_product_detail_quotation_entry_id 		= advance_entry_id	
									 WHERE 
