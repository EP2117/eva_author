...
<head>
    ...
    <title>Quotation Product Entry</title>
<?php 
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Quotation Product Report</h1>
                        ...
                        <div class="panel-body">
							...
							<div class="row" style="margin-left:3px;margin-right:3px;">
								...
								<div class="col-lg-4">
									...
									<?php } 
									/*$tot_search_raw=0;
									for($i=0;$i<count($ser_val);$i++){
									$tot_search_raw=$tot_search_raw[$i];
									
									}
									echo $tot_search_raw;exit;*/
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Quotation Product Report Detail
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
								...
								<?php 
								?>
								<table class="table table-striped table-bordered table-hover" id="product_detail_rls" width="100%">
									<?php
                                    ...
                                    <tbody >
										...
										if($product_id!=$get_val['quotation_entry_product_detail_product_id']){
										if($sno!=1){ ?>
										<tr>
										...
										?>
										<tr>
										<td class="text_right"><?php echo $sno++;?></td>	
											<td><?php echo $get_val['quotation_entry_no'];?></td>
											...
											<td class="text-right"><?php echo $arr_thick[$get_val['quotation_entry_product_detail_product_thick']];?></td>
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['quotation_entry_product_detail_s_width_inches']);?></td>
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['quotation_entry_product_detail_s_width_mm']);?></td>
											<!--<td><?php echo $get_val['quotation_entry_product_detail_sl_feet'];?></td>
											<td><?php echo $get_val['quotation_entry_product_detail_sl_feet_met'];?></td>-->
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['quotation_entry_product_detail_s_weight_inches']);?></td>
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['quotation_entry_product_detail_s_weight_mm']); ?></td>
											<td class="text-right"><?php echo round($get_val['quotation_entry_product_detail_s_weight_met']); ?></td>
											<!--<td><?php echo round($get_val['quotation_entry_product_detail_qty']);?></td>-->
											<td class="text-right"><?php echo number_format($get_val['quotation_entry_product_detail_rate']);?></td>
											<td class="text-right"><?php echo number_format($get_val['quotation_entry_product_detail_total']);?></td>
											
										</tr>
										<?php 
										
										$product_id=$get_val['quotation_entry_product_detail_product_id'];
										$subinches=$subinches+$get_val['quotation_entry_product_detail_s_width_inches'];
										$submm = $submm+$get_val['quotation_entry_product_detail_s_width_mm'];
										$subton = $subton+$get_val['quotation_entry_product_detail_s_weight_inches'];
										$subkg = $subkg+$get_val['quotation_entry_product_detail_s_weight_mm'];
										$submet = $submet+$get_val['quotation_entry_product_detail_s_weight_met'];
										$subrate = $subrate+$get_val['quotation_entry_product_detail_rate'];
										$subtotal = $subtotal+$get_val['quotation_entry_product_detail_total'];
										$grandinches=$grandinches+$get_val['quotation_entry_product_detail_s_width_inches'];
										$grandmm = $grandmm+$get_val['quotation_entry_product_detail_s_width_mm'];
										$grandton = $grandton+$get_val['quotation_entry_product_detail_s_weight_inches'];
										$grandkg = $grandkg+$get_val['quotation_entry_product_detail_s_weight_mm'];
										$grandmet = $grandmet+$get_val['quotation_entry_product_detail_s_weight_met'];
										$grandrate = $grandrate+$get_val['quotation_entry_product_detail_rate'];
										$grandtotal = $grandtotal+$get_val['quotation_entry_product_detail_total'];
								...
								?>
									<thead>
                                         ...
                                         <tr>
											...
											<th style="vertical-align:middle;" class="text-center"> QUOTATION NO</th>
                                    ...
                                    <tbody >
										...
										<td class="text-right"><?php echo $sno++;?></td>	
											...
											<td><?php echo $get_val['product_name'];?></td>
											<td><?php echo $get_val['product_uom_name'];?></td>
											<td class="text-right"><?php echo round($get_val['quotation_entry_product_detail_qty']);?></td>
											<td class="text-right"><?php echo number_format($get_val['quotation_entry_product_detail_rate']);?></td>
											<td class="text-right"><?php echo number_format($get_val['quotation_entry_product_detail_total']);?></td>
								...
								?>
                                    ...
                                    <tbody >
										...
										<td class="text-right"><?php echo $sno++;?></td>	
											...
											<!--<td><?php echo $get_val['quotation_entry_product_detail_sl_feet'];?></td>
											<td><?php echo $get_val['quotation_entry_product_detail_sl_feet_met'];?></td>-->
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['quotation_entry_product_detail_sl_feet']);?></td>
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['quotation_entry_product_detail_sl_feet_in']);?></td>
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['quotation_entry_product_detail_sl_feet_mm']); ?></td>
											<td class="text-right"><?php echo round($get_val['quotation_entry_product_detail_sl_feet_met']); ?></td>
											<td class="text-right"><?php echo round($get_val['quotation_entry_product_detail_qty']);?></td>
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['quotation_entry_product_detail_tot_length']);?></td>
											<td class="text-right"><?php echo number_format($get_val['quotation_entry_product_detail_rate']);?></td>
											<td class="text-right"><?php echo number_format($get_val['quotation_entry_product_detail_total']);?></td>
										...
										$product_id=$get_val['quotation_entry_product_detail_product_id'];
										$subqty=$subqty+$get_val['quotation_entry_product_detail_qty'];
										$sublength=$sublength+$get_val['quotation_entry_product_detail_tot_length'];
										$subinches=$subinches+$get_val['quotation_entry_product_detail_s_width_inches'];
										$submm = $submm+$get_val['quotation_entry_product_detail_s_width_mm'];
										$subft = $subft+$get_val['quotation_entry_product_detail_sl_feet'];
										$subftin = $subftin+$get_val['quotation_entry_product_detail_sl_feet_in'];
										$sublmm= $sublmm+$get_val['quotation_entry_product_detail_sl_feet_mm'];
										$submet = $submet+$get_val['quotation_entry_product_detail_sl_feet_met'];
										$subrate = $subrate+$get_val['quotation_entry_product_detail_rate'];
										$subtotal = $subtotal+$get_val['quotation_entry_product_detail_total'];
										$grandinches=$grandinches+$get_val['quotation_entry_product_detail_s_width_inches'];
										$grandmm = $grandmm+$get_val['quotation_entry_product_detail_s_width_mm'];
										$grandft = $grandft+$get_val['quotation_entry_product_detail_sl_feet'];
										$grandftin = $grandftin+$get_val['quotation_entry_product_detail_sl_feet_in'];
										$grandlmm= $grandlmm+$get_val['quotation_entry_product_detail_sl_feet_mm'];
										$grandmet = $grandmet+$get_val['quotation_entry_product_detail_sl_feet_met'];
										$grandrate = $grandrate+$get_val['quotation_entry_product_detail_rate'];
										$grandtotal = $grandtotal+$get_val['quotation_entry_product_detail_total'];
										$grandqty=$grandqty+$get_val['quotation_entry_product_detail_qty'];
										$grandlength=$grandlength+$get_val['quotation_entry_product_detail_tot_length'];
										}?>
										<tr>
											<td colspan="8" class="text-right"> Sub Total</td>
											<td style="text-align:right"><?php //echo number_format($subinches,3,'.','');?></td>
