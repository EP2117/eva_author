...
?>
<script type="text/javascript" src="<?php echo PROJECT_PATH.'/sales-delivery-date-report/sales-delivery-entry-javascript.js'; ?>"></script>
</head>
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Delivery Report</h1>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-invoice-entry">
                                    <thead >
                                        <tr >
											...
											<th style="text-align:center">Delivery Entry No.</th>
									...
									?>
										 <tr  class="odd gradeX">
										  ...
										  <td><?php echo $get_value['delivery_entry_no'];?></td>
										  <td><?php echo dateGeneralFormatN($get_value['delivery_entry_date']);?></td>
										  <td><?php echo $get_value['customer_name']//.'-'.$get_value['customer_code'];?></td>
										
										  <td class="text-right"><?php echo number_format($get_value['delivery_entry_product_detail_qty']);?></td>
										</tr>
									<?php $qty=$qty+$get_value['delivery_entry_product_detail_qty'];} ?>
										<tr>
