							...
							<div class="panel-body">
								...
								<table class="table table-striped table-bordered table-hover" style=" width:100%" >
									...
									<tr>
										...
										<td><input type="text" class="form-control" name="invoice_entry_dis_amount" id="invoice_entry_dis_amount" value="0" ></td>
							...
							<div class="panel-body">
								...
								<table class="table table-striped table-bordered table-hover" style=" width:100%" >
									...
									<tr>
										...
										<td><input type="text" class="form-control" name="invoice_entry_dis_amount" id="invoice_entry_dis_amount" value="<?=$invoice_entry_edit['invoice_entry_dis_amount']?>" ></td>
