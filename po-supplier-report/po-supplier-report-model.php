<?php  
	...
	{
		$where = " WHERE pI_deleted_status =0 AND  pI_company_id = '".$_SESSION[SESS.'_session_company_id']."' AND piP_deleted_status 	= '0' ";
		...
		if(isset($_REQUEST['search_prodcut_id']) && (!empty($_REQUEST['search_prodcut_id']))) {
			$where .= " AND piP_product_id = '".dataValidation($_REQUEST['search_prodcut_id'])."'";
		}
