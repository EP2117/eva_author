...
<head>
    ...
    <title> Debit Note Report (Product Wise Report)</title>
<?php 
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line"> Debit Note Report (Product Wise Report))</h1>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           Debit Note Report (Product Wise Report)
                        </div>
								...
								<table class="table table-striped table-bordered table-hover" id="product_detail_rls" >
                                    <thead  >
										 ...
										 <th rowspan="2" style="vertical-align:middle;" class="text-center">#</th>
											...
											<th rowspan="2" style="vertical-align:middle;" nowrap="nowrap" class="text-center"> D.N NO.</th>
                                    ...
                                    <tbody >
										...
										foreach($invoice_list as $get_val){
											...
											$grn_no	= substr(('00000'.$get_val['dn_entry_id']),-5);
											
											//Added by AuthorsMM
											$ft_total = $ft_total + $get_val['dne_child_detail_dnl_feet'];
											$m_total  = $m_total + $get_val['dne_child_detail_dnl_m'];
											$ton_total= $ton_total + $get_val['dne_child_detail_dnl_dw_ton'];
											$kg_total = $kg_total + $get_val['dne_child_detail_dw_kg'];
											$currency_total = $currency_total + $get_val['dne_child_detail_amount_cur'];
											$mmk_total = $mmk_total + $get_val['dne_child_detail_amount'];
										?>
										<tr>
										<td class="text-right"><?php echo $sno++;?></td>	
											<td><?php echo substr(('00000'.$get_val['dn_entry_id']),-5);?></td>
											<td><?php echo dateGeneralFormatN($get_val['dn_entry_date']);?></td>
											...
											<td><?php echo $arr_thick[$get_val['product_con_entry_child_product_detail_thick_ness']];?></td>-->
											<!--<td><?php echo $get_val['dne_child_detail_width_inches'];?></td>
											<td><?php echo $get_val['dne_child_detail_width_mm'];?></td>-->
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['dne_child_detail_dnl_feet']);?></td>
											<td class="text-right"><?php echo round($get_val['dne_child_detail_dnl_m']);?></td>
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['dne_child_detail_dnl_dw_ton']);?></td>
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['dne_child_detail_dw_kg']);?></td>
											<td class="text-right"><?php echo number_format($get_val['dne_child_detail_amount_cur']);?></td>
											<td class="text-right"><?php echo number_format($get_val['dne_child_detail_amount']);?></td>
