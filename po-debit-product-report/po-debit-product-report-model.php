<?php  
	...
	{
		$where = " WHERE dne_child_detail_deleted_status =0 AND pI_deleted_status = 0 AND pI_company_id = '".$_SESSION[SESS.'_session_company_id']."'";
		...
		if(isset($_REQUEST['search_prodcut_id']) && (!empty($_REQUEST['search_prodcut_id']))) {
			$where .= " AND grn_child_product_detail_product_id = '".dataValidation($_REQUEST['search_prodcut_id'])."'";
		         ...
		         $select_invoice_entry = "SELECT 
												...
												dne_child_detail_width_inches,
												dne_child_detail_width_mm,
												dne_child_detail_length_feet,
												dne_child_detail_length_mm,
												dne_child_detail_ton_qty,
												dne_child_detail_kg_qty,
												dne_child_detail_amount,
												dne_child_detail_amount_cur,
												dne_child_detail_dnl_feet,
												dne_child_detail_dnl_m,
												dne_child_detail_dnl_dw_ton,
												dne_child_detail_dw_kg,
								  ...
								  ON 
								  		product_con_entry_child_product_detail_id = dne_child_detail_product_id
