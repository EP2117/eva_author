...
?>
			...
			<tr class="odd gradeX">
				...
				<input type="hidden" name="product_thick_ness_val" id="product_thick_ness_val<?php echo $record_so_detail['invoice_entry_product_detail_id'];?>" value="<?php echo $arr_thick[$record_so_detail['product_thick_ness']]; ?>" >
				<input type="hidden" name="product_thick_ness" id="product_thick_ness<?php echo $record_so_detail['invoice_entry_product_detail_id'];?>" value="<?php echo $record_so_detail['product_thick_ness']; ?>" >
				<input type="hidden" name="product_color_id" id="product_color_id<?php echo $record_so_detail['invoice_entry_product_detail_id'];?>" value="<?php echo $record_so_detail['invoice_entry_product_detail_color_id']; ?>" >
				...
				<input type="hidden" name="product_type_id" id="product_type_id<?php echo $record_so_detail['invoice_entry_product_detail_id'];?>" value="<?php echo $invoice_entry_type_id; ?>" />
				</td>
