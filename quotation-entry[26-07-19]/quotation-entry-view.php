					...
					<div class="col-md-12">
						...
						<div class="panel panel-info">
							...
							<tr>
								...
								<td><input class="form-control" type="text"  name="quotation_entry_product_detail_qty[]" id="quotation_entry_product_detail_qty<?=$row_cnt; ?>" onBlur="GetTotalLength(<?=$row_cnt; ?>)"  onBlur="GetTotalLength(<?=$row_cnt; ?>),discountPerFind(<?=$row_cnt; ?>);"  value="<?=round($get_product_detail['quotation_entry_product_detail_qty'])?>"  /></td> 
