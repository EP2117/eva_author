...
?>
		<form method="get" name="advance_product_list_form" id="advance_product_list_form"  >
...
?>
			...
			<tr class="odd gradeX">
				...
				<input type="hidden" name="product_t_id" id="product_t_id<?php echo $record_so_detail['product_id'];?>1" value="<?=$t_id?>" >
                ...
                <input type="hidden" name="mother_child_type" id="mother_child_type<?php echo $record_so_detail['product_id'];?>1" value="1" >
...
<?php
   		$select_product 			= "SELECT  
											...
											product_con_entry_child_product_detail_uom_id as product_purchase_uom_id,
											brand_name,
											product_con_entry_child_product_detail_product_brand_id as product_brand_id,
											product_con_entry_child_product_detail_color_id as product_colour_id
										...
										WHERE 
											...
											product_con_entry_child_product_detail_id 						NOT IN (".$m_id.")								AND
											product_con_entry_child_product_detail_product_brand_id			= '".$brand_id."'";
...
?>
			...
			<tr class="odd gradeX">
				...
				<input type="checkbox" class="check_prd_id"  name="chk_product_id[]" id="chk_product_id<?php echo $record_so_detail['product_id'];?>2" value="<?php echo $record_so_detail['product_id']; ?>2" />
				<input type="hidden" name="product_id" id="product_id<?php echo $record_so_detail['product_id'];?>2" value="<?php echo htmlspecialchars(ucfirst($record_so_detail['product_id'])); ?>" >
				<input type="hidden" name="product_name" id="product_name<?php echo $record_so_detail['product_id'];?>2" value="<?php echo htmlspecialchars(ucfirst($record_so_detail['product_name'])); ?>" >

				<input type="hidden" name="product_code" id="product_code<?php echo $record_so_detail['product_id'];?>2" value="<?php echo $record_so_detail['product_code']; ?>" >
					<input type="hidden" name="product_brand_name" id="product_brand_name<?php echo $record_so_detail['product_id'];?>2" value="<?php echo $record_so_detail['brand_name']; ?>" >
					<input type="hidden" name="product_brand_id" id="product_brand_id<?php echo $record_so_detail['product_id'];?>2" value="<?php echo $record_so_detail['product_brand_id']; ?>" >
				<input type="hidden" name="product_uom_id" id="product_uom_id<?php echo $record_so_detail['product_id'];?>2" value="<?php echo $record_so_detail['product_purchase_uom_id']; ?>" >
				<input type="hidden" name="product_uom_name" id="product_uom_name<?php echo $record_so_detail['product_id'];?>2" value="<?php echo $record_so_detail['product_uom_name']; ?>" >
				<input type="hidden" name="product_colour_name" id="product_colour_name<?php echo $record_so_detail['product_id'];?>2" value="<?php echo $record_so_detail['product_colour_name']; ?>" >
				<input type="hidden" name="product_colour_id" id="product_colour_id<?php echo $record_so_detail['product_id'];?>2" value="<?php echo $record_so_detail['product_colour_id']; ?>" >

				<input type="hidden" name="product_thick_ness" id="product_thick_ness<?php echo $record_so_detail['product_id'];?>2" value="<?php echo $record_so_detail['product_thick_ness']; ?>" >
				<input type="hidden" name="product_thick_ness_val" id="product_thick_ness_val<?php echo $record_so_detail['product_id'];?>2" value="<?php echo $record_so_detail['product_thick_ness']; ?>" >
				<input type="hidden" name="product_type" id="product_type<?php echo $record_so_detail['product_id'];?>2" value="2" >
				<input type="hidden" name="product_t_id" id="product_t_id<?php echo $record_so_detail['product_id'];?>2" value="<?=$t_id?>" >
				
				<input type="hidden" name="product_inches" id="product_inches<?php echo $record_so_detail['product_id'];?>2" value="0" >
				<input type="hidden" name="product_inches_mm" id="product_inches_mm<?php echo $record_so_detail['product_id'];?>2" value="0" >
				<input type="hidden" name="mas_product_id" id="mas_product_id<?php echo $record_so_detail['product_id'];?>2" value="<?php echo htmlspecialchars(ucfirst($record_so_detail['product_id'])); ?>"  />
                <input type="hidden" name="mother_child_type" id="mother_child_type<?php echo $record_so_detail['product_id'];?>2" value="2">
				</td>
				<td><?php echo $record_so_detail['product_code']; ?></td>
				<td><?php echo $record_so_detail['brand_name']; ?></td>
				<td><?php echo $record_so_detail['product_name']; ?></td>
				<td><?=$record_so_detail['product_uom_name']?></td>
					<td><input type="text" name="count_product_id" style="width:70px;"  id="count_product_id<?php echo $record_so_detail['product_id'];?>2" value="1" ></td>
			</tr>
