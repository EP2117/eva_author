  ...
  <!-- <tr>
   ...
   <tr>
	...
	<tr>	 
	 ...
	 <td colspan="2" class="report-border-right report-border-bottom" style='text-align:left;font-weight:bold;font-size:13px;' >INVOICE NO : <?=$invoice_entry_edit['branch_prefix'].$invoice_entry_edit['invoice_entry_no']?></td>
	</tr>
	<tr>	 
		...
		<?php  $k = 1; foreach($invoice_entry_prd_edit as $getDetail){
			...
			<tr>
				...
				<td class="report-border-right report-border-bottom" style='text-align:right;font-size:11px;'> 
					...
					<td class="report-border-right report-border-bottom" style='text-align:right;font-size:11px;'> 
					<?=number_format($getDetail['invoice_entry_product_detail_tot_length'],3,'.','')?> </td>
				<td class="report-border-right report-border-bottom" style='text-align:right;font-size:11px;'> 
...
<?php } ?>	
	...
	<tr>
		...
		<td class="report-border-right report-border-bottom" style='text-align:right;font-weight:bold;font-size:11px;width:15%'> <?=number_format($invoice_entry_edit['invoice_entry_dis_amount'],0,'.','')?> &nbsp;&nbsp;</td>
	</tr>
	<tr>
