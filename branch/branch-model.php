<?php
	...
	function insertBranch(){
		...
		$branch_prefix					= trim($_POST['branch_prefix']);
		$branch_active_status           = "active";
		$request_fields 				= ((!empty($branch_name)) && (!empty($branch_address)));
		
		checkRequestFields($request_fields, PROJECT_PATH, "branch/index.php?page=add");
		...
		$insert_branch 					= sprintf("INSERT INTO branches  (branch_uniq_id, branch_code,branch_name, 
																		  ...
																		  branch_added_ip, branch_company_id,branch_prefix) 
																VALUES ('%s', '%s', '%s', 
																		'%s', '%d', '%d', 
																		'%d', '%s',
																		'%s', '%s', '%s',
																		...
																		'%s', '%d', '%s')", 
																		  ...
																		  $ip, $_SESSION[SESS.'_session_company_id'],$branch_prefix); 
		mysql_query($insert_branch);
		pageRedirection("branch/index.php?page=add");
	}
	function listBranch(){
	...
	function updateBranch(){
		...
		checkRequestFields($request_fields, PROJECT_PATH, "branch/index.php?page=edit&id=".$branch_uniq_id);
		...
		pageRedirection("branch/?page=edit&id=$branch_uniq_id");			
