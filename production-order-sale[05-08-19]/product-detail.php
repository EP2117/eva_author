...
?>
			...
			<tr class="odd gradeX">
				...
				<input type="hidden" name="product_colour_id" id="product_colour_id<?php echo $record_so_detail['invoice_entry_product_detail_id'];?>" value="<?php echo $product_color_id	; ?>" >
                ...
                <input type="hidden" name="product_s_weight_met" id="product_s_weight_met<?php echo $record_so_detail['invoice_entry_product_detail_id'];?>" value="<?php echo $record_so_detail['invoice_entry_product_detail_s_weight_met']; ?>" />
