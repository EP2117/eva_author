...
function AddproductDetail(){
			var entry_type 	= document.getElementById('recycle_entry_type').value;
...
function GetCHLcalc(calculation_id,id){
	...
	$.get(
		...
		function(data) {
			...
			document.getElementById('product_con_entry_child_product_detail_length_mm'+id).value 		= data_t[2];
		}

	);
}
function GetWidthcuttin(){
			var entry_type 	= document.getElementById('recycle_entry_type').value;
			document.getElementById('t_width_product_detail').style.display	=	"none"; 
		if(entry_type=='1'){
			document.getElementById('t_width_product_detail').style.display	=	""; 
		}
}
