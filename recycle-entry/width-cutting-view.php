...
<head>
    ...
    <title>Re-Cycle Entry DETAILS</title>
...
<?php 
	...
	if(isset($_GET['msg'])) {
		...
		if($_GET['msg']==1) {
			$msg = '<div style="color:#66FF00;text-align:center;font-size:16px;">Re-Cycle Entry added successfully</div>';
		} else if($_GET['msg']==2) {
			$msg = '<div style="color:#66FF00;text-align:center;font-size:16px;">Re-Cycle Entry updated successfully</div>';
		} else if($_GET['msg']==3) {
			$msg = '<div style="color:#66FF00;text-align:center;font-size:16px;">Re-Cycle Entry deleted successfully</div>';
		} else if($_GET['msg']==4) {
			$msg = 'Product Code already added';
		}else if($_GET['msg']==5) {
			$msg = 'Please fill all required fields';
		}else if($_GET['msg']==6) {
			$msg = '<div style="color:#66FF00;text-align:center;font-size:16px;">Re-Cycle Entry Product Detail deleted successfully</div>';
		}else if($_GET['msg']==7) {
			$msg = '<div style="color:#66FF00;text-align:center;font-size:16px;">Re-Cycle Entry deleted successfully</div>';
		}  
...
<script type="text/javascript" src="<?php echo PROJECT_PATH.'/recycle-entry/width-cutting-javascript.js'; ?>"></script>
        ...
        <div id="page-wrapper">
            ...
            <div id="page-inner">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <h1 class="page-head-line">Re-Cycle Entry</h1>
										...
										<div class="form-group">
											...
											<label>Date</label>
											 <div class="input-group date">
											  ...
											  <input type="text" class="form-control" name="recycle_entry_date" id="recycle_entry_date" value="<?=date('d/m/Y')?>" >
											</div>
										</div>
										<div class="form-group">
											<label>Warehouse</label>
											<select name="recycle_entry_type" id="recycle_entry_type" class="form-control" onChange="GetCuttingDisplay()">
												  <option value="1"> With Cutting </option>
												  <option value="2"> Without Cutting </option>
											</select>
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="panel panel-info re_child">
							<div class="panel-heading">
							  Width Cutting
							</div>
							<div class="panel-body">
								...
								<div class="panel-body">
									...
									<div class="col-lg-6">
										...
										<div class="form-group">
											...
											<select name="recycle_entry_type" id="recycle_entry_type" class="form-control select2" style="width:100%">
												...
												<?php
													...
													foreach($arr_producton_type	as	$value=>$list){
														...
														$selected	= ($value==$recycle_entry_edit['recycle_entry_type'])?'selected="selected"':'';
                                    ...
                                    <tbody id="child_product_detail_display">
										<?php
											...
											<tr>
												...
												<td>
													<input type="hidden" name="product_con_entry_child_product_detail_thick_ness[]" id="product_con_entry_child_product_detail_thick_ness<?=$i?>"  value="<?=$get_chd_prd_detail['product_con_entry_child_product_detail_thick_ness']?>"   />
													<input type="text" class="form-control" name="product_con_entry_child_product_detail_thick_ness_val[]" id="product_con_entry_child_product_detail_thick_ness_val<?=$i?>"  value="<?=$arr_thick[$get_chd_prd_detail['product_con_entry_child_product_detail_thick_ness']]?>"   />
												</td>
												<td>
			...
			<div class="modal-dialog" style="width: 800px;">
				...
				<div class="modal-content">
					...
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">Re-Cycle Entry Detail</h4>
