								...
								<div class="panel-body">
									...
									<div class="col-lg-6">
										...
										<div class="form-group">
											...
											<select class="form-control select2" style="width:100%" name="lv_leave" id="lv_leave"  onChange="getCalc(this.value)"  required >
										...
										<div class="form-group">
													...
													<input type="text" name="lv_paymentid" id="lv_paymentid" class="form-control" value="<?php echo empty($leave_edit['lv_paymentid'])?"":$leave_edit['lv_paymentid']; ?>" >
												</div>								
									</div>
									...
									<div class="col-lg-6">
										...
										<div class="form-group">
											<label class="control-label">Leave Salary Type</label><br>
											
												 <?php
												 $salary_type= empty($leave_edit['lv_leave_salary_type'])?"":$leave_edit['lv_leave_salary_type'];
												 $arr_type	= explode(",",$salary_type);
													foreach($arr_salary as $key => $value){
													
													$checked = (in_array($key,$arr_type)==1)?"checked=checked":'';
												?>
							<input type="checkbox" name="lv_leave_salary_type[]"  id="lv_leave_salary_type<?=$key?>" class="salary_type" value="<?=$key?>"  <?=$checked?> onClick="getCalc(this.value)" /> <?=$value?><br/> 
												<?php
													}
												?>
										</div>
