								...
								<div class="panel panel-info">
									...
									<div class="panel-body">
										...
										<div class="col-lg-6">										
											...
											<div class="form-group">
												<label  class="control-label">Supplier loaction</label>
										...
										<table id="payment_table" class="table table-striped table-bordered table-hover" style="width:200%">
											...
											<?php 
												...
												<tr id="remove_req_<?php echo $i; ?>">
													...
													<td>																
														<input type="text" class="form-control" name="purchaseamnt_cur_<?php echo $i; ?>" id="purchaseamnt_cur_<?php echo $i; ?>"  onkeypress="return o_obj.Alpha_Numeric(this,event);" value="<?php echo round($editPaymentdetails[$j]['pI_invoice_total_amt']); ?>" >
													</td>
													<td>																
														<input type="text" class="form-control" name="advanceamnt_cur_<?php echo $i; ?>" id="advanceamnt_cur_<?php echo $i; ?>"  onkeypress="return o_obj.Alpha_Numeric(this,event);" value="<?php echo round($editPaymentdetails[$j]['pR_advance_amount']); ?>" >
													</td>
													<td>																
														<input type="text" class="form-control" name="purchaseamnt_<?php echo $i; ?>" id="purchaseamnt_<?php echo $i; ?>"  onkeypress="return o_obj.Alpha_Numeric(this,event);" value="<?php echo round($editPaymentdetails[$j]['pI_invoicetotal']); ?>" >
													</td>
													<td>																
														<input type="text" class="form-control" name="advanceamnt_<?php echo $i; ?>" id="advanceamnt_<?php echo $i; ?>"  onkeypress="return o_obj.Alpha_Numeric(this,event);" value="<?php echo round($editPaymentdetails[$j]['pR_advanceAmnt']); ?>" >
													</td>
													
													<td>																
														<input type="text" class="form-control" name="paidamnt_cur_<?php echo $i; ?>" id="paidamnt_cur_<?php echo $i; ?>"  onkeypress="return o_obj.Alpha_Numeric(this,event);" value="<?php echo round($editPaymentdetails[$j]['pi_paidamnt_cur']); ?>">
													</td>
													<td>																
														<input type="text" class="form-control" name="paidamnt_<?php echo $i; ?>" id="paidamnt_<?php echo $i; ?>"  onkeypress="return o_obj.Alpha_Numeric(this,event);" value="<?php echo round($editPaymentdetails[$j]['pi_paidamnt']); ?>">
													</td>
													...
													<td>																
														<input type="text" class="form-control" name="amount_<?php echo $i; ?>" id="amount_<?php echo $i; ?>"  onkeypress="return o_obj.Alpha_Numeric(this,event);" value="<?php echo round($editPaymentdetails[$j]['pi_amount']); ?>" onChange="return balance_calculation(this.value,this,'<?php echo $i; ?>');"></td>
													<td>
														
														<input  type="text" class="form-control" name="amount_cur_<?php echo $i; ?>" id="amount_cur_<?php echo $i; ?>"   value="<?php echo round($editPaymentdetails[$j]['pi_amount_cur']); ?>" >
													</td>
													<td>																
														<input type="text" class="form-control" name="balanceamnt_cur_<?php echo $i; ?>" id="balanceamnt_cur_<?php echo $i; ?>"  onkeypress="return o_obj.Alpha_Numeric(this,event);" value="<?php echo round($editPaymentdetails[$j]['pi_balanceamnt_cur']); ?>">
													</td>
													<td>																
														<input type="text" class="form-control" name="balanceamnt_<?php echo $i; ?>" id="balanceamnt_<?php echo $i; ?>"  onkeypress="return o_obj.Alpha_Numeric(this,event);" value="<?php echo round($editPaymentdetails[$j]['pi_balanceamnt']); ?>">
													</td>
													<td>																
														<input type="text" class="form-control" class='form-control'  name="pay_det_desc_per_<?php echo $i; ?>" id="pay_det_desc_per<?php echo $i; ?>" value="<?php echo round($editPaymentdetails[$j]['pi_descount_per']); ?>"  /> 
													</td>
													<td>																
														<input type="text" class="form-control" class='form-control'  name="pay_det_desc_amount_<?php echo $i; ?>" id="pay_det_desc_amount_<?php echo $i; ?>" value="<?php echo round($editPaymentdetails[$j]['pi_descount_amt']); ?>" /> 
													</td>
													<td>
														<?php if($count_id>1){?>
									...
									<div class="panel-body">
										<div class="col-lg-3">										
											<div class="form-group">
												...
												<select name="paymentterm" id="paymentterm" class="form-control select2" style="width:100%" onChange="get_paymentterm(this.value);" required >
													 <option value=""> - Select - </option>
										...
										<?php $sho_hide=(isset($editPayment['p_paymentterm']) && $editPayment['p_paymentterm']==1)?"none":"";?>																			
										<div class="col-lg-3" id="d_bankname" style="display:<?=$sho_hide?>">										
											<div class="form-group">
												<label>Bank name</label>
												<select name="bankname" id="bankname" class="form-control select2" style="width:100%" >
													 <option value=""> - Select - </option>
													<?php
														foreach($bank_arr as	$get_bank){
															if($editPayment['p_bankname'] == $get_bank['account_sub_id']){ $select ='selected="selected"'; }else{ $select="";}
														?>
															<option <?php echo $select;?>  value="<?=$get_bank['account_sub_id']?>"><?=$get_bank['account_sub_name']?></option>
													<?php
														}
														?>
										...
										<div class="col-lg-3" id="d_acno" style="display:<?=$sho_hide?>">										
											<div class="form-group">
										...
										<?php $sho_hide=(isset($editPayment['p_paymentterm']) && $editPayment['p_paymentterm']==2)?"none":"";?>																			
										<div class="col-lg-3" id="d_cash" style="display:<?=$sho_hide?>">										
											<div class="form-group">
												<label>Cash </label>
												<select name="cash" id="cash" class="form-control select2" style="width:100%" >
													 <option value=""> - Select - </option>
													<?php
														foreach($cash_arr as	$get_cash){
															if($editPayment['p_cash'] == $get_cash['account_sub_id']){ $select ='selected="selected"'; }else{ $select="";}
														?>
															<option <?php echo $select;?>  value="<?=$get_cash['account_sub_id']?>"><?=$get_cash['account_sub_name']?></option>
													<?php
														}
														?>
                                ...
                                <div class="col-lg-6">
									...
									<div class="form-group">
											...
											<select name="search_supplier_id" id="search_supplier_id" class="form-control select2" style="width:100%" >
													...
													foreach($arr_supplier as $get_value){
								...
								<form name="payment_invoice_forms" id="payment_invoice_forms" method="post" enctype="multipart/form-data">
									<table class="table table-striped table-bordered table-hover" id="dataTables-payment">
										...
										<?php
											...
											/*$edit_status = $edit_status = editStatus('purchase_payment', 'paymentId','p_branchid', 'p_deleted_status');
			...
			if($delete_status == 1)	{
				...
				$delete_status = $edit_status;			
										...
										?>
											<tr class="odd gradeX">
												<td><?php echo $s_no++; ?></td>
												<td><?php echo $result['payment_no']; ?></td> 
                                ...
                                <div class="modal-dialog" style="width: 800px;">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" onClick="AddproductDetail()"  data-dismiss="modal">Ok</button>
