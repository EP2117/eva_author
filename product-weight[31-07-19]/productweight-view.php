...
function GetWcalc(calculation_id,id){
	if(calculation_id==2){
		...
		var total=	(1000/calc_amount);
		document.getElementById('weight_mm_'+id).value=total;
	}
	else if(calculation_id==7){
		var calc_amount 	= document.getElementById('weight_mm_'+id).value;	
		var total=	(0.001*calc_amount);
		document.getElementById('weight_ton_'+id).value=total;
	}
}
