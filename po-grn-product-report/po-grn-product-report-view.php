...
<head>
    ...
    <title> Good Receipt Note Report (Product Wise)</title>
<?php 
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line"> Good Receipt Note Report (Product Wise)</h1>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           Good Receipt Note Report (Product Wise)
                        </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Good Receipt Note Report Detail
								...
								<table class="table table-striped table-bordered table-hover" id="product_detail_rls" >
                                    <thead  >
										 ...
										 <th rowspan="2" class="text-center" style="vertical-align:middle;" >#</th>
											...
											<th rowspan="2" style="vertical-align:middle;" nowrap="nowrap" class="text-center"> GRN NO.</th>
											...
											<!--<th colspan="2" class="text-center"> WIDTH</th>-->
                                    ...
                                    <tbody >
										...
										foreach($invoice_list as $get_val){
											...
											$grn_no	= substr(('00000'.$get_val['grnId']),-5);
											
											//Added by AuthorsMM
											$ft_total = $ft_total + $get_val['grn_child_product_detail_length_feet'];
											$m_total  = $m_total + $get_val['grn_child_product_detail_length_mm'];
											$ton_total= $ton_total + $get_val['grn_child_product_detail_ton_qty'];
											$kg_total = $kg_total + $get_val['grn_child_product_detail_kg_qty'];
										?>
										<tr>
										<td class="text-right"><?php echo $sno++;?></td>	
											<td><?php echo $grn_no;?></td>
											<td><?php echo dateGeneralFormatN($get_val['grn_date']);?></td>
											...
											<!--<td class="text-right"><?php echo $get_val['grn_child_product_detail_width_inches'];?></td>
											<td class="text-right"><?php echo $get_val['grn_child_product_detail_width_mm'];?></td>-->
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['grn_child_product_detail_length_feet']);?></td>
											<td class="text-right"><?php echo round($get_val['grn_child_product_detail_length_mm']);?></td>
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['grn_child_product_detail_ton_qty']);?></td>
											<td class="text-right"><?php echo sprintf('%0.2f', $get_val['grn_child_product_detail_kg_qty']);?></td>
