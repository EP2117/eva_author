					...
					<div class="col-md-12 col-sm-12 col-xs-12">
					   <div class="panel panel-info">
							...
							<input type="checkbox" name="production_order_type_id[]"  id="production_order_type_id<?=$key?>" value="<?=$key?>" onClick="getTableHeader(this.value)" /> <?=$value?><br/>
										...
										<div class="form-group">
											<label class="control-label">SAELS WAREHOUSE</label>
											<!--<input type="checkbox" name="production_order_sw_check" id="production_order_sw_check" value="1" >-->
					...
					<div class="col-md-12">
						...
						<div class="panel panel-info">
							...
							<div class="panel-body">
								...
								<table class="table table-striped table-bordered table-hover product_detail_rls_d" id="product_detail_rls"  style="width:180%;display:">
                                    <thead  >
										<tr>
											<td colspan="20"><button type="button" onClick="GetDetail('1');" data-toggle="modal" data-target="#myModal" data-id="1" class="glyphicon glyphicon-plus"></button></td>
										</tr>
                                         <tr>
											...
											<th colspan="2"  style=" text-align:center"> SALES WIDTH</th>
											<th colspan="4"  style=" text-align:center"> SALES LENGTH</th>
											<th colspan="4"  style=" text-align:center"> EXTR LENGTH</th>
											<th rowspan="2" style="vertical-align:middle;">QTY</th>
											<th rowspan="2" style="vertical-align:middle;"> Total Length </th>
                                        </tr>
										<tr>
											<th style="vertical-align:middle; ">INCHES</th>
											<th style="vertical-align:middle;">MM</th>
											<th style="vertical-align:middle;">INCHES</th>
											<th style="vertical-align:middle;">MM</th>
											<th style="vertical-align:middle; ">FEET</th>
											<th style="vertical-align:middle; ">FT.IN</th>
											<th style="vertical-align:middle;">MM</th>
											<th style="vertical-align:middle; ">MET</th>
											<th style="vertical-align:middle;">FEET</th>
											<th style="vertical-align:middle;">FT.IN</th>
											<th style="vertical-align:middle;">MM</th>
											<th style="vertical-align:middle;">MET</th>
...
<input type="hidden"  name="production_order_product_detail_entry_type[]" id="production_order_product_detail_entry_type" value="<?=$get_product_detail['production_order_product_detail_entry_type']?>"/>  
											...
											<td><input class="form-control" type="text"  name="production_order_product_detail_width_mm[]" id="production_order_product_detail_width_mm<?=$row_cnt?>"  onBlur="GetWcalc(3,<?=$row_cnt?>)"onBlur="GetTotalLength(<?=$row_cnt?>)" value="<?=$get_product_detail['production_order_product_detail_width_mm']?>" /></td>
											...
											<td><input class="form-control" type="text"  name="production_order_product_detail_sl_feet_in[]" id="production_order_product_detail_sl_feet_in<?=$row_cnt?>" onblur="GetLcalFeet(1,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" value="<?=$get_product_detail['production_order_product_detail_sl_feet_in']?>"/></td>
											...
											<td><input class="form-control" type="text"  name="production_order_product_detail_ext_feet_in[]" id="production_order_product_detail_ext_feet_in<?=$row_cnt?>" onblur="GetLcalFeetExtr(1,<?=$row_cnt?>)" onBlur="GetTotalLength(<?=$row_cnt?>)" value="<?=$get_product_detail['production_order_product_detail_ext_feet_in']?>" /></td>
											...
											<td><input class="form-control" type="text"  name="production_order_product_detail_qty[]" id="production_order_product_detail_qty<?=$row_cnt?>" onBlur="GetTotalLength(<?=$row_cnt?>)"  onBlur="GetTotalLength(3,<?=$row_cnt?>),discountPerFind(<?=$row_cnt?>);" value="<?=$get_product_detail['production_order_product_detail_qty']?>" /></td> 
								...
								<table class="table table-striped table-bordered table-hover" id="product_detail_rws"  style="width:100%;display:">
									<thead>
										<tr>
											<td colspan="18"><button type="button" onClick="GetDetail('2');" data-toggle="modal" data-target="#myModal" data-id="1" class="glyphicon glyphicon-plus"></button></td>
										</tr>
 ...
 <td ><input class="form-control" type="text"  name="production_order_product_detail_width_mm[]" id="production_order_product_detail_width_mm<?=$row_cnt?>"   onBlur="GetWcalc(3,<?=$row_cnt?>)" value="<?=$get_product_detail['production_order_product_detail_width_mm']?>" /></td>
			 ...
			 <td ><input class="form-control" type="text"  name="production_order_product_detail_tot_meter[]" id="production_order_product_detail_tot_meter<?=$row_cnt?>"  onBlur="GetTotalFeet(4,<?=$row_cnt?>)" value="<?=$get_product_detail['production_order_product_detail_tot_meter']?>"/></td>
								...
								<table class="table table-striped table-bordered table-hover" id="product_detail_as"  style="width:100%; display:" >
