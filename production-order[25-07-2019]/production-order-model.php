...
//echo $select_production_order_no;exit;
		...
		$insert_production_order 					= sprintf("INSERT INTO production_order  (production_order_uniq_id, production_order_date,
																					  		  ...
																					  		  production_order_production_section_id,production_order_department_id,
																							  ...
																							  production_order_status,production_order_order_type,production_order_type_id,
																							  production_order_sw_check) 
			...
			if($detail_request_fields) {
				...
				$insert_production_order_product_detail 		= sprintf("INSERT INTO production_order_product_details 
																				(production_order_product_detail_uniq_id,production_order_product_detail_production_order_id,
																				 production_order_product_detail_product_id,production_order_product_detail_product_color_id,
																				 ...
																				 production_order_product_detail_added_by, production_order_product_detail_added_on,
																				 production_order_product_detail_added_ip,production_order_product_detail_entry_type) 
																	VALUES     ('%s', '%d', 
																				'%d', '%d',
																				'%d', '%d', 
																				'%f', '%f',
																		 ...
																		 $production_order_product_detail_sl_feet_mm[$i],$production_order_product_detail_sl_feet_met[$i],
																		  $production_order_product_detail_ext_feet[$i],$production_order_product_detail_ext_feet_in[$i],
																		 $production_order_product_detail_ext_feet_mm[$i],$production_order_product_detail_ext_feet_met[$i],
																		 ...
																		 $production_order_product_detail_s_weight_inches[$i],$production_order_product_detail_s_weight_mm[$i],
																		  $production_order_product_detail_tot_feet[$i],$production_order_product_detail_tot_meter[$i],
																		 $_SESSION[SESS.'_session_user_id'],$ip,$production_order_product_detail_entry_type[$i]);
				...
				//if($_SESSION[SESS.'_session_user_branch_type']==2){
					if($production_order_product_detail_entry_type[$i]=='4'){ //echo 'test';exit;
							...
							stockLedger('out',$production_order_id,$detail_id,$produt_id,$length_feet,$length_meter,$ton_qty,$kg_qty,$produt_qty, $production_order_branch_id,  $godown_id, $production_orderdate, $production_order_no,$stock_ledger_entry_type,'1');
					}
					else{
						// echo 'test1';exit;
					$produt_id											=	$production_order_product_detail_product_id[$i];
					...
					if($production_order_sw_check=='yes'){ //echo 'yesy';exit;
						
						
						reduceRawMaterial($produt_id,$product_thick,$product_colour_id,$width_inches,$tot_length,$production_order_no,$production_order_date,$production_order_id,$detail_id,$production_order_branch_id,$entry_type,$production_order_product_detail_entry_type[$i],$ton_qty,$kg_qty,-1);	
					...
					/*reduceRawMaterial($produt_id,$product_thick,$product_colour_id,$width_inches,$tot_length,$production_order_no,$production_order_date,$production_order_id,$detail_id,$production_order_branch_id,$entry_type,$production_order_product_detail_entry_type[$i],$ton_qty,$kg_qty);	
					*/
					}
				//}				
			}
		...
		for($i = 0; $i < count($production_order_product_detail_product_id); $i++) {
			...
			if($detail_request_fields) { 
				...
				if(!empty($production_order_product_detail_id[$i])) {
					...
					echo $update_production_order_product_detail = sprintf("	UPDATE 
																			production_order_product_details 
																		SET  
