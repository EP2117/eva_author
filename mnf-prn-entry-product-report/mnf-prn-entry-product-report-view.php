...
<head>
    ...
    <title> Prodution Entry Report</title>
<?php 
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line"> Prodution Entry Report</h1>
								...
								<table class="table table-striped table-bordered table-hover" id="product_detail_rls" >
                                    <thead  >
										<?php if($_REQUEST['search_product_type']==1){ ?>		
                                         <tr>
											 <th rowspan="2" >#</th>
											<th style="vertical-align:middle;" nowrap="nowrap" rowspan="2"> Production No. </th>
											<th style="vertical-align:middle;" rowspan="2"> Date</th>
											<th style="vertical-align:middle;" nowrap="nowrap" rowspan="2"> GIN No. </th>
										...
										<?php }elseif($_REQUEST['search_product_type']==4){ ?> 
										 <tr>
											 <th rowspan="2" >#</th>
											<th style="vertical-align:middle;" nowrap="nowrap"> Production No. </th>
											<th style="vertical-align:middle;"> Date</th>
											<th style="vertical-align:middle;" nowrap="nowrap"> GIN No. </th>
											<th style="vertical-align:middle;"> Date</th>
                                    ...
                                    <tbody >
										...
										<tr>
										<td><?php echo $sno++;?></td>	
											<td><?php echo $get_val['production_entry_no'];?></td>
											<td><?php echo dateGeneralFormatN($get_val['production_entry_date']);?></td>
											<td><?php echo $get_val['grn_entry_no'];?></td>
											<td><?php echo dateGeneralFormatN($get_val['grn_entry_date']);?></td>
											...
											<td><?php echo $arr_thick[$get_val['production_entry_product_detail_product_thick']];?></td>
											<td><?php echo $get_val['production_entry_product_detail_s_width_inches'];?></td>
											<td><?php echo $get_val['production_entry_product_detail_s_width_mm'];?></td>
											<td><?php echo $get_val['production_entry_product_detail_sl_feet'];?></td>
											<td><?php echo $get_val['production_entry_product_detail_sl_feet_mm'];?></td>
											<td><?php echo $get_val['production_entry_product_detail_qty'];?></td>
										</tr>
										<?php 
										...
										<td><?php echo $sno++;?></td>	
											...
											<td><?php echo $get_val['production_entry_product_detail_s_width_inches'];?></td>
											<td><?php echo $get_val['production_entry_product_detail_s_width_mm'];?></td>
											<td><?php echo number_format($get_val['production_entry_product_detail_s_weight_inches'],2,'.','');?></td>
											<td><?php echo $get_val['production_entry_product_detail_s_weight_mm'];?></td>
											<td><?php echo $get_val['production_entry_product_detail_qty'];?></td>
										</tr>
										<?php 
