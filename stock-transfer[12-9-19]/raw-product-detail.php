...
?>
			...
			<tr class="odd gradeX">
				...
				<input type="hidden" name="product_type_id" id="product_type_id<?php echo $record_so_detail['product_con_entry_child_product_detail_id'];?>2" value="<?php echo $t_id;?>" ><input type="hidden" name="osf_uom_ton" id="osf_uom_ton<?php echo $record_so_detail['product_con_entry_child_product_detail_id'];?>2" value="<?php echo $record_so_detail['product_con_entry_osf_uom_ton']; ?>" >
                <input type="hidden" name="osf_uom_ton" id="osf_uom_ton<?php echo $record_so_detail['product_con_entry_child_product_detail_id'];?>2" value="<?php echo $record_so_detail['product_con_entry_osf_uom_ton']; ?>" >
