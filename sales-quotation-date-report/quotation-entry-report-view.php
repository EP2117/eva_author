...
?>
<script type="text/javascript" src="<?php echo PROJECT_PATH.'/sales-quotation-date-report/quotation-entry-javascript.js'; ?>"></script>
</head>
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Quotation Report</h1>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-invoice-entry">
									...
									?>
										 <tr  class="odd gradeX">
										  ...
										  <td><?php echo $get_value['quotation_entry_no'];?></td>
										  <td><?php echo dateGeneralFormatN($get_value['quotation_entry_date']);?></td>
										  <td><?php echo $get_value['customer_name'].'-'.$get_value['customer_code'];?></td>
										
										  <td class="text-right"><?php echo number_format($get_value['quotation_entry_net_amount']);?></td>
										</tr>
									<?php $amt=$amt+$get_value['quotation_entry_net_amount']; } ?>
									<tr>
