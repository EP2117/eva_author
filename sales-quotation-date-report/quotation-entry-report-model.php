...
function listsalesman()
{
	...
	function quotationReport()
	{
		...
		if(isset($_REQUEST['search_customer_id']) && (!empty($_REQUEST['search_customer_id']))) {
		   ...
		   $select_invoice_entry = "SELECT quotation_entry_id, quotation_entry_uniq_id, quotation_entry_no, 
								  quotation_entry_date, quotation_entry_net_amount,
								  customer_name, customer_code,
								  customer_code
								  FROM quotation_entry
								  LEFT JOIN customers ON customer_id = quotation_entry_customer_id
								  
								  LEFT JOIN cities ON city_id = customer_city_id
								  $where
								  ORDER BY quotation_entry_date ASC, quotation_entry_no ASC";
