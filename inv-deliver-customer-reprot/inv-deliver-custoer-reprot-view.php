...
<head>
    ...
    <title>Delivery Customer Entry</title>
<?php 
...
?>
<script type="text/javascript" src="<?php echo PROJECT_PATH.'/inv-deliver-customer-reprot/inv-deliver-custoer-reprot-javascript.js'; ?>"></script>
</head>
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Delivery Customer Report</h1>
								...
								<table class="table table-striped table-bordered table-hover" id="product_detail_rls" >
                                    <thead  >
										 ...
										 <th rowspan="2" >#</th>
											...
											<th rowspan="2" style="vertical-align:middle;" nowrap="nowrap"> DELLIVERY NO</th>
                                    ...
                                    <tbody >
										...
										if($product_id!=$get_val['delivery_customer_product_detail_product_id']){
										if($sno!=1){ ?>
										...
										<tr>
										<td><?php echo $sno++;?></td>	
											<td><?php echo $get_val['delivery_customer_no'];?></td>
											...
											<td><?php echo $arr_thick[number_format($get_val['delivery_customer_product_detail_product_thick'])];?></td>
											<td><?php echo $get_val['delivery_customer_product_detail_s_width_inches'];?></td>
											<td><?php echo $get_val['delivery_customer_product_detail_s_width_mm'];?></td>
											<td><?php echo $get_val['delivery_customer_product_detail_sl_feet'];?></td>
											<td><?php echo $get_val['delivery_customer_product_detail_sl_feet_met'];?></td>
											<td><?php echo $get_val['delivery_customer_product_detail_s_weight_inches'];?></td>
											<td><?php echo $get_val['delivery_customer_product_detail_s_weight_mm'];?></td>
											
											<td><?php echo number_format($get_val['delivery_customer_product_detail_qty'],3,'.','');?></td>
										</tr>
										<?php 
										
										$product_id=$get_val['delivery_customer_product_detail_product_id'];
										$subqty=$subqty+$get_val['delivery_customer_product_detail_qty'];
										$grandqty=$grandqty+$get_val['delivery_customer_product_detail_qty'];
										}?>
										<tr><td colspan="11" >&nbsp; </td>
											<td colspan="5" > Sub Total</td>
											<td style="text-align:right"><?php echo number_format($subqty,3,'.','');?>
