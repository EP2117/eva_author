	 	...
	 	$rows_ledger	= mysql_num_rows($result_ledger);
			if ( $rows_ledger == 0 ) {
				...
				mysql_query($insert_stock_ledger);
					 	...
					 	$update_stock_ledger = "UPDATE stock_ledger SET stock_ledger_product_id				=	'".$stock_ledger_product_id."',
																...
																WHERE	
																		...
																		stock_ledger_branch_id			    = '".$branch_id."'								AND
																    	stock_ledger_financial_year		    = '".$_SESSION[SESS.'_session_financial_year']."'"; 
...
function stockLedgerSales($stock_ledger_type, $stock_ledger_entry_id, $stock_ledger_entry_detail_id,$stock_ledger_product_id, $length_inches,$width_inches,$stock_ledger_product_quantity,$branch_id, $stock_ledger_customer_id, $stock_ledger_godown_id, $stock_ledger_date, $stock_ledger_trans_no,$stock_ledger_entry_type,
$stock_ledger_prd_type) {
...
$ip = getRealIpAddr();
		...
		$rows_ledger	= mysql_num_rows($result_ledger);
			if ( $rows_ledger == 0 ) {
					$insert_stock_ledger = "INSERT INTO stock_ledger_sales(	stock_ledger_type,
																		stock_ledger_entry_id,
																		stock_ledger_entry_detail_id,
																		stock_ledger_product_id,
																		stock_ledger_date,
					...
					mysql_query($insert_stock_ledger);
						...
						$update_stock_ledger = "UPDATE stock_ledger_sales SET stock_ledger_purchase_entry_date 	= 	'".$stock_ledger_date."',
