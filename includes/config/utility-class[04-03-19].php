...
$arr_account_type21			= array("op"=>"Opening Stock", "pu"=>"Purchase","ci"=>"Carriage inwards", "sa"=>"Sales","cl"=>"Closing Stock", "in"=>"Income", "ex"=>"Expenses", "mf"=>"Manufacture");
...
$ip = getRealIpAddr();
		 $select_ledger	= "	Select
							...
							WHERE
								...
								stock_ledger_product_quantity	= '".$stock_ledger_product_quantity."'				AND
					...
					$record = mysql_fetch_array($result_ledger);
						 $update_stock_ledger = "UPDATE stock_ledger SET stock_ledger_date 	= 	'".$stock_ledger_date."',
																...
																WHERE	
																		...
																		stock_ledger_entry_detail_id		=	'".$record['stock_ledger_id']."' ";   
...
function reduceRawMaterial($product_id,$thick,$color_id,$width_inches,$tot_len,$entry_no,$entry_date,$entry_id,$detail_id,$branch_id,$entry_type,$type_id,$ton_qty,$kg_qty,$product_detail_qty1){
