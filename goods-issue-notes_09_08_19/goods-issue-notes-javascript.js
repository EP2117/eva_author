...
function AddproductDetail(){
	...
	for (var i = 0; i < x.length; i++) {
		if (x[i].checked ==true) {
			...
			var product_tot_feet			= document.getElementById('product_tot_feet'+ord_id).value; //alert(product_tot_feet);
			...
			apnd	+= '<tr><td style="width:5%"><input type="hidden"  name="gin_entry_product_detail_mother_child_type[]" id="gin_entry_product_detail_mother_child_type" value="'+mother_child_type+'" />'+product_brand_name+'</td><td style="width:5%">'+product_name+'<input type="hidden"  name="gin_entry_product_detail_product_id[]" id="gin_entry_product_detail_product_id" value="'+product_id+'" /><input type="hidden"  name="gin_entry_product_detail_product_type[]" id="gin_entry_product_detail_product_type" value="'+product_type+'" /><input type="hidden"  name="gin_entry_product_detail_po_detail_id[]" id="gin_entry_product_detail_po_detail_id" value="'+detail_id+'" /> <input type="hidden"  name="gin_entry_product_detail_product_brand_id[]" id="gin_entry_product_detail_product_brand_id" value="'+product_brand_id+'" /></td>';
...
function GetRawDetail(){
	...
	$.get('raw-product-detail.php',
		...
		{m_id:m_id,rp_id:rp_id,product_id:product_id,gin_entry_type_id:gin_entry_type_id,product_color_id:product_color_id,product_brand_id:product_brand_id,product_thick:product_thick},
