                                ...
                                <table class="table table-striped table-bordered table-hover" id="product_detail"  style=" width:200%; overflow:scroll;" >
									...
									<tbody id="product_detail_display" >
										...
										<tr class="rls" style="display:none">
											...
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_ext_feet_mm[]" id="gin_entry_product_detail_ext_feet_mm<?=$row_cnt?>" onblur="GetLcalFeet(3,<?=$row_cnt?>);GetTotalLength(<?=$row_cnt?>)" value="<?=$get_product_detail['gin_entry_product_detail_ext_feet_mm']?>"  />  
											</td>
											
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_ext_feet_met[]" id="gin_entry_product_detail_ext_feet_met<?=$row_cnt?>" onblur="GetLcalFeet(3,<?=$row_cnt?>);GetTotalLength(<?=$row_cnt?>)" value="<?=$get_product_detail['gin_entry_product_detail_ext_feet_met']?>"  /> 
											</td>
										...
										<tr class="rws" style="display:none">
											...
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_s_weight_inches[]" id="gin_entry_product_detail_s_weight_inches<?=$row_cnt?>" onblur="GetLcalFeet(2,<?=$row_cnt?>);GetTotalLength(<?=$row_cnt?>)"  value="<?=$get_product_detail['gin_entry_product_detail_s_weight_inches']?>"  /> 
 
											</td>
											
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_s_weight_mm[]" id="gin_entry_product_detail_s_weight_mm<?=$row_cnt?>" onblur="GetLcalFeet(3,<?=$row_cnt?>);GetTotalLength(<?=$row_cnt?>)" value="<?=$get_product_detail['gin_entry_product_detail_s_weight_mm']?>"  />
											</td>
											
											<td>
											<input class="form-control" type="text"  name="gin_entry_product_detail_tot_feet[]" id="gin_entry_product_detail_tot_feet<?=$row_cnt?>" onblur="GetLcalFeet(3,<?=$row_cnt?>);GetTotalLength(<?=$row_cnt?>)" value="<?=$get_product_detail['gin_entry_product_detail_tot_feet']?>"  />
											</td>
...
<input type="hidden"  name="gin_entry_raw_product_detail_product_type[]" id="gin_entry_raw_product_detail_product_type<?=$row_cnt?>" value="<?=$get_product_detail['	gin_entry_raw_product_detail_product_type']?>" />
											...
											<td>
											<input class="form-control" type="text"  name="gin_entry_raw_product_detail_sl_feet[]" id="gin_entry_raw_product_detail_sl_feet<?=$row_cnt?>" value="<?=$get_product_detail['gin_entry_raw_product_detail_sl_feet']?>" onKeyUp="GetRLcalFeet(1,<?=$row_cnt?>)"  onBlur="GetRTotalLength(<?=$row_cnt?>)" readonly />
											</td>
											<td>
											<input class="form-control" type="text"  name="gin_entry_raw_product_detail_sl_feet_mm[]" id="gin_entry_raw_product_detail_sl_feet_mm<?=$row_cnt?>" value="<?=$get_product_detail['gin_entry_raw_product_detail_sl_feet_mm']?>" onKeyUp="GetRLcalFeet(2,<?=$row_cnt?>)" onBlur="GetRTotalLength(<?=$row_cnt?>)" readonly />
											</td>
											<td>
											<input class="form-control" type="text"  name="gin_entry_raw_product_detail_ton[]" id="gin_entry_raw_product_detail_ton<?=$row_cnt?>" value="<?=$get_product_detail['gin_entry_raw_product_detail_ton']?>" onKeyUp="GetRLcalFeet(3,<?=$row_cnt?>)" onBlur="GetRTotalLength(<?=$row_cnt?>)" readonly />
											</td>
											
											
											<td><input class="form-control" type="text"  name="gin_entry_raw_product_detail_kg[]" id="gin_entry_raw_product_detail_kg<?=$row_cnt?>" onBlur="GetRTotalLength(<?=$row_cnt?>);GetRLcalFeet(3,<?=$row_cnt?>);" value="<?=$get_product_detail['gin_entry_raw_product_detail_kg']?>" readonly  /> 
											</td>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<?php
										...
										$edit_status =editStatus('grn_entry_product_details','grn_entry_product_detail_gin_entry_id',$get_quotation['gin_entry_uniq_id'],'grn_entry_product_detail_deleted_status');
