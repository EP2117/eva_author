...
<body >
   ...
   <tr>
	  ...
	  <td width="50%" colspan="2" class="report-border-right report-border-bottom" style='text-align:left;font-weight:bold;font-size:13px;' >QUOTATION NO : &nbsp;<?=$invoice_entry_edit['invoice_entry_quotation_entry_id']?></td>
