...
$invoice_entry_product_detail_entry_type 		= $_POST['invoice_entry_product_detail_entry_type'];
		...
		update_transaction($invoice_entry_id, $invoice_entry_no, $invoice_entry_date, 'direct_Invoice', $acc_dr_id, $acc_cr_id, 'C', $acc_amount, $invoice_entry_remark, $invoice_entry_branch_id, $invoice_entry_net_amount);	
		update_transaction($invoice_entry_id, $invoice_entry_no, $invoice_entry_date, 'direct_Invoice', $acc_cr_id, $acc_dr_id, 'D', $acc_amount, $invoice_entry_remark, $invoice_entry_branch_id, $invoice_entry_net_amount);	
		
		/*update_transaction($invoice_entry_id, $invoice_entry_no, $invoice_entry_date, 'cash_sales', $acc_col_dr_id, $acc_cr_id, 'D', $acc_amount, $invoice_entry_remark, $invoice_entry_branch_id, $invoice_entry_net_amount);	
		update_transaction($invoice_entry_id, $invoice_entry_no, $invoice_entry_date, 'cash_sales', $acc_cr_id, $acc_col_dr_id, 'C', $acc_amount, $invoice_entry_remark, $invoice_entry_branch_id, $invoice_entry_net_amount);	*/		
...
$invoice_entry_product_detail_id 			  	  = $_POST['invoice_entry_product_detail_id'];
		...
		update_transaction($invoice_entry_id, $invoice_entry_no, $invoice_entry_date, 'Invoice', $acc_dr_id, $acc_cr_id, 'C', $acc_amount, $invoice_entry_remark, $invoice_entry_branch_id, $invoice_entry_net_amount);	
		update_transaction($invoice_entry_id, $invoice_entry_no, $invoice_entry_date, 'Invoice', $acc_cr_id, $acc_dr_id, 'D', $acc_amount, $invoice_entry_remark, $invoice_entry_branch_id, $invoice_entry_net_amount);	
