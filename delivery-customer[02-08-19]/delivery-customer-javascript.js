...
function AddproductDetail(){
	...
	for (var i = 0; i < x.length; i++) {
		if (x[i].checked ==true) {
			...
			apnd	+= '<tr><td><input type="hidden"  name="delivery_customer_product_detail_mother_child_type[]" id="delivery_customer_product_detail_mother_child_type" value="'+product_mother_child_type+'" />'+product_brand_name+'</td><td>'+product_name+'<input type="hidden"  name="delivery_customer_product_detail_product_id[]" id="delivery_customer_product_detail_product_id" value="'+product_id+'" /><input type="hidden"  name="delivery_customer_product_detail_product_type[]" id="delivery_customer_product_detail_product_type" value="2" /><input type="hidden"  name="delivery_customer_product_detail_invoice_detail_id[]" id="delivery_customer_product_detail_invoice_detail_id" value="'+detail_id+'" /><input type="hidden"  name="delivery_customer_product_detail_entry_type[]" id="delivery_customer_product_detail_entry_type" value="2" /></td>';
