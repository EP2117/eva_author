...
?>
			...
			<tr class="odd gradeX">
				<td>
				<input type="checkbox" name="production_order_product_detail_id[]" id="production_order_product_detail_id<?php echo $record_so_detail['production_order_product_detail_id'];?>" value="<?php echo $record_so_detail['production_order_product_detail_id']; ?>"   class="prd_checkbox" />
				...
				<input type="hidden" name="product_width_inches" id="product_width_inches<?php echo $record_so_detail['production_order_product_detail_id'];?>" value="<?php echo $record_so_detail['production_order_product_detail_width_inches']; ?>" />

				<input type="hidden" name="product_width_mm" id="product_width_mm<?php echo $record_so_detail['production_order_product_detail_id'];?>" value="<?php echo $record_so_detail['production_order_product_detail_width_mm']; ?>" />

				<input type="hidden" name="product_s_width_inches" id="product_s_width_inches<?php echo $record_so_detail['production_order_product_detail_id'];?>" value="<?php echo $record_so_detail['production_order_product_detail_s_width_inches']; ?>" />

				<input type="hidden" name="product_s_width_mm" id="product_s_width_mm<?php echo $record_so_detail['production_order_product_detail_id'];?>" value="<?php echo $record_so_detail['production_order_product_detail_s_width_mm']; ?>" />

				<input type="hidden" name="product_sl_feet" id="product_sl_feet<?php echo $record_so_detail['production_order_product_detail_id'];?>" value="<?php echo $record_so_detail['production_order_product_detail_sl_feet']; ?>" />

				<input type="hidden" name="product_sl_feet_in" id="product_sl_feet_in<?php echo $record_so_detail['production_order_product_detail_id'];?>" value="<?php echo $record_so_detail['production_order_product_detail_sl_feet_in']; ?>" />
				
				<input type="hidden" name="product_sl_feet_mm" id="product_sl_feet_mm<?php echo $record_so_detail['production_order_product_detail_id'];?>" value="<?php echo $record_so_detail['production_order_product_detail_sl_feet_mm']; ?>" />
				
				<input type="hidden" name="product_sl_feet_met" id="product_sl_feet_met<?php echo $record_so_detail['production_order_product_detail_id'];?>" value="<?php echo $record_so_detail['production_order_product_detail_sl_feet_met']; ?>" />
				
				<input type="hidden" name="product_ext_feet" id="product_ext_feet<?php echo $record_so_detail['production_order_product_detail_id'];?>" value="<?php echo $record_so_detail['production_order_product_detail_ext_feet']; ?>" />

				<input type="hidden" name="product_ext_feet_in" id="product_ext_feet_in<?php echo $record_so_detail['production_order_product_detail_id'];?>" value="<?php echo $record_so_detail['production_order_product_detail_ext_feet_in']; ?>" />
				
				<input type="hidden" name="product_ext_feet_mm" id="product_ext_feet_mm<?php echo $record_so_detail['production_order_product_detail_id'];?>" value="<?php echo $record_so_detail['production_order_product_detail_ext_feet_mm']; ?>" />
				
				<input type="hidden" name="product_ext_feet_met" id="product_ext_feet_met<?php echo $record_so_detail['production_order_product_detail_id'];?>" value="<?php echo $record_so_detail['production_order_product_detail_ext_feet_met']; ?>" />
				
				<input type="hidden" name="product_s_weight_inches" id="product_s_weight_inches<?php echo $record_so_detail['production_order_product_detail_id'];?>" value="<?php echo $record_so_detail['production_order_product_detail_s_weight_inches']; ?>" />
				<input type="hidden" name="product_s_weight_mm" id="product_s_weight_mm<?php echo $record_so_detail['production_order_product_detail_id'];?>" value="<?php echo $record_so_detail['production_order_product_detail_s_weight_mm']; ?>" />
				<input type="hidden" name="product_tot_feet" id="product_tot_feet<?php echo $record_so_detail['production_order_product_detail_id'];?>" value="<?php echo $record_so_detail['production_order_product_detail_tot_feet']; ?>" />
				<input type="hidden" name="product_tot_meter" id="product_tot_meter<?php echo $record_so_detail['production_order_product_detail_id'];?>" value="<?php echo $record_so_detail['production_order_product_detail_tot_meter']; ?>" />
				...
				<input type="hidden" name="product_type_id" id="product_type_id<?php echo $record_so_detail['production_order_product_detail_id'];?>" value="<?php echo $t_id; ?>" />
				...
				<input type="hidden" name="uom_id" id="uom_id<?php echo $record_so_detail['production_order_product_detail_id'];?>" value="<?php echo $record_so_detail['product_product_uom_id']; ?>" />
                <input type="hidden" name="mother_child_type" id="mother_child_type<?php echo $record_so_detail['production_order_product_detail_id'];?>" value="1" />
				</td>
