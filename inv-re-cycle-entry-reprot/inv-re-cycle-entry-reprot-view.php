    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Re Cycle Entry Report</h1>
								...
								<table class="table table-striped table-bordered table-hover" id="product_detail_rls" >
                                    <thead  >
										 ...
										 <th rowspan="2" style="vertical-align:middle;">SNO</th>
											...
											<th rowspan="2" style="vertical-align:middle;" nowrap="nowrap"> RE-CYCLE NO.</th>
                                    ...
                                    <tbody >
										...
										if($product_id!=$get_val['product_con_entry_child_product_detail_mas_product_id']){
										

										?>
										<tr>
											<td colspan="12" style="text-align:center"> <?php echo $get_val['product_code'].' - '.$get_val['product_name'];?></td>
										</tr>
										
										<?php } 
										if($get_val['product_con_entry_child_product_detail_thick_ness']==0){
										$arr_thicks='';
										}else{
										$arr_thicks=$arr_thick[number_format($get_val['product_con_entry_child_product_detail_thick_ness'])];
										...
										<td><?php echo $sno++;?></td>	
											...
											<td><?php echo $get_val['recycle_entry_no'];?></td>
											<td><?php echo dateGeneralFormatN($get_val['recycle_entry_date']);?></td>
											...
											<td><?php echo $get_val['product_con_entry_child_product_detail_length_feet'];?></td>
											<td><?php echo $get_val['product_con_entry_child_product_detail_length_mm'];?></td>
											<td><?php echo $get_val['product_con_entry_child_product_detail_ton_qty'];?></td>
											<td><?php echo $get_val['product_con_entry_child_product_detail_kg_qty'];?></td>
											
											
										</tr>
										<?php 
										
										$product_id=$get_val['product_con_entry_child_product_detail_mas_product_id'];
