   		   ...
   		   $select_product 			= "	SELECT 
										...
										LEFT JOIN 
											(SELECT 
												...
												SUM(pi_amount_cur+pi_descount_amt) AS rcv_amount_cur
											FROM 
										...
										WHERE 
											...
											(IFNULL(rcv_table.rcv_amount+dn_table.dn_rcv_amount+dnp_table.dnp_rcv_amount,0) 		< pI_invoicetotal OR IFNULL(rcv_table.rcv_amount_cur+dn_table.dn_rcv_amount_cur+dnp_table.dnp_rcv_amount_cur,0) 	< pI_invoice_total_amt)";//exit;
