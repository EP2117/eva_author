		...
		// echo $grn_entry_product_detail_qty[$i]; exit;
			...
			if($detail_request_fields) {
				...
				$grn_detail_id	= mysql_insert_id();
							...
							stockLedger('out',$grn_entry_id,$grn_detail_id,$produt_id,$length_feet,$length_meter,$ton_qty,$kg_qty,(-1*$product_detail_qty), $grn_entry_branch_id,  $product_con_entry_godown_id, NdateDatabaseFormat($grn_entry_date), $grn_no,$stock_ledger_entry_type, '2',$width_inches,$width_mm,$color_id,$thick);
							$product_con_entry_godown_id						= 	"3";
							stockLedger('in',$grn_entry_id,$grn_detail_id,$produt_id,$length_feet,$length_meter,$ton_qty,$kg_qty,$product_detail_qty, $grn_entry_branch_id,  $product_con_entry_godown_id, NdateDatabaseFormat($grn_entry_date), $grn_no,$stock_ledger_entry_type, '2',$width_inches,$width_mm,$color_id,$thick);
		...
		deleteMultiRecords('grn_entry_product_details', 'grn_entry_product_detail_deleted_by', 'grn_entry_product_detail_deleted_on', 'grn_entry_product_detail_deleted_ip', 'grn_entry_product_detail_deleted_status', 'grn_entry_product_detail_grn_entry_id', 'grn_entry','grn_entry_id','grn_entry_uniq_id', '1'); 
				...
				{ 
					...
					$select_grn_ch_detal			= "SELECT
														...
														WHERE
															grn_entry_raw_product_detail_deleted_status		= 0	AND
															grn_entry_raw_product_detail_grn_entry_id				= '".$deleteCheck."'";
